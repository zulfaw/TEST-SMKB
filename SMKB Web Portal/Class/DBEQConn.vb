...
#End Region
    ...
    Public Sub sReadConfig()
        ...
        strDbEQServer = WebConfigurationManager.AppSettings("DBEQServerName")
        strDbEQName = WebConfigurationManager.AppSettings("DBEQName")
        strDBEQUser = WebConfigurationManager.AppSettings("DBEQUserID")
        strDBEQPassword = WebConfigurationManager.AppSettings("DBEQPassword")
    ...
    Private Sub sInitializeConnStr()
        ...
        'syafiqah sila semak smula- pka
        strDBEQPassword = "smkb*pwd"

        ConnectionString = "Server=" & strDbEQServer & ";Database=" & strDbEQName & ";Uid=" & strDBEQUser & ";Pwd=" & strDBEQPassword & ";Pooling=False;"
