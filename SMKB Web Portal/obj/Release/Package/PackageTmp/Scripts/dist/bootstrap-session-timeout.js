...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        var defaults = {
            ...
            message: 'Sesi anda hampir tamat kerana tiada aktiviti dalam tempoh sesi.',
            logoutButton: 'Logout',
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            // Create timeout warning dialog
            //removed 'logout' dan 'stay-alive' button
            $('body').append('<div class="modal fade" id="session-timeout-dialog"> \
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  <div class="modal-header"> \
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> \
                    <h4 class="modal-title" style="text-align:center;"><span style="color:#b94a48"><i class="fas fa-exclamation-triangle fa-lg"></i></span> &nbsp;&nbsp;' + opt.title + '</h4> \
                  </div> \
                  <div class="modal-body"> \
                    <p>' + opt.message + '</p> \
                    ' + countdownMessage + ' \
