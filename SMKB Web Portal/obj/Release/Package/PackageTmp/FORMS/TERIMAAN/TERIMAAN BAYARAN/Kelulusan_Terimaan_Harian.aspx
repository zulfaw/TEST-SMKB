<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Kelulusan_Terimaan_Harian.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Terimaan_Harian" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:GridView ID="gvTerimaan" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" Tiada rekod"
							cssclass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" ShowFooter="true" DataKeyNames="RC01_ID" Font-Size="8pt">
								<columns>
								...
								<asp:BoundField HeaderText="No Resit Harian" DataField="RC01_NoResitHarian" SortExpression="RC01_NoResitHarian" itemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />
								...
								<asp:BoundField HeaderText="Maklumat Pembayar" DataField="RC03_NamaPembayar" SortExpression="RC03_NamaPembayar"  ItemStyle-Width="20%" />
						    ...
						    <div style="text-align:right;">
                                <table class="table table-borderless table-striped">                                    
                                    <tr id="trEFT" runat="server" visible ="false">
                                        ...
                                        <td>
                                            <asp:label ID="lblNoEft" runat="server"></asp:label>                                            
                                        </td>
                                    </tr>
                                </table>
                                </div>
                                <table id="tblCek" runat="server" visible="false" class="table table-borderless table-striped">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlBankPembayar" runat="server" AutoPostBack="True" CssClass="form-control" Width="100%" Enabled="false"></asp:DropDownList>                                            
                                        </td>
                                        <td>&nbsp</td>
                                        <td>
                                            No Cek/ Dokumen :
                                        ...
                                        <td>
                                             <asp:label ID="lblNoCek" runat="server" ></asp:label>                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:label ID="lblCawBank" runat="server" ></asp:label>                                            
                                        </td>
                                        <td>&nbsp</td>
                                        <td>
                                            Jenis Cek :
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlJnsCek" runat="server" AutoPostBack="True" CssClass="form-control" Width="100%" Enabled="false"></asp:DropDownList>                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:label ID="lblTrkCek" runat="server"></asp:label>
                                            </td>
                                        <td>&nbsp</td>
                                        <td>
                                            Tarikh Terima Cek :
                                        ...
                                        <td>
                                            <asp:label ID="lblTrkTerimaCek" runat="server"></asp:label>
                                            </td>
                                    </tr>
                                </table>
            ...
            <ContentTemplate>
               <table style="border: Solid 3px #D5AA00; width: 100%; height: 100%; " >                  
                ...
                cssclass="table table-striped table-bordered table-hover" Width="100%"  BorderStyle="Solid" ShowFooter="false" Font-Size="8pt" PageSize="25">
                    ...
                    <asp:BoundField HeaderText="Mod Bayar" DataField="NamaMod" SortExpression="NamaMod" ItemStyle-Width="20%"/>			            
