<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatSSTK.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatSSTK" %>
...
.calendarContainerOverride table tr td
{
    ...
    function fCheckBatal(obj) {
        debugger;
        var gridView = document.getElementById("<%=gvSST.ClientID %>");
        var TxtNoSST = document.getElementById("<%=txtNoSSTBatal1.ClientID %>");
        var btnHantar = document.getElementById("<%=lbtnHantar.ClientID %>");

        var row = obj.parentNode.parentNode;
        var intRowidx = row.rowIndex;
        var noSST = gridView.rows[intRowidx].cells[11].outerText;
        var objChx = gridView.rows[intRowidx].cells[14].childNodes[1];
        if (objChx.checked) {
            if (TxtNoSST.value == " " || TxtNoSST.value == "") {
                TxtNoSST.value = noSST;
            }
            else {
                TxtNoSST.value = TxtNoSST.value + " & " + noSST;
            }
    ...
    <h1>Maklumat Surat Setuju Terima (Kerja)</h1>
    <p></p>
        ...
        <div class="panel panel-default" style="width:auto;">
                  <div class="panel-heading">
                    <h3 class="panel-title">
                        Maklumat Surat Setuju Terima (Kerja)
                    </h3>
                   </div>
                    ...
                    <div class="panel-body" style="overflow-x:auto; width:initial;">
                        ...
                        <asp:GridView ID="gvSST" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText=" Tiada rekod" Font-Size="8pt"
							cssclass="table table-striped table-bordered table-hover" Width="98%" BorderStyle="Solid" DataKeyNames="PO03_OrderID">
                                ...
                                <asp:BoundField HeaderText="No SST" DataField="PO19_NoPt" SortExpression="PO19_NoPt" NullDisplayText=" " ItemStyle-HorizontalAlign="Center">
									<ItemStyle Width="10%" />
								</asp:BoundField>                                
                        ...
                        <br />
                        <div id="divAddNewSST" runat="server" style="text-align:center;" visible="false">
                            <asp:label ID="lblGantiSST" runat="server" ToolTip="Penggantian SST yang telah dibatalkan : " >Ganti SST</asp:label>
                    ...
                    <br />
                                <table style="width:100%;" class="table table-borderless table-striped">                                    
                                    ...
                                    <tr>
                                        <td style="width: 15%;">Pegawai SST (Pelulus):</td>
                                        <td>
                                            <asp:DropDownList ID="ddlPelulusSST" runat="server" AutoPostBack="True" CssClass="form-control" Width="40%">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlPelulusSST" ErrorMessage="" ForeColor="Red" Text="*Sila pilih" ValidationGroup="lbtnHantar" Display="Dynamic" ></asp:RequiredFieldValidator>
                                    ...
                                    <tr id="trKelulusanSST" runat="server" visible="false">
								        <td style="vertical-align:top;width:15%;"> 
									        <b>Kelulusan SST :</b></td>
									        <td>
                                                No SST : <asp:textbox  id="txtNoSSTLulus" runat="server" BackColor="#FFFFCC" CssClass="form-control" Width="250px" ReadOnly="true" rows="1" cols="50" textmode="MultiLine"> </asp:textbox>                                           
                                            <br />
                                    ...
                                    <tr id="trBatalSST" runat="server" visible="false">
								        <td style="vertical-align:top;width:15%;"> 
									        <b>Pembatalan SST</b>
									        </td>
									        <td>
                                                No SST : <textarea  type="text" name="txtNoSSTBatal1" id="txtNoSSTBatal1" runat="server" style="text-align:left;background-color:#FFFFCC;" Class="form-control" Width="250px" ReadOnly="readonly" rows="1" cols="50"> </textarea>                                           
                                            <br />
                                                Kategori Pembatalan SST :
									        <asp:RadioButtonList ID="rbBatalSST" runat="server" Height="25px" Width="273px" RepeatDirection="Vertical" AutoPostBack="true" ValidationGroup="lbtnHantar">
									            <asp:ListItem Text=" Batal SST" Value="1" />
									            <asp:ListItem Text=" Batal SST dan Perlantikan" Value="2" />
                                                <asp:ListItem Text=" Batal SST dan Permohonan Pembelian" Value="3" />
								            </asp:RadioButtonList>
                                            <asp:RequiredFieldValidator ID="rfvrbBatalSST" runat="server" ControlToValidate="rbBatalSST" ErrorMessage="" ForeColor="Red" Text="*Sila Pilih" ValidationGroup="lbtnHantar" Display="Dynamic" Enabled="false"></asp:RequiredFieldValidator>
                                            <div id="divBatalSST" runat="server">
										        <label class="control-label" for="Ulasan"><b>Ulasan Pembatalan :</b></label><br />
										        <asp:TextBox ID="txtUlasanBatalSST" runat="server" TextMode="MultiLine" Width="90%" Rows="3" ></asp:TextBox>
										        <asp:RequiredFieldValidator ID="rfvtxtBatalSST" runat="server" ControlToValidate="txtUlasanBatalSST" ErrorMessage="" ForeColor="Red" Text="*Sila isi" Display="Dynamic"  ValidationGroup="vgBatal"></asp:RequiredFieldValidator>
									         </div>
