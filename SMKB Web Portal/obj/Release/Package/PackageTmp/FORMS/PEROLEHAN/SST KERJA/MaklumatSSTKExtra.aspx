<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatSSTKExtra.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatSSTKExtra" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h1>MaklMaklumat SST Kerja tanpa e-Perolehan</h1>
            ...
            <asp:MultiView ID="mvPO" runat="server" ActiveViewIndex="0">				
                ...
                <div class="panel panel-default" style="width:auto;overflow-x:auto;"  >
                        ...
                        <tr>
                            ...
                            <tr>
                                <td style="width: 20%;"><Label class="control-label" for="">No SST:</Label></td>
                                <td>
                                    <asp:TextBox ID="txtNoBelian2" runat="server" ReadOnly="true" BackColor="#FFFFCC" CssClass="form-control" Width="200px"></asp:TextBox>
                                    <asp:HiddenField ID="hfNoPOSem" runat="server" />
                            ...
                            <tr class="calendarContainerOverride">
                                ...
                                <td>
                                    ...
                                    <ajaxToolkit:CalendarExtender ID="calTarikhMula" runat="server" Animated="true" DefaultView="Days" FirstDayOfWeek="Monday" Format="dd/MM/yyyy" TargetControlID="txtTarikhMula" TodaysDateFormat="dd/MM/yyyy" />
                            ...
                            <tr class="calendarContainerOverride">
								...
								<td>
									<asp:TextBox ID="txtTempoh" runat="server" Width="100px" TextMode="number" CssClass="form-control"></asp:TextBox>
                            ...
                            <br />
                            <asp:GridView ID="gvMohon" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" Font-Size="8pt"
						cssclass="table table-striped table-bordered table-hover" Width="100%"  BorderStyle="Solid" ShowFooter="True" DataKeyNames="PO01_DtID">
							<columns>
							...
							<asp:BoundField DataField="KodKo" HeaderText="Kod Operasi" ItemStyle-Width="2%" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="centerAlign" ReadOnly="true" />
                            ...
                            <asp:BoundField DataField="KodKp" HeaderText="Kod Projek" SortExpression="KodKp" ItemStyle-Width="2%" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Center" ReadOnly="true"/>
							<asp:BoundField DataField="KodVot" HeaderText="Vot Sebagai" SortExpression="KodVot" ItemStyle-Width="3%" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Center" ReadOnly="true"/>
							...
							<asp:BoundField DataField="PO01_Kuantiti" HeaderText="Kuantiti" SortExpression="PO01_Kuantiti" ItemStyle-Width="2%" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="right" ReadOnly="true"/>
                            <asp:BoundField DataField="Ukuran" HeaderText="Ukuran" ItemStyle-Width="3%" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="centerAlign" ReadOnly="true"/>
								...
								<td>
									...
									<asp:GridView ID="gvLampiran" runat="server" AutoGenerateColumns="false" BorderColor="#333333" BorderStyle="Solid" ShowHeaderWhenEmpty="true" Font-Size="8pt"
                                         ...
                                         <Columns>
                                             ...
                                             <asp:HyperLinkField DataNavigateUrlFields="PO13_NoMohon,PO13_NamaDok" DataNavigateUrlFormatString="~/Upload/Document/PO/SSTK/{0}/{1}" DataTextField="PO13_ID" DataTextFormatString="&lt;img src='../../../Images/search.png' alt='View' /&gt;" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%" Target="_blank" />
                ...
                <asp:View ID="View3" runat="server">
                    ...
                    <br />
                               <table style="width:100%;" class="table table-borderless table-striped">
                                    ...
                                    <tr class="calendarContainerOverride">
                                        <td class="auto-style1">Tarikh Daftar SST :</td>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td style="width: 15%;">Pelulus SST :</td>
                                        <td>
                                            <asp:DropDownList ID="ddlPelulusSST" runat="server" AutoPostBack="True" CssClass="form-control" Width="40%">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="rfvddlPelulusSST" runat="server" ControlToValidate="ddlPelulusSST" ErrorMessage="" ForeColor="Red" Text="*Sila pilih" ValidationGroup="lbtnHantar" Display="Dynamic" ></asp:RequiredFieldValidator>
                                   ...
                                   <tr>
                                    ...
                                    <tr id="trBatalPT" runat="server" visible="false">
								        <td style="vertical-align:top;width:15%;"> 
									        <b>Pembatalan SST :</b></td>
									        <td>                                                
                                                Kategori Pembatalan SST :
									        <asp:RadioButtonList ID="rbBatalPT" runat="server" Height="25px" Width="100%" RepeatDirection="Vertical" AutoPostBack="true" ValidationGroup="lbtnHantar">
									            <asp:ListItem Text=" Batal SST" Value=1 />
                                                <asp:ListItem Text=" Batal SST dan Permohonan Pembelian" Value=2 />
								            </asp:RadioButtonList>
