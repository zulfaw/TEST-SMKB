<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatPenilaianHarga.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatPenilaianHarga" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="panel panel-default" style="width: auto;">
						...
						Masa Tamat Perolehan&nbsp; :&nbsp;<asp:TextBox ID="txtMasaTamatPO" runat="server" CssClass="form-control rightAlign" Width="100px" TextMode="Time" BackColor="#FFFFCC" ReadOnly="true"></asp:TextBox>--%>
                                ...
                                <tr>
                                    <td style="width: 20%;">Tarikh Pembuka :</td>
                                    <td>
                                ...
                                <tr class="calendarContainerOverride">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTarikh" runat="server" CssClass="form-control rightAlign" Width="100px"></asp:TextBox>
                            ...
                            <asp:GridView ID="gvHarga" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText="Tiada Rekod"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ulasan Syor" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtUlasan" runat="server" Text='<%#Eval("PO03_UlasanHarga") %>' MaxLength="250" TextMode="MultiLine" Style="width: inherit;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                                    ...
                                                    <asp:Panel ID="pnlChild" runat="server" Style="margin-left: 20px; margin-right: 20px; height: 0px; overflow: auto;" Width="95%">
                                                        ...
                                                        <asp:GridView ID="gvChild" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" Tiada rekod"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="PO01_Kuantiti" HeaderText="Kuantiti" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                                                <asp:BoundField DataField="Ukuran" HeaderText="Ukuran" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Center" />
                                                                <asp:BoundField DataField="PO03_HargaSeunit" HeaderText="Harga Seunit (RM)" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Right" NullDisplayText=" " DataFormatString="{0:N2}" />
                                                                <asp:BoundField DataField="PO03_JumHarga" HeaderText="Jumlah Harga (RM)" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Right" NullDisplayText=" " DataFormatString="{0:N2}" />
                            ...
                            <%--<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Sila pilih salah satu syor." ClientValidationFunction="Validate" ForeColor="Red" ValidationGroup="btnSimpan"></asp:CustomValidator>
                        <br />--%>
                            <br />
                            ...
                            <div class="panel-body" style="overflow-x:auto">
                                ...
                                <asp:GridView ID="gvJawatanKuasa" runat="server" AllowPaging="false" AllowSorting="True" AutoGenerateColumns="False" BorderStyle="Solid" cssclass="table table-striped table-bordered table-hover" 
                                    EmptyDataText=" Tiada Rekod" ShowFooter="false" ShowHeaderWhenEmpty="True" Width="100%" DataKeyNames="PO05_StafID" >
                                    <columns>
