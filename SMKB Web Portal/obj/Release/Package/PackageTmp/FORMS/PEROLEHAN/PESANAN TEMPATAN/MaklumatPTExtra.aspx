<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatPTExtra.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatPTExtra" EnableEventValidation = "false"%>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Maklumat Pesanan Tempatan tanpa e-Perolehan</h1>
                ...
                <div class="panel panel-default" style="width:auto;overflow-x:auto;"  >
                        ...
                        <div class="panel-body">
                            ...
                            <tr>
							    ...
							    <td>
								<asp:TextBox ID="txtTujuan" runat="server" style="width: 90%; height:auto; min-height:100px;" BackColor="#FFFFCC" TextMode="MultiLine" CssClass="form-control" ReadOnly="true"></asp:TextBox>								
							    </td>
							</tr>
							<tr>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td style="width: 20%;"><Label class="control-label" for="">No Pesanan Tempatan:</Label></td>
                                <td>
                                    <asp:TextBox ID="txtNoPT" runat="server" ReadOnly="true" BackColor="#FFFFCC" CssClass="form-control" Width="200px"></asp:TextBox>
                                    <asp:HiddenField ID="hfNoPOSem" runat="server" />
                                    &nbsp;&nbsp;&nbsp;Tarikh Daftar PT :&nbsp<asp:TextBox ID="txtTarikhPO" runat="server" ReadOnly="true" CssClass="form-control" Width="100px" BackColor="#FFFFCC"></asp:TextBox>
                                </td>
							</tr>                          
                            <tr>
                            ...
                            <tr class="calendarContainerOverride">
                                ...
                                <td>
                                    <asp:TextBox ID="txtTarikhMula" ViewStateMode="Enabled" runat="server" AutoPostBack="True" CssClass="form-control" Width="100px"></asp:TextBox>
						...
						cssclass="table table-striped table-bordered table-hover" Width="100%"  BorderStyle="Solid" ShowFooter="True" DataKeyNames="PO01_DtID" Font-Size="8pt">
                            ...
                            <asp:BoundField DataField="PO01_JumKadar" HeaderText="Ang. Jum. (RM)" ItemStyle-Width="6%" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="centerAlign" ReadOnly="true" DataFormatString="{0:N}"/>
                ...
                <asp:View ID="View3" runat="server">
                    ...
                    <br />
                               <table style="width:100%;" class="table table-borderless table-striped">
                                    <tr>
                                        <td>No Pesanan Tempatan (PT): </td>
                                        <td>
                                             <asp:textbox  id="txtNoPT2" runat="server" BackColor="#FFFFCC" CssClass="form-control" Width="250px" ReadOnly="true"> </asp:textbox>
                                        </td>
                                    </tr>
                                    <tr class="calendarContainerOverride">
                                    ...
                                    <tr id="trBatalPT" runat="server" visible="false">
								        <td style="vertical-align:top;width:15%;"> 
									        ...
									        <asp:RadioButtonList ID="rbBatalPT" runat="server" Height="25px" Width="100%" RepeatDirection="Vertical" AutoPostBack="true" ValidationGroup="lbtnHantar">
									            <asp:ListItem Text=" Batal Pesanan Tempatan" Value=1 />
                                                <asp:ListItem Text=" Batal Pesanan Tempatan dan Permohonan Pembelian" Value=2 />
								            </asp:RadioButtonList>
