<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Daftar_PT_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Daftar_PT_PTJ" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Pendaftaran Pesanan Tempatan PTJ</h1>
				...
				<div class="panel-body" style="overflow-x:auto">
					...
					<asp:GridView ID="gvMohonPO2" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" Tiada rekod"
							cssclass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" Font-Size="8pt">
                                ...
                                <asp:BoundField HeaderText="Tarikh Lulus" DataField="PO01_TkhLulus" SortExpression="PO01_TkhLulus" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center">
									<ItemStyle Width="7%" HorizontalAlign="Center"/>
								</asp:BoundField>
								<asp:BoundField HeaderText="Status" DataField="Butiran" SortExpression="Butiran" HeaderStyle-CssClass="centerAlign">
									<ItemStyle Width="20%" />
