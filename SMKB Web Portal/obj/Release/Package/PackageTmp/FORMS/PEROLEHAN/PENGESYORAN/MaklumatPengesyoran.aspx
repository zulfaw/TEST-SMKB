<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatPengesyoran.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatPengesyoran" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Maklumat Pengesyoran
                            </h3>
                        </div>
						...
						<i class="fas fa-external-link-alt fa-lg"></i>&nbsp;&nbsp;&nbsp;P. Teknikal
                            ...
                            <asp:GridView ID="gvHarga" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText=" Tiada Rekod" Font-Size="8pt"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ulasan Syor Harga" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="txtUlasanHarga" runat="server" Text='<%#Eval("PO03_UlasanHarga") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Syor P. Teknikal" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Ulasan Syor Teknikal" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="txtUlasanTeknikal" runat="server" Text='<%#Eval("PO03_UlasanTeknikal") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="centerAlign" HeaderText="Syor" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox1" runat="server" Name="CheckBox1" onclick="fCheckChildSyor()" ClientIDMode="Static" Checked='<%#IIf(IsDBNull(Eval("PO03_Syor")), False, Eval("PO03_Syor")) %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Ulasan Syor" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtUlasan" runat="server" Text='<%#Eval("PO03_UlasanSyor") %>' MaxLength="250" TextMode="MultiLine" Style="width: inherit;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <ItemTemplate><%#IIf(CInt(Eval("PO03_JnsHarga")) = 1, "Bercukai (Tanpa GST)", "Tanpa cukai (FOB)")%></ItemTemplate>
                                                               ...
                                                               <%-- <asp:BoundField DataField="PO03_JumGST" HeaderText="Cukai GST (RM)" ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Right" NullDisplayText=" " DataFormatString="{0:N2}" />
                                                                ...
                                                                <%--<asp:TemplateField HeaderText="Syor" ItemStyle-HorizontalAlign="Center" >
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="CheckBox1Dt" runat="server" name="CheckBox1Dt" ClientIDMode="Static" onclick="fCheckMainSyor()" Checked='<%#IIf(IsDBNull(Eval("PO03_SyorDt")), False, Eval("PO03_SyorDt")) %>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Ulasan Syor" ItemStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtUlasanDt" runat="server" Text='<%#Eval("PO03_UlasanSyorDt") %>' MaxLength="250" TextMode="MultiLine" Style="width: inherit;"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>--%>
                                                            </Columns>
                                                        </asp:GridView>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" style="overflow-x: auto">
                                    ...
                                    <asp:GridView ID="gvLampiran2" runat="server" AutoGenerateColumns="false" BorderColor="#333333" BorderStyle="Solid" ShowHeaderWhenEmpty="true" Font-Size="8pt"
                                        CssClass="table table-striped table-bordered table-hover" DataKeyNames="PO13_ID" EmptyDataText=" Tiada rekod" HeaderStyle-BackColor="#6699FF">
                                        <Columns>
    ...
    ClientValidationFunction="Validate" ForeColor="Red" ValidationGroup="btnSimpan"></asp:CustomValidator>--%>
                        <div class="row">
                            <div class="col-md-10" style="text-align: center">
                                <asp:LinkButton ID="lbtnSimpan" runat="server" CssClass="btn" ToolTip="Simpan" ValidationGroup="btnSimpan" OnClientClick="return Validate2();">
        ...
        <asp:View ID="View2" runat="server">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Lampiran Dokumen Pengesyoran
                    </h3>
                </div>
                <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td>Jenis-jenis dokumen:
                                ...
                                <asp:RadioButtonList ID="rbDokumenType" runat="server">
                                    <asp:ListItem Text="Laporan Pengesyoran" Value="SYOR" />
                                </asp:RadioButtonList>
                                <br />
                                <div class="form-inline">
                                ...
                                <asp:GridView ID="gvLampiran" runat="server" AutoGenerateColumns="false" BorderColor="#333333" BorderStyle="Solid" ShowHeaderWhenEmpty="true" Font-Size="8pt"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="JenisDok" HeaderText="Type" ItemStyle-Width="25%" />
                                        <asp:BoundField DataField="PO13_NoMohon" HeaderText="" ItemStyle-Width="1%" Visible="false" />
                                        <asp:HyperLinkField DataNavigateUrlFields="PO13_NoMohon,PO13_NamaDok" DataNavigateUrlFormatString="~/Upload/Document/PO/Pengesyoran/{0}/{1}" DataTextField="PO13_ID" DataTextFormatString="&lt;img src='../../../Images/search.png' alt='View' /&gt;" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%" Target="_blank" />
