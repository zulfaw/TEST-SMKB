<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Perlantikan_Vendor_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Perlantikan_Vendor_PTJ" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h1>Perlantikan Vendor PTJ</h1>
    <p></p>  
            ...
            <div class="panel panel-default" style="width:90%">
                <div class="panel-heading">
                    <h3 class="panel-title">
						Senarai Jualan Naskah Sebut Harga PTJ
                    </h3>
                </div>
