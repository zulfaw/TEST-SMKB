<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Pembatalan_Pesanan_Belian.aspx.vb" Inherits="SMKB_Web_Portal.Pembatalan_Pesanan_Belian" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <h1>Pembatalan Pesanan Belian</h1>
				...
				<div class="panel-body" style="overflow-x:auto">
					...
					<asp:GridView ID="gvMohonPO" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" Tiada rekod"
							cssclass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" Font-Size="8pt">
								...
								<asp:BoundField HeaderText="Kategori" DataField="PO01_JenisBrg" SortExpression="PO01_JenisBrg" HeaderStyle-CssClass="centerAlign">
									<ItemStyle Width="5%" HorizontalAlign="Center"/>
								</asp:BoundField>                          
