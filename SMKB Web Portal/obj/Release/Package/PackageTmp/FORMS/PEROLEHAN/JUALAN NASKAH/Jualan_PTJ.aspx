<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Jualan_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Pembelian_Terus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Jualan Naskah Bagi Pembelian PTj</h1>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Senarai Jualan Sebut Harga PTj
                    </h3>
                </div>
