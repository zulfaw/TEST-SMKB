<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" EnableEventValidation = "false" CodeBehind="MaklumatIndenExtra.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatIndenExtra" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Maklumat Inden tanpa e-Perolehan</h1>
            ...
            <asp:MultiView ID="mvPO" runat="server" ActiveViewIndex="0">				
                ...
                <div class="panel panel-default" style="width:auto;overflow-x:auto;"  >
                        ...
                        <tr>
                            ...
                            <tr>
                                <td style="width: 20%;"><Label class="control-label" for="">No Inden:</Label></td>
                                <td>
                                    <asp:TextBox ID="txtNoInden" runat="server" ReadOnly="true" BackColor="#FFFFCC" CssClass="form-control" Width="200px"></asp:TextBox>
                                    <asp:HiddenField ID="hfNoPOSem" runat="server" />
                                    &nbsp;&nbsp;&nbsp;Tarikh Daftar Inden :&nbsp<asp:TextBox ID="txtTarikhPO" runat="server" ReadOnly="true" CssClass="form-control" Width="100px" BackColor="#FFFFCC"></asp:TextBox>
                                </td>
							</tr>                          
                            <tr>
                            ...
                            <br />
                            <asp:GridView ID="gvMohon" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" Tiada rekod"
						cssclass="table table-striped table-bordered table-hover" Width="100%"  BorderStyle="Solid" ShowFooter="True" DataKeyNames="PO01_DtID" Font-Size="8pt">
                            ...
                            <asp:TemplateField HeaderText="Jenama" ItemStyle-Width="7%" HeaderStyle-CssClass="centerAlign">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtJenama" runat="server" CssClass="form-control" Width="100px" Text='<%# Eval("PO19_Jenama") %>' onkeyup="upper(this)"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
								...
								<td>
									...
									<asp:GridView ID="gvLampiran" runat="server" AutoGenerateColumns="false" BorderColor="#333333" BorderStyle="Solid" ShowHeaderWhenEmpty="true" Font-Size="8pt"
                                         ...
                                         <Columns>
                                             ...
                                             <asp:HyperLinkField DataNavigateUrlFields="PO13_NoMohon,PO13_NamaDok" DataNavigateUrlFormatString="~/Upload/Document/PO/Inden/{0}/{1}" DataTextField="PO13_ID" DataTextFormatString="&lt;img src='../../../Images/search.png' alt='View' /&gt;" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%" Target="_blank" />
                    ...
                    <br />
                               <table style="width:100%;" class="table table-borderless table-striped">
                                    <tr>
                                        <td>No Inden: </td>
                                        <td>
                                             <asp:textbox  id="txtNoInden2" runat="server" BackColor="#FFFFCC" CssClass="form-control" Width="250px" ReadOnly="true"> </asp:textbox>
                                        </td>
                                    </tr>
                                    <tr class="calendarContainerOverride">
                                   ...
                                   <tr>
                                        ...
                                        &nbsp;&nbsp;<asp:TextBox ID="txtJawatanWakil" runat="server" CssClass="form-control" Width="40%" ReadOnly="true" BackColor="#FFFFCC"></asp:TextBox>
                                            </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 15%;">Pelulus Inden :</td>
                                        <td>
                                            <asp:DropDownList ID="ddlPelulusInden" runat="server" AutoPostBack="True" CssClass="form-control" Width="40%">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="rfvddlPelulusInden" runat="server" ControlToValidate="ddlPelulusInden" ErrorMessage="" ForeColor="Red" Text="*Sila pilih" ValidationGroup="lbtnHantar" Display="Dynamic" ></asp:RequiredFieldValidator>
                                            &nbsp;&nbsp;<asp:TextBox ID="txtJawatan" runat="server" CssClass="form-control" Width="40%" ReadOnly="true" BackColor="#FFFFCC"></asp:TextBox>
                                        </td>
                                    </tr>
                                   <tr>
                                        ...
                                        <td>
                                            ...
                                            &nbsp;&nbsp;<asp:TextBox ID="txtPenyelarasProj" runat="server" CssClass="form-control" Width="40%" ReadOnly="true" BackColor="#FFFFCC"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            &nbsp;&nbsp;<asp:TextBox ID="txtPenyeliaKerja" runat="server" CssClass="form-control" Width="40%" ReadOnly="true" BackColor="#FFFFCC"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="trBatalPT" runat="server" visible="false">
								        <td style="vertical-align:top;width:15%;"> 
									        ...
									        <asp:RadioButtonList ID="rbBatalPT" runat="server" Height="25px" Width="100%" RepeatDirection="Vertical" AutoPostBack="true" ValidationGroup="lbtnHantar">
                                                ...
                                                <asp:ListItem Text=" Batal Inden dan Permohonan Pembelian" Value=2 />
								            </asp:RadioButtonList>
