<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Cetak_Inden.aspx.vb" Inherits="SMKB_Web_Portal.Cetak_Inden" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h1>Cetakkan Inden</h1>
    <p></p>
                    ...
                    <asp:DropDownList ID="ddlSaizRekod" runat="server" Width="50px" AutoPostBack="true" CssClass="form-control">                        
                        ...
                        <asp:GridView ID="gvCetakInden" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="true" EmptyDataText=" Tiada rekod"
							cssclass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" PageSize="25" Font-Size="8pt">
                                ...
                                <asp:BoundField HeaderText="No Inden" DataField="PO19_NoPt" SortExpression="PO19_NoPt" HeaderStyle-CssClass="centerAlign">
									<HeaderStyle CssClass="centerAlign" />
									<ItemStyle Width="5%" HorizontalAlign="Center"/>
								</asp:BoundField>
                                <asp:BoundField HeaderText="Tarikh Inden" DataField="PO19_TkhPt" SortExpression="PO19_TkhPt" HeaderStyle-CssClass="centerAlign" dataformatstring="{0:MM/dd/yyyy}">
                                    <HeaderStyle CssClass="centerAlign" />
                                    <ItemStyle Width="5%" HorizontalAlign="Center"/>
                                </asp:BoundField>							            
