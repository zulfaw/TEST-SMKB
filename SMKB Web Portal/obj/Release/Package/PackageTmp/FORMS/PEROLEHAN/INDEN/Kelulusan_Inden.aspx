<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Kelulusan_Inden.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Inden" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Kelulusan Inden</h1>
				...
				<div class="panel-body" style="overflow-x:auto">
					...
					<asp:GridView ID="gvMohonPO" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" Tiada rekod"
							cssclass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" Font-Size="8pt">
								...
								<asp:BoundField HeaderText="Kaedah" DataField="Kaedah" SortExpression="Kaedah" HeaderStyle-CssClass="centerAlign">
									<ItemStyle Width="15%" />
								</asp:BoundField>
