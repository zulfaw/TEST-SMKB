<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Penilaian_Teknikal_Universiti.aspx.vb" Inherits="SMKB_Web_Portal.Penilaian_Teknikal_Universiti" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h1>Penilaian Teknikal Universiti</h1>
    <p></p>
            ...
            <div class="panel panel-default" style="width:90%">
                <div class="panel-heading">
                    <h3 class="panel-title">
						Senarai Jualan Naskah Sebut Harga / Tender Universiti
                    </h3>
                </div>
