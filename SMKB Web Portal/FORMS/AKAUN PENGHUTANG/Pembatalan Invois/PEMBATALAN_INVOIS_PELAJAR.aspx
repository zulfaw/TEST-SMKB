<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PEMBATALAN_INVOIS_PELAJAR.aspx.vb" Inherits="SMKB_Web_Portal.PEMBATALAN_INVOIS_PELAJAR" %>
                ...
                <div class="panel panel-default" style="width: 85%;">
                    ...
                    <div class="panel-body">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td style="width: 180px">No. Jurnal Sementara</td>
                                <td style="width: 10px">:</td>
                                <td style="width: 450px">
                                    <asp:TextBox ID="txtNoJurnSem" runat="server" BackColor="#FFFFCC" CssClass="form-control" ReadOnly="True" Style="width: 350px;"></asp:TextBox>
                            ...
                            <tr>
                                <td style="width: 180px">No. Invois</td>
                                <td style="width: 10px">:</td>
                                <td style="width: 450px">
                                    <asp:Label ID="lblNoInv" runat="server" ForeColor="#000099"></asp:Label>
                            ...
                            <tr>
                                ...
                                <td class="auto-style1" colspan="7">
                                    <asp:Label ID="lblBank" runat="server" ForeColor="#000099"></asp:Label>
                                </td>
