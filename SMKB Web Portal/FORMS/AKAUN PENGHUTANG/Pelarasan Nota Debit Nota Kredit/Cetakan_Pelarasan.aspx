<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Cetakan_Pelarasan.aspx.vb" Inherits="SMKB_Web_Portal.Cetakan_Pelarasan" %>
                    ...
                    PageSize="25" cssclass="table table-striped table-bordered table-hover" Width="100%" Height="100%" HeaderStyle-BackColor="#6699FF" Font-Size="8pt" BorderColor="#333333" BorderStyle="Solid" ShowFooter="True"  >
                               ...
                               <%--  <asp:TemplateField HeaderText="Kategori">
                                 ...
                                 <asp:TemplateField HeaderText="No. Pelarasan">
                                     <ItemTemplate>
                                         <asp:Label ID="lblNPenerima" runat="server" Text='<%# Eval("AR04_NoAdj")%>' />
                                     </ItemTemplate>
                                     <ItemStyle HorizontalAlign="Left" Width="30%" />
                                 </asp:TemplateField>
