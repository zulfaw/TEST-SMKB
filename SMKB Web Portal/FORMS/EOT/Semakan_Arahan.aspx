<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/NestedMasterPage2.master"  CodeBehind="Semakan_Arahan.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Arahan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
 <style>
    ...
    <div class="modal fade" id="PilihStaf" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <%--<button type="button" class="closeModalSenaraiArahan" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>--%>
     ...
     <h6 style="color:#FF0000;font-style: italic;align-content:center">Sila Pilih <b>No Arahan kerja </b> dalam <b> Senarai Arahan Kerja </b></h6>   
     <div class="row">
                <div class="col-md-12">                    
                   <div class="form-row">
                       ...
                       <div class="form-group col-md-9">
                            <div class="btn btn-primary btnPaparSen" onclick="ShowPopup('2')" >
                                <i class="fa fa-list"></i>Senarai Staf Mengikut Arahan Kerja
                            </div>
                       </div>
                </div>
             </div>
