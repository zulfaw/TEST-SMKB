<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="TetapanZonStaf.aspx.vb" Inherits="SMKB_Web_Portal.TetapanZonStaf" %>
...
list-style: none;
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
                <div class="search-filter">
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Sila pilih Zon Kewangan :</label>
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                               <asp:DropDownList ID="ddlZon" runat="server" CssClass="form-control"  EnableFilterSearch="true" FilterType="StartsWith"></asp:DropDownList>
            ...
            <div class="table-title">
                <h6>Senarai Staf Kewangan mengikut Zon</h6>
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvKod" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NoStaf" HeaderText="No Staf" HeaderStyle-HorizontalAlign="Center"> 
                        ...
                        <asp:TemplateField HeaderText="Nama" ItemStyle-Width="20">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"
                                    ...
                                    Text='<%# DataBinder.Eval(Container.DataItem, "NamaStaf") %>' class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" ssClass="btn-xs" ToolTip="Pilih" />
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <div class="modal-dialog modal-dialog-centered modal-s" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Senarai Staf                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               </h5>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label>Zon</label>
                                            <asp:DropDownList ID="ddlZonEntry" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Nama</label>
                                            <asp:DropDownList ID="ddlNamaStaf" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlNamaStaf_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
