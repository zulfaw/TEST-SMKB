<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="TetapanZonPTj.aspx.vb" Inherits="SMKB_Web_Portal.TetapanZonPTj" %>
...
list-style: none;
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
                <div class="search-filter">
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Zon:</label>
                                <div class="col-sm-8">
            ...
            <div class="table-title">
                <h6>Senarai Pusat Tanggungjawab</h6>
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvKod" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Kod_Ptj" HeaderText="Kod PTj" HeaderStyle-HorizontalAlign="Center"> 
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Nama PTJ" ItemStyle-Width="65%">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"
                                    Style="text-decoration: none; font: bold; color: blue"
                                    Text='<%# DataBinder.Eval(Container.DataItem, "namaPTj") %>' class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" ssClass="btn-xs" ToolTip="Pilih" />
                            </ItemTemplate>
                        </asp:TemplateField>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label>Zon</label>
                                            <asp:DropDownList ID="ddlZonEntry" runat="server" CssClass="form-control" ></asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label>Ptj</label>
                                            <asp:DropDownList ID="ddlPTjEntry" runat="server" CssClass="form-control" ></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
