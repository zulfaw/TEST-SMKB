...
Public Class testAir
    ...
    Private Function fCreateDtMaklumatKorporat() As DataTable
        ...
        Try
            ...
            Dim strSql As String = $"select MS01_NoStaf, MS01_Nama, MS01_Gambar from MS01_Peribadi
                        where MS01_NoStaf in('00270','01662')"
            ...
            For i As Integer = 0 To dsMaklumatKorporat.Tables(0).Rows.Count - 1
                ...
                noStaf = dsMaklumatKorporat.Tables(0).Rows(i)(0).ToString
                namaStaf = dsMaklumatKorporat.Tables(0).Rows(i)(1).ToString

                dt.Rows.Add(noStaf, namaStaf)
            Next
    ...
    Sub UpdateDatabase(ByVal logoData As Byte())
        ...
        sqlCommand.CommandText = "UPDATE MS01_Peribadi SET MS01_Gambar = @gmbr WHERE MS01_NoStaf = '" & strNamaSing & "'"

        sqlCommand.Parameters.Add("@gmbr", SqlDbType.Binary).Value = logoData
