...
Public Class MaklumatKorporat
    ...
    Sub UpdateDatabase(ByVal logoData As Byte())
        ...
        sqlCommand.CommandText = "UPDATE SMKB_Korporat SET Logo = @logo WHERE Nama_Sing = '" & strNamaSing & "'"
        ...
        Try
            If e.CommandName = "Select" Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    fBindNegeri(dt.Rows(0)("Kod_Negeri"))
                    ddlNegeri.SelectedValue = dt.Rows(0)("Kod_Negeri")
                    fBindNegara(dt.Rows(0)("Kod_Negara"))
                    ddlNegara.SelectedValue = dt.Rows(0)("Kod_Negara")
    ...
    Private Sub fBindNegeri(kodKlasifikasi As String)
        Try
            Dim strsql As String
            ...
            ddlNegeri.DataValueField = "Kod_Detail"
            ddlNegeri.DataBind()
            ...
            Else
                ddlNegeri.Items.FindByValue(kodKlasifikasi).Selected = True
            End If
        ...
        End Try
    End Sub
    Private Sub fBindNegara(kodKlasifikasi As String)
        Try
            Dim strsql As String
            ...
            ddlNegara.DataValueField = "Kod_Detail"
            ddlNegara.DataBind()
            ...
            'Else
            '    ddlNegara.Items.FindByValue("100").Selected = True
            'End If
