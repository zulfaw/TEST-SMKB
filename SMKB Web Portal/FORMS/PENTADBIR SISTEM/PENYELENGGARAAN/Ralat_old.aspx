<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Ralat_old.aspx.vb" Inherits="SMKB_Web_Portal.Ralat" %>
...
<%--    <script type="text/javascript">
        var gvTestClientId = '<% =gvErr_Log.ClientID %>';
    </script>--%>
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvErr_Log" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Err_Event" HeaderText="Err Event" >
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>

                        <asp:BoundField DataField="Err_PcIP" HeaderText="IP Pc" >
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>

                        <asp:BoundField DataField="Err_PcUser" HeaderText="Pc User" >
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="txtsource_indicator" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Status</label>
