<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="DaftarTahap.aspx.vb" Inherits="SMKB_Web_Portal.DaftarTahap" %>
...
<%--    <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function ShowPopup(elm) {
            ...
            if (elm == "1") {
                $('#<%=hdnProc.ClientID%>').val("update");
                $('#permohonan').modal('toggle');

            }
            else if (elm == "2") {
                $('#<%=hdnProc.ClientID%>').val("insert");
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <div class="table-title">
                ...
                <div class="btn btn-primary" onclick="ShowPopup('2')">
                    <i class="fa fa-plus"></i>Tahap              
                </div>

            </div>
       
            <div class="box-body" align="center">
                 <asp:GridView ID="gvTahap" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                     AutoGenerateColumns="false" ShowHeaderWhenEmpty ="true">
                    <Columns>
                        <asp:BoundField DataField="Kod_Tahap" HeaderText="Kod Tahap" HeaderStyle-HorizontalAlign="Center"> 
                            <ItemStyle Width="8%" HorizontalAlign="left" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Tahap" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"
                                    Style="text-decoration: none; font: bold; color: blue"
                                    Text='<%# DataBinder.Eval(Container.DataItem, "Jen_Tahap") %>' class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" ssClass="btn-xs" ToolTip="Pilih" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Butiran" HeaderText="Butiran" HeaderStyle-HorizontalAlign="Center"> 
                ...
                <div class="modal-dialog modal-dialog-centered modal-s" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Tahap                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <h6>Maklumat Tahap</h6>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label>Kod Tahap</label>
                                            <input id="txtKodTahap" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                        <div class="form-group col-md-9">
                                            <label>Tahap</label>
                                            <input id="txtJenTahap" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                    </div>
                                    <div class="row">
