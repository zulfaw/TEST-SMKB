<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="TetapanTahap.aspx.vb" Inherits="SMKB_Web_Portal.TetapanTahap" %>
    ...
    <script type="text/javascript">
        ...
        function ShowPopup(elm) {
            ...
            if (elm == "1") {
                ...
                $('#permohonan').modal('toggle');
                var dropDownList = document.getElementById("<%=ddlTahapDT.ClientID%>");
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <div class="table-title">
                ...
                <div class="btn btn-primary" onclick="ShowPopup('2')">
                    <i class="fa fa-plus"></i>Tetapan Pengguna              
                </div>
                        ...
                        <asp:TemplateField HeaderText="Nama" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"
                                    ...
                                    Text='<%# DataBinder.Eval(Container.DataItem, "ms01_nama") %>' class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" ssClass="btn-xs" ToolTip="Pilih" />
                            </ItemTemplate>
                        </asp:TemplateField>
                       <asp:BoundField DataField="tahap" HeaderText="Tahap" >
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <asp:DropDownList ID="ddlTahapDT" runat="server" DataTextField="Jen_Tahap" DataValueField="Kod_Tahap" EnableFilterSearch="true" FilterType="StartsWith" class="form-control ui fluid search read-only dropdown selection custom-select"></asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <asp:DropDownList ID="ddlPenggunaSis" runat="server" DataTextField="MS01_Nama" DataValueField="MS01_NoStaf" EnableFilterSearch="true" FilterType="StartsWith" class="form-control ui fluid search dropdown selection custom-select" OnSelectedIndexChanged="ddlPenggunaSis_SelectedIndexChanged"  AutoPostBack="true"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-12">
