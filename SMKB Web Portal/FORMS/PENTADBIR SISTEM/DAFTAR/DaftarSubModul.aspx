<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="DaftarSubModul.aspx.vb" Inherits="SMKB_Web_Portal.DaftarSubModul" %>
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
                <div class="search-filter">
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Modul:</label>
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddlCariModul" runat="server" CssClass="form-control"  EnableFilterSearch="true" FilterType="StartsWith"></asp:DropDownList>
            ...
            <div class="table-title">
                ...
                <div class="btn btn-primary" onclick="ShowPopup('2')">
                    <i class="fa fa-plus"></i>Sub Modul              
                </div>

            </div>
       
            <div class="box-body" align="center">
                 <asp:GridView ID="gvSubModul" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                     AutoGenerateColumns="false" ShowHeaderWhenEmpty ="true">
                    <Columns>
                        <asp:BoundField DataField="Kod_Sub" HeaderText="Kod Sub Modul" HeaderStyle-HorizontalAlign="Center"> 
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Nama Sub Modul" ItemStyle-Width="18%">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"
                                    Style="text-decoration: none; font: bold; color: blue"
                                    Text='<%# DataBinder.Eval(Container.DataItem, "Nama_Sub") %>' class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" ssClass="btn-xs" ToolTip="Pilih" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Dis_Sub" HeaderText="Keterangan" >
                            <ItemStyle Width="30%" HorizontalAlign="left" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Icon" ItemStyle-Width="8%">
                            <ItemTemplate>
                                <div class="item-icon">
                                    <i class="las la-<%#Eval("Nama_Icon")%>"></i>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Nama_Icon" HeaderText="Nama Icon" ItemStyle-Width="8%" />
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Sub Modul                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               </h5>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label>Modul</label>
                                            <asp:DropDownList ID="ddlModul" runat="server" CssClass="form-control"  EnableFilterSearch="true" FilterType="StartsWith"></asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label>Kod Sub</label>
                                            <input id="txtKodSub" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                        <div class="form-group col-md-9">
                                            <label>Nama Sub</label>
                                            <input id="txtNamaSub" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <asp:DropDownList ID="ddlNamaIcon" runat="server" CssClass="form-control"  EnableFilterSearch="true" FilterType="StartsWith"></asp:DropDownList>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Urutan</label>
