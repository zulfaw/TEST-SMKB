<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="DaftarModul.aspx.vb" Inherits="SMKB_Web_Portal.DaftarModul" %>
...
list-style: none;
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvModul" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                     AutoGenerateColumns="false" ShowHeaderWhenEmpty ="true">
                    <Columns>
                        <asp:BoundField DataField="Kod_Modul" HeaderText="Kod Modul" HeaderStyle-HorizontalAlign="Center"> 
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Nama Modul" ItemStyle-Width="8">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"
                                    Style="text-decoration: none; font: bold; color: blue"
                                    Text='<%# DataBinder.Eval(Container.DataItem, "Nama_Modul") %>' class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" ssClass="btn-xs" ToolTip="Pilih" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Dis_Modul" HeaderText="Keterangan" >
                        ...
                        <asp:BoundField DataField="Icon_Location" HeaderText="Icon Location" ItemStyle-Width="18%" />
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Modul                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <h6>Maklumat Modul</h6>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label>Kod Modul</label>
                                            <input id="txtKodModul" runat="server" type="text" class="form-control" enable="true" readonly>
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label>Nama Modul</label>
                                            <input id="txtNamaModul" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label>Keterangan</label>
                                            <input id="txtDis_Modul" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                    </div>
                                   <div class="row">
                                        ...
                                        <div class="form-group col-md-10">
                                           ...
                                           <%--<img src="<%#Trim(Eval("icon_location")) %>"/>--%>
                                            ...
                                            <input id="txtIcon_Location" runat="server" type="text" class="form-control" enable="true" style="display:none">
                                        </div>
                                    </div>
                                    <div class="row">
