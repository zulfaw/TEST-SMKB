<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="ParamProses.aspx.vb" Inherits="SMKB_Web_Portal.ParamProses" %>
...
list-style: none;
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <div class="table-title">
                <h6>Senarai Parameter Proses</h6>
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvKod" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Kadar" HeaderText="Kadar" >
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="Tarikh_Akhir" HeaderText="Tarikh Akhir" >
                            <ItemStyle Width="8%" HorizontalAlign="center" />
                        </asp:BoundField>
