<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="ParamSistem.aspx.vb" Inherits="SMKB_Web_Portal.ParamSistem" %>
...
list-style: none;
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <div class="table-title">
                <h6>Senarai Parameter Sistem</h6>
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvKod" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Database Name" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"
                                    Style="text-decoration: none; font: bold; color: blue"
                                    Text='<%# DataBinder.Eval(Container.DataItem, "DATABASE_NAME") %>' class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" ssClass="btn-xs" ToolTip="Pilih" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Tindakan">
                         ...
                         <asp:TemplateField HeaderText="Tindakan">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Hapus" CssClass="btn-xs" Text="Delete" ToolTip="Hapus.">
                                <i class="las la-edit"></i></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Width="3%" HorizontalAlign="Center" />
                        </asp:TemplateField>
                ...
                <div class="modal-dialog modal-dialog-centered modal-s" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Parameter Sistem                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <h6>Maklumat Parameter Sistem</h6>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="txtDatabaseName" runat="server" type="text" class="form-control" enable="true">
                                            <input id="txtSistemID" runat="server" type="hidden" class="form-control" enable="true">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label>Server Name</label>
                                            <input id="txtServerName" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label>Type</label>
                                            <input id="txtType" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Status</label>
            ...
            <div class="modal fade" id="hapus" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-s" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle2">Tambah Parameter Sistem                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label>Database Name</label>
                                            <input id="Text1" runat="server" type="text" class="form-control" enable="true">
                                            <input id="Hidden1" runat="server" type="hidden" class="form-control" enable="true">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label>Server Name</label>
                                            <input id="Text2" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label>Type</label>
                                            <input id="Text3" runat="server" type="text" class="form-control" enable="true">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Status</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                            <button type="button" runat="server" id="Button1" class="btn btn-secondary">Simpan</button>
