<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="UntungRugiDetailBaru.aspx.vb" Inherits="SMKB_Web_Portal.UntungRugiDetailBaru" %>
...
<%--                                window.location.href = '<%=ResolveClientUrl("~/reportbaru4.aspx")%>';--%>
                                window.open('<%=ResolveClientUrl("~/FORMS/JURNAL/LAPORAN/PrintReport/reportpnldetailbaru.aspx")%>', '_blank');
