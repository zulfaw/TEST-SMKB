<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportImbanganDuga.aspx.vb" Inherits="SMKB_Web_Portal.reportImbanganDuga" %>
        ...
        <div id="masterdiv" class="container">
           ...
           <div id="headerreport" class="header" style ="">
                <table>
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan : CLS005</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <br/>
                            <p class="pheader3"><strong>Imbangan Duga</strong></p>
                            <p class="pheader3">31
                                <asp:Label runat="server" ID="bulan"></asp:Label>
                                <asp:Label runat="server" ID="tahun"></asp:Label></p>
                            <p runat="server" id="reportTitle" class="pheader3">KW Dari 01 Hingga 11</p>
                            <p class="pheader3">PTJ Dari 010000 Hingga Y00006</p>
                        </td>
            ...
            <div class="vot-table-content">
                <Vot:Table runat="server" ID="tblPendapatan" kodKwFrom="1" kodKwTo="1" CustomClass="tblPendapatan" />
            </div>
<%--                 <table>
                    <tr>
                        <td style="width: 10%"></td>
                        <td style="width: 30%"></td>
                        <td style="width: 15%" id="tdk1"></td>
                        <td style="width: 15%" id="tdk2"></td>
                        <td style="width: 15%" id="tdk3"></td>
                        <td style="width: 15%" id="tdk4"></td>
                    </tr>
                </table>--%>
