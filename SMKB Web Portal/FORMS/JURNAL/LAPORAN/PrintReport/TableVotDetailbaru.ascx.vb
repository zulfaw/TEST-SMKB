...
Public Class TableVotDetailbaru
    Inherits System.Web.UI.UserControl
    Public Property KodVotFrom As String
    Public Property KodVotTo As String
    ...
    Public Property KategoriVot As String
    Public Property AmaunKeseluruhan As Decimal
    ...
    Private Sub LoadDataTable(kodVotFrom As String, kodVotTO As String, namaTable As String)
        ...
        Dim optionalJoin As String = ""

        If Not (String.IsNullOrEmpty(KategoriVot)) Then
            optionalJoin = " JOIN SMKB_Vot B ON LEFT(A.Kod_Vot, 2)= LEFT(B.Kod_Vot, 2)  "

            optionalWhere = " AND B.Kategori_Vot = @kategoriVot  "
        Else
            optionalJoin = " JOIN SMKB_Vot B ON A.Kod_Vot=B.Kod_Vot "
            optionalWhere = " And A.Kod_Vot >= @kodVotFrom AND A.Kod_Vot <= @kodVotTo "
        End If
                        ...
                        FROM (
                            SELECT 
                                ...
                                REPLACE(
                                    SUM(
                                        CASE 
                                            WHEN 12 = 1 THEN (A.Dr_1 - A.Cr_1)
                                            WHEN 12 = 2 THEN (A.Dr_1 + A.Dr_2) - (A.Cr_1 + A.Cr_2)
                                            WHEN 12 = 3 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3) - (A.Cr_1 + A.Cr_2 + A.Cr_3)
                                            WHEN 12 = 4 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4) - (A.Cr_1 + A.Cr_2 + A.Cr_2 + A.Cr_4)
                                            WHEN 12 = 5 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5)
                                            WHEN 12 = 6 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5 + A.Dr_6) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5 + A.Cr_6)
                                            WHEN 12 = 7 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5 + A.Dr_6 + A.Dr_7) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5 + A.Cr_6 + A.Cr_7)
                                            WHEN 12 = 8 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5 + A.Dr_6 + A.Dr_7 + A.Dr_8) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5 + A.Cr_6 + A.Cr_7 + A.Cr_8)	
                                            WHEN 12 = 9 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5 + A.Dr_6 + A.Dr_7 + A.Dr_8 + A.Dr_9) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5 + A.Cr_6 + A.Cr_7 + A.Cr_8 + A.Cr_9)
                                            WHEN 12 = 10 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5 + A.Dr_6 + A.Dr_7 + A.Dr_8 + A.Dr_9 + A.Dr_10) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5 + A.Cr_6 + A.Cr_7 + A.Cr_8 + A.Cr_9 + A.Cr_10)
                                            WHEN 12 = 11 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5 + A.Dr_6 + A.Dr_7 + A.Dr_8 + A.Dr_9 + A.Dr_10 + A.Dr_11) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5 + A.Cr_6 + A.Cr_7 + A.Cr_8 + A.Cr_9 + A.Cr_10 + A.Cr_11)
                                            WHEN 12 = 12 THEN (A.Dr_1 + A.Dr_2 + A.Dr_3 + A.Dr_4  + A.Dr_5 + A.Dr_6 + A.Dr_7 + A.Dr_8 + A.Dr_9 + A.Dr_10 + A.Dr_11 + A.Dr_12) - (A.Cr_1 + A.Cr_2 + A.Cr_3 + A.Cr_4 + A.Cr_5 + A.Cr_6 + A.Cr_7 + A.Cr_8 + A.Cr_9 + A.Cr_10 + A.Cr_11 + A.Cr_12)
                                            ELSE 0 
                                        END
                                    ), '-', '') AS amaun,
                                REPLACE(
                                    SUM(
                                        CASE 
                                            WHEN 12 = 1 THEN (A.Dr_1 - A.Cr_1)
                                            WHEN 12 = 2 THEN (A.Dr_2 - A.Cr_2) 
                                            WHEN 12 = 3 THEN (A.Dr_3 - A.Cr_3) 
                                            WHEN 12 = 4 THEN (A.Dr_4 - A.Cr_4) 
                                            WHEN 12 = 5 THEN (A.Dr_5 - A.Cr_5)
                                            WHEN 12 = 6 THEN (A.Dr_6 - A.Cr_6)
                                            WHEN 12 = 7 THEN (A.Dr_7 - A.Cr_7)
                                            WHEN 12 = 8 THEN (A.Dr_8 - A.Cr_8)
                                            WHEN 12 = 9 THEN (A.Dr_9 - A.Cr_9)
                                            WHEN 12 = 10 THEN (A.Dr_10 - A.Cr_10)
                                            WHEN 12 = 11 THEN (A.Dr_11 - A.Cr_11)
                                            WHEN 12 = 12 THEN (A.Dr_12 - A.Cr_12)
                                            ELSE 0 
                                        END
                                    ), '-', '') AS amaun2
                            FROM
        ...
        Using connection As New SqlConnection(connectionString)
            Using command As New SqlCommand(query, connection)
                If KategoriVot IsNot Nothing Then
                    command.Parameters.Add(New SqlParameter("@kategoriVot", KategoriVot))
                Else
    ...
    Private Sub BindDataToTableDynamic(ByVal dataTable As DataTable, namaTable As String)
        ...
        For Each row As DataRow In dataTable.Rows
            ...
            cell4.InnerText = "" ' Replace "amaun2" with the actual column name in your database
            cell4.Attributes("class") = "valuekanan"
            newRow.Cells.Add(cell4)

            Dim cell5 As New HtmlTableCell()
            cell5.InnerText = "" ' Replace "amaun2" with the actual column name in your database
        ...
        lbl.Attributes("class") = "top-border lblamaun" ' top-border
        ...
        lbl2.ID = "lbl2Amaun" & namaTable
        lbl2.Attributes("class") = "top-border lblamaun"
        lbl2.Text = totalAmaun.ToString("N") 'totalAmaun2.ToString("N")
        ...
        Dim totalAmaun3Cell As New HtmlTableCell()
        Dim lbl3 As New System.Web.UI.WebControls.Label()
        totalAmaun3Cell.Controls.Add(lbl3)
        totalRow.Cells.Add(totalAmaun3Cell)

        ' Add the last row to the table
        table.Rows.Add(totalRow)

        AmaunKeseluruhan = totalAmaun
