<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="UntungRugiBaru.aspx.vb" Inherits="SMKB_Web_Portal.UntungRugiBaru" %>
                        ...
                        <div class="col-md-12">
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans_rpt" class="table table-striped" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="text-align: right;">Jumlah Terkumpul (RM)</th>
                                ...
                                <div style="margin-top: 20px;display:none;" id="displaybawahDT">  
                                    <table style="width: 20%; margin-right: 0; margin-left: auto;">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label runat="server" ID="perbelanjaan1"></asp:Label></td>
                                        </tr>
...
<%--                                window.location.href = '<%=ResolveClientUrl("~/reportbaru4.aspx")%>';--%>
                                window.open('<%=ResolveClientUrl("~/FORMS/JURNAL/LAPORAN/PrintReport/reportpnlbaru.aspx")%>', '_blank');
                    ...
                    "footerCallback": function (row, data, start, end, display) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (kodvot > 90000) {
                                ...
                                totals.emo += amaun;
                            } else if (kodvot >= 00000 && kodvot <= 09999) {
                                totals.pbt += amaun;
                        ...
                        var netProfit = totals.pendapatan - (totals.pbt + totals.emo + totals.perkhidmatan + totals.aset + totals.pemberian + totals.pl);
                        ...
                        document.getElementById("MainContent_FormContents_perbelanjaan1").innerHTML = totals.pbt;
