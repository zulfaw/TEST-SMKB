<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="KW.aspx.vb" Inherits="SMKB_Web_Portal.KW" %>
...
<asp:Content ID="FormContents" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <script type="text/javascript">
       ...
       <%--     <div class="filter-table-function">
             ...
             <div class="box-body" > 
                  <asp:GridView ID="gvKodKW"  CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
            CellPadding="5" CellSpacing="2" AutoGenerateColumns="false" >
                    <Columns>
                        <asp:BoundField DataField="Kod_Kump_Wang" HeaderText="Kod">
                ...
                <div class="modal-dialog modal-dialog-centered modal-s" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Kumpulan Wang</h5>
