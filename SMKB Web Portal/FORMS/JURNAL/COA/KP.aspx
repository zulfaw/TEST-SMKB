<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="KP.aspx.vb" Inherits="SMKB_Web_Portal.KP"%>
...
<asp:Content ID="FormContents" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <%--        <div class="filter-table-function">
            ...
            CellPadding="5" CellSpacing="2" AutoGenerateColumns="false" >
                    <Columns>
                        <asp:BoundField DataField="Kod_Projek" HeaderText="Kod">
                ...
                <div class="modal-dialog modal-dialog-centered modal-s" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Projek</h5>
