...
Public Class ArahanK
    ...
    Public Sub New(No_Arahan_ As String, No_Mohon_ As String, No_Surat_ As String, No_Staf_Peg_AK_ As String, Kod_PTJ_ As String, KW_ As String, Kod_Vot_ As String, Tkh_Mula_ As Date, Tkh_Tamat_ As Date, Lokasi_ As String, PeneranganK_ As String, Ketua_PTJ_ As String)
