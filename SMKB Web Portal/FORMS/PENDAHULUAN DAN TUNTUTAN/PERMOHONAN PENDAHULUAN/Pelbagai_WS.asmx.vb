...
Public Class Pelbagai_WS
    ...
    Private Function GetRecord_SenaraiSendiri(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime, staffP As String) As DataTable
        ...
        Dim query As String = "SELECT a.No_Pendahuluan, a.Tujuan, a.Tempat_Perjalanan, a.PTj, FORMAT(a.Tarikh_Mula, 'yyyy-MM-dd') as Tarikh_Mula, FORMAT(a.Tarikh_Tamat, 'yyyy-MM-dd') as Tarikh_Tamat, a.Status, 
                        FORMAT(a.Tkh_Adv_Perlu, 'yyyy-MM-dd') as Tkh_Adv_Perlu,FORMAT(a.Tarikh_Mohon, 'yyyy-MM-dd') AS Tarikh_Mohon,  isnull(a.Jum_Mohon,'0.00') as Jum_Mohon,                        
                       ...
                       a.Kod_PTJ, (SELECT b.Pejabat FROM [DEVMIS\SQL_INS01].dbStaf.dbo.MS_PEJABAT as b WHERE b.STATUS = 1 and b.kodpejabat = left(a.Kod_PTJ,2)) as ButiranPTJ  ,
                        ...
                        b.Butiran, a.No_Staf + ' - ' + c.ms01_nama   as NamaPemohon, a.No_Staf as Nopemohon,a.Peruntukan_Prgm,a.Justifikasi_Prgm
                        ...
                        WHERE  (b.Kod_Modul = '09') AND (b.Kod_Status_Dok = '01') AND (a.Jenis_Pendahuluan ='PP')  " & tarikhQuery & " order by a.Tarikh_Mohon desc"
    ...
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function SaveRecordPelbagai(OtherList As MhnPelbagai) As String
        Dim resp As New ResponseRepository
        ...
        Else 'untuk permohonan sedia ada
            ...
            'AdvList.JnsTugas, AdvList.JnsJalan, AdvList.TkhMula, AdvList.TkhTamat, AdvList.Tempoh, AdvList.hadMin, AdvList.JumlahAll, AdvList.stafID,
            'AdvList.KodVot, AdvList.kodKW, AdvList.kodKO, AdvList.kodKP, AdvList.TkhAdvance, AdvList.JnsPginapan, AdvList.JnsBayar
            If UpdateNewOrder(OtherList) <> "OK" Then
                'If InsertNewOrder(OtherList) <> "OK" Then
                resp.Failed("Gagal Menyimpan order 1266")
                Return JsonConvert.SerializeObject(resp.GetResult())
                ' Exit Function
        ...
        If UpdateStatusDokOrder_Mohon(OtherList, "Y") <> "OK" Then
    ...
    'Private Function InsertDataItem(orderDetail As OrderDetail)
    '    Dim db As New DBKewConn
    ...
    '    Return db.Process(query, param)
    'End Function
    Private Function UpdateNewOrder(OtherList As MhnPelbagai)
    ...
    Private Function InsertNewOrder(OtherList As MhnPelbagai)
        Dim db As New DBKewConn
        Dim query As String = "INSERT INTO SMKB_Pendahuluan_Hdr (No_Pendahuluan, No_Staf, Samb_Telefon, PTj,  Jenis_Pendahuluan, Tujuan,  Tarikh_Mula, Tarikh_Tamat, 
                    Justifikasi_Prgm, Peruntukan_Prgm,  Id_Mohon, Kod_Kump_Wang, Kod_Operasi, Kod_Projek, Kod_PTJ, Kod_Vot, Tkh_Adv_Perlu, 
                    Status_Dok,  Status, CaraBayar, Tarikh_Mohon, Tempat_Prgm, Pengesahan_Pemohon)
                    VALUES (@No_Pendahuluan, @No_Staf, @Samb_Telefon, @PTj, @Jenis_Pendahuluan, @Tujuan, @Tarikh_Mula, @Tarikh_Tamat, 
                    @TunjukSebab, @Peruntukan_Prgm, @Id_Mohon, @Kod_Kump_Wang, @Kod_Operasi, @Kod_Projek,@Kod_PTJ, @Kod_Vot, @TkhAdvPerlu, 
                    @Status_Dok, @Status, @CaraBayar, @TkhMohon, @TempatProgram, @statusPemohon)"
        Dim param As New List(Of SqlParameter)

        param.Add(New SqlParameter("@No_Pendahuluan", OtherList.mohonID))
        param.Add(New SqlParameter("@No_Staf", OtherList.NoPemohon))
        param.Add(New SqlParameter("@Samb_Telefon", OtherList.NoTel))
        param.Add(New SqlParameter("@PTj", OtherList.PtjMohon))
        param.Add(New SqlParameter("@Jenis_Pendahuluan", "PP"))
        param.Add(New SqlParameter("@Tujuan", OtherList.TujuanProgram))
        param.Add(New SqlParameter("@Tarikh_Mula", OtherList.TkhMula))
        param.Add(New SqlParameter("@Tarikh_Tamat", OtherList.TkhTamat))
        param.Add(New SqlParameter("@TkhAdvPerlu", OtherList.TkhAdvPerlu))
        ...
        param.Add(New SqlParameter("@Peruntukan_Prgm", OtherList.Peruntukan))
        ...
        param.Add(New SqlParameter("@Status", "1"))
        param.Add(New SqlParameter("@CaraBayar", OtherList.JnsBayar))
        param.Add(New SqlParameter("@TkhMohon", OtherList.TkhMohon))
        param.Add(New SqlParameter("@statusPemohon", OtherList.StatusPemohon))
    ...
    Private Function UpdateStatusDokOrder_Mohon(OtherList As MhnPelbagai, statusLulus As String)
        Dim db As New DBKewConn
    ...
    Private Function GetHdrPermohonan(id As String) As DataTable
        ...
        Dim query As String = "SELECT a.No_Pendahuluan, a.Tujuan,  FORMAT(a.Tarikh_Mula, 'yyyy-MM-dd') as Tarikh_Mula, FORMAT(a.Tarikh_Tamat, 'yyyy-MM-dd') as Tarikh_Tamat, a.Status, 
            ...
            a.Kod_Vot, (select Kod_Vot+' - '+ Butiran from SMKB_Vot as vot where a.Kod_Vot = vot.Kod_Vot) as ButiranVot, a.Status_Dok,
            b.Butiran, a.No_Staf + ' - ' + c.ms01_nama   as NamaPemohon, a.No_Staf as Nopemohon,a.Samb_Telefon
            FROM SMKB_Pendahuluan_Hdr as a INNER JOIN 
            SMKB_Kod_Status_Dok AS b ON a.Status_Dok = b.Kod_Status_Dok INNER JOIN
            [qa11].dbStaf.dbo.MS01_Peribadi as c ON a.No_Staf = c.ms01_noStaf
            WHERE  (b.Kod_Modul = '09') AND (b.Kod_Status_Dok = '01') AND  a.No_Pendahuluan=@No_Permohonan"
    ...
    <WebMethod()>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function LoadHdrKeperluan(ByVal id As String) As String
        Dim resp As New ResponseRepository

        dt = GetHdrKeperluan(id)
        resp.SuccessPayload(dt)

        Return JsonConvert.SerializeObject(resp.GetResult())
    End Function

    Private Function GetHdrKeperluan(id As String) As DataTable
        Dim db = New DBKewConn
    ...
    Public Function SaveRecordChecklist(checkList As Lampiran) As String
        ...
        Else 'untuk permohonan sedia ada
            ...
            '    If semakdatachecklist(checkList.mohonID) = "wujud" Then
            '        status = UpdateNewLampiranSurat(checkList)
            '    Else
            '        status = InsertNewLampiranSurat(checkList)
            '    End If
            ...
            '    If semakdatachecklist(checkList.mohonID) = "wujud" Then
            '        status = UpdateNewLampiranBajet(checkList)
            '    Else
            '        status = InsertNewLampiranBajet(checkList)
            '    End If
