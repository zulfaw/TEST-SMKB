<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PengesahanPD.aspx.vb" Inherits="SMKB_Web_Portal.PengesahanPD" %>
       ...
       <div class="panel panel-default">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                   <div class="col-md-6">  
                      <button type="button" class="btn-change" data-toggle="modal" data-target="#myPersonal">Maklumat Pegawai</button> <br />
                  </div>
              </div>              
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax": {
                    "url": "PengesahanPD_WS.asmx/LoadOrderRecordPD",
                    type: 'POST',
        ...
        function loadRecordPelulus(nomohon) {
            ...
            fetch('PengesahanPD_WS.asmx/GetDataPelulus', {
                method: 'POST',
                headers: {
       ...
       function setDataPelulus(data) {
        ...
        async function ajaxSavePelulus(id) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: 'PengesahanPD_WS.asmx/SaveRecordSokong',
                    method: 'POST',
        ...
        function resolveAppUrl(relativeUrl) {
            ...
            $.ajax({
                type: "POST",
                url: "PengesahanPD_WS.asmx/GetBaseUrl",
        ...
        function getDataPeribadi() {
            ...
            var nostaf = '<%=Session("ssusrID")%>'
                 ...
                 fetch('PengesahanPD_WS.asmx/GetUserInfo', {
                     method: 'POST',
                     headers: {
                         'Content-Type': "application/json"
                     },
        ...
        function getHadMinPendahuluan() {
            ...
            //Cara Pertama          
            fetch('PengesahanPD_WS.asmx/GetHadMin', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json"
                },
             ...
             async function initDropdownCOA(id) {
                 ...
                 $('#' + id).dropdown({
                     ...
                     apiSettings: {
                         url: 'PengesahanPD_WS.asmx/GetVotCOA?q={query}',
                         method: 'POST',
                         dataType: "json",
                         contentType: 'application/json; charset=utf-8',
                         cache: false,
             ...
             function kiraElaunMakan() {            
                 ...
                 fetch('PengesahanPD_WS.asmx/GetKiraAdv', {
                     method: 'POST',
                     headers: {
             ...
             $(document).ready(function () {
                 ...
                 //    kiraElaunMakan();
                 //})
                 generateDropdown("ddlTugas", "PengesahanPD_WS.asmx/GetJenisTugas", null, kiraElaunMakan) 
                 generateDropdown("ddlPenginapan", "PengesahanPD_WS.asmx/GetPenginapan", null, kiraElaunMakan)
                 generateDropdown("ddlTempat", "PengesahanPD_WS.asmx/GetTempat", null, kiraElaunMakan)
                 generateDropdown("ddlBayar", "PengesahanPD_WS.asmx/GetKaedahBayar")
                 generateDropdown("ddlJnsJalan", "PengesahanPD_WS.asmx/GetJenisJalan", null, kiraElaunMakan)
