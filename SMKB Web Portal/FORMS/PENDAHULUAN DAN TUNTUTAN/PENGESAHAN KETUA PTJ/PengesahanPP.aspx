<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PengesahanPP.aspx.vb" Inherits="SMKB_Web_Portal.PengesahanPP" %>
    ...
    <div id="menu3" class="tab-pane fade" aria-labelledby="tab-Pengesahan" role="tabpanel">
         <asp:Panel ID="Panel3" runat="server">
            ...
            <br />
             <div class="form-row">
            <div class="form-group col-md-12" align="right">                 
                <button type="button" class="btn btn-secondary Sokong">Sokong</button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        tbl = $("#tblDataSenarai").DataTable({
            ...
            "ajax": {
                "url": "PengesahanPD_WS.asmx/LoadOrderRecordPP",
                type: 'POST',
...
<%--         $(document).ready(function () {
    ...
    async function AjaxGetRecordListItem(id) {
        ...
        try {
            ...
            const response = await fetch('PengesahanPD_WS.asmx/LoadListingKeperluan', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    $('#btnSimpanTblData2').click(async function () {
        ...
        $('#totalKt').val(result.Payload.Jumlah);
    ...
    async function AjaxGetDataSurat(id) {
        ...
        try {
            ...
            const response = await fetch('PengesahanPD_WS.asmx/LoadDataSurat', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function AjaxGetDataBajet(id) {
        ...
        try {
            ...
            const response = await fetch('PengesahanPD_WS.asmx/LoadDataBajet', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
