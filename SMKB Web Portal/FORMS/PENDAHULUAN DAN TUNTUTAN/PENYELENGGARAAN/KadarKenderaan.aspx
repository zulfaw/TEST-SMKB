<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="KadarKenderaan.aspx.vb" Inherits="SMKB_Web_Portal.KadarKenderaan" %>
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <div class="box-body" style="overflow: auto; height: 600px">
        <asp:GridView ID="gvSenarai" CssClass="table table-bordered table-striped grid" Width="100%"  runat="server"   OnRowCommand="gvSenarai_RowCommand"
            ...
            <Columns>               
                <asp:BoundField DataField="ButiranKend" HeaderText="Kenderaan" ItemStyle-Width="40%" />
                <asp:BoundField DataField="KM" HeaderText="Kilometer" ItemStyle-Width="25%"  />
                <asp:BoundField DataField="Kadar" HeaderText="Kadar"  ItemStyle-Width="25%"/>
                          
                <asp:TemplateField HeaderText="Kemaskini" ItemStyle-Width="10%">                       
                      <ItemTemplate>
                                    <asp:LinkButton  ID="lnkButton" runat="server"  class="lnk" data-id='<%#Eval("ID")%>' CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"   
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                     ...
                                     <asp:DropDownList ID="ddlKend"  AutoPostBack="false" Width="300px"  runat="server" Class="form-control" ></asp:DropDownList>                    
                                    </div>                                   
                                </div>

                                <div class="form-row">
                                     <div class="form-group col-md-6">
                                        <label for="kodModul">Kilometer</label>
                                       <asp:TextBox ID="txtKM" runat="server" Width="100px" Class="form-control"></asp:TextBox>
                                    </div>                                                  
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                       ...
                                       <asp:TextBox ID="txtKadar" runat="server" Width="100px" Class="form-control" ></asp:TextBox>
                                    </div>                                   
                                </div>
