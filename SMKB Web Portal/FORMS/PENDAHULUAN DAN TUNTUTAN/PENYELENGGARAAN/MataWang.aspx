<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="MataWang.aspx.vb" Inherits="SMKB_Web_Portal.MataWang" %>
    ...
    <script type="text/javascript">
     ...
     <div class="box-body" style="overflow: auto; height: 600px">
        <asp:GridView ID="gvSenarai"  CssClass="table table-bordered table-striped grid" Width="100%"  runat="server"   OnRowCommand="gvSenarai_RowCommand"
            ...
            <Columns>          
                  <asp:BoundField DataField="Negara" HeaderText="Negara" />
                <asp:BoundField DataField="Matawang" HeaderText="MataWang" />
                <asp:BoundField DataField="Simbol" HeaderText="Simbol" />  
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Id</label>
                                         <asp:TextBox ID="txtId" runat="server" Width="100px" class="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Negara</label>
                                        <asp:DropDownList ID="ddlNegara"  AutoPostBack="false" runat="server" class="form-control searchable-dropdown" ></asp:DropDownList>
                                      
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Mata Wang</label>
                                         <asp:TextBox ID="txtMataWang" runat="server"  class="form-control"></asp:TextBox>                                                                         
                                     </div>                                
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Simbol</label>
                                       <asp:TextBox ID="txtSimbol" runat="server" Width="100px" class="form-control" ></asp:TextBox>
                                    </div>
