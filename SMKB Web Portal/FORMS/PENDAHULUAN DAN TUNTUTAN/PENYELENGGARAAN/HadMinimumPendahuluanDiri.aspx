<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="HadMinimumPendahuluanDiri.aspx.vb" Inherits="SMKB_Web_Portal.HadMinimumPendahuluanDiri" %>
    ...
    <div class="box-body" style="overflow: auto; height: 600px">
        <asp:GridView ID="gvSenarai" CssClass="table table-bordered table-striped grid" Width="100%"  runat="server"   OnRowCommand="gvSenarai_RowCommand"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Dari" HeaderText="Gred Dari" ItemStyle-Width="15%" />
                <asp:BoundField DataField="Hingga" HeaderText="Gred Ke" ItemStyle-Width="15%"  />
                <asp:BoundField DataField="Kump" HeaderText="Kumpulan"  ItemStyle-Width="20%"/>
                <asp:BoundField DataField="HadMin" HeaderText="Had Minimum"  ItemStyle-Width="15%"/>
                ...
                <asp:TemplateField HeaderText="Kemaskini" ItemStyle-Width="10%">                       
                      <ItemTemplate>
                                    <asp:LinkButton  ID="lnkButton" runat="server"  class="lnk" data-id='<%#Eval("ID_HadMin")%>' CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"   
                  ...
                  <%--  <asp:TemplateField HeaderText="Kemaskini" ItemStyle-Width="10%">
                    <ItemTemplate>
                        ...
                        class="lnk" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CommandName="Select" CssClass="btn-xs" Text="Edit" ToolTip="Kemaskini">
               ...
               <%-- <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HiddenField ID="strId"  Value="ID_HadMin"  runat="server"/>
                    </ItemTemplate>
                </asp:TemplateField>--%>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Gred Dari</label>
                                         <asp:TextBox ID="txtGredDari" runat="server" Width="70px" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Gred Ke</label>
                                       <asp:TextBox ID="txtGredKe" runat="server" Width="70px" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="kodModul">Kumpulan</label>
                                     <asp:DropDownList ID="ddlKumpulan"  AutoPostBack="false" runat="server" CssClass="form-control" ></asp:DropDownList>                                    
                                </div>

                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Had Minimum</label>
                                       <asp:TextBox ID="txtHadMin" runat="server" Width="100px" CssClass="form-control" ></asp:TextBox>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <asp:HiddenField ID="hidIDP" runat="server" />
