<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="checklist.aspx.vb" Inherits="SMKB_Web_Portal.checklist" %>
    ...
    <div class="box-body" style="overflow: auto; height: 600px">
        <asp:GridView ID="gvSenarai" CssClass="table table-bordered table-striped grid" Width="100%"  runat="server"   OnRowCommand="gvSenarai_RowCommand"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ButirADV" HeaderText="Jenis Pendahuluan" ItemStyle-Width="20%" />
                ...
                <asp:TemplateField HeaderText="Kemaskini" ItemStyle-Width="15%">                       
                      <ItemTemplate>
                                    <asp:LinkButton  ID="lnkButton" runat="server"  class="lnk" data-id='<%#Eval("ID_CheckList")%>' CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"   
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="kodModul">Butiran Lampiran</label>
                                          <%-- <textarea rows="2" cols="45" ID="txtLampiran" class="form-control" MaxLength="100"></textarea>  --%>   
                                        <asp:TextBox ID="txtLampiran" runat="server" width="450px" TextMode="MultiLine" CssClass="form-control" MaxLength="200"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    <label for="kodModul">Jenis Pendahuluan</label>
                                     <asp:DropDownList ID="ddlPendahuluan"  AutoPostBack="false" runat="server" CssClass="form-control" ></asp:DropDownList>                                    
                                </div>
                            ...
                            <div class="modal-footer">
                               <%-- <asp:LinkButton ID="lbtnTutup" runat="server" CssClass="btn btn-danger"><i class="lar la-window-close"></i>&nbsp;&nbsp;&nbsp;Tutup </asp:LinkButton>--%>
                                <button type="button" class="btn btn-danger"   id="lbtnTutup" data-dismiss="modal">Tutup</button>
