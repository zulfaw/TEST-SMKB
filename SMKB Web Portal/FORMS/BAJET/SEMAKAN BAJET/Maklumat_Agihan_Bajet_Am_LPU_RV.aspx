<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Maklumat_Agihan_Bajet_Am_LPU_RV.aspx.vb" Inherits="SMKB_Web_Portal.Maklumat_Agihan_Bajet_Am_LPU_RV" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-default" style="width: 80%;">
                ...
                <div class="panel-body">
                    <table style="width: 100%; text-align: left; margin-bottom: 0px;">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <asp:TextBox ID="txtJum" runat="server" class="form-control" Style="text-align: right" Width="100"></asp:TextBox>
                                <asp:Label ID="lblExist" runat="server" visible="false" />
                                &nbsp;
                                <asp:LinkButton ID="lnlBtnSave" runat="server" CssClass="btn">
                    ...
                    <table style="width: 100%; text-align: left;">
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td>
                                ...
                                <asp:Label ID="lblHidObjSbg" runat="server" Visible="false"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>Jumlah Keseluruhan (RM)</td>
                            <td>:</td>
                            <td>
                                <asp:TextBox ID="txtJumSbg" runat="server" class="form-control" Style="text-align: right" Width="100"></asp:TextBox>
                                &nbsp;<asp:Label ID="lblExistSbg" runat="server" visible="false" />
