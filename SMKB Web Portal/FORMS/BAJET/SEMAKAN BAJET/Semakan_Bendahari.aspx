<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Semakan_Bendahari.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Bendahari" EnableEventValidation="False" %>
...
<UC:PEMOHON                 runat="server"/>
                        ...
                        <ContentTemplate>
                            <div class="panel-body">
                                ...
                                <div style="align-content: center; text-align:center" >
                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-info" Width="15%" >
                        <i class="fa fa-paper-plane-o fa-lg"></i>&nbsp;&nbsp;&nbsp;Posting Agihan Bajet Peruntukan
                                    </asp:LinkButton>
                                </div>
                        ...
                        <ContentTemplate>
                            <div style="text-align: left; margin-top: 10px;">
                                ...
                                <asp:GridView ID="gvMohonBajet" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" "
                                    CssClass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" ShowFooter="true" OnDataBound="gvMohonBajet_RowCommand">
                                    <Columns>
            ...
            <asp:Panel ID="pnlVot" runat="server" BackColor="White" Width="800px" Style="display: ;">
                <table style="border: Solid 3px #D5AA00; width: 100%; height: 100%;">
                    <tr style="background: linear-gradient(to bottom, #fceabb 0%,#fccd4d 50%,#f8b500 51%,#fbdf93 100%);">
                        <td style="height: 10%; font-weight: bold; text-align: left;" colspan="2">
