Public Class Maklumat_Agihan_Bajet_Review_NC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Dim strKodPTj = Request.QueryString("KodPTj") + "0000"
            ...
            fBindGvObjSebagai(strTahun, strKodKW, strKodKO, Left(strKodPTj, 2), strKodKP, strKodVot)
        End If
    End Sub
...
group by KodKO"
    ...
    Public Function fGetButPTj(strKodpTj) As String
        Dim strButiran As String
        Try
            Dim strSql As String = "select Butiran from MK_PTJ where KodPTJ = '" & strKodpTj & "' and status = 1"
            ...
            If Not ds Is Nothing Then
                If ds.Tables(0).Rows.Count > 0 Then
                    strButiran = ds.Tables(0).Rows(0)("Butiran").ToString.ToUpper
                End If
            End If
            Return strButiran
        Catch ex As Exception
...
group by KodKP"
    ...
    Private Sub sBindGvButiran(strKodVotSbg, strTahun, kodkw, kodKO, kodPtj)
        ...
        Try
            ...
            strSql = $"select a.BG20_NoMohon, a.KodVotSebagai as KodVot, b.BG20_Program, a.BG20_Butiran ,BG20_AngJumlah  from BG01_MohonDt as a
                    inner join  BG01_Mohon as b on a.BG20_NoMohon = b.BG20_NoMohon
