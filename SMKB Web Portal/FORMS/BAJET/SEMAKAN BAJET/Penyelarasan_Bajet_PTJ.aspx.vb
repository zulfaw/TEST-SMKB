...
Public Class Penyelarasan_Bajet_PTJ
...
AND KodBahagian = '4101')
    ...
    Dim strAmtMohon, decAmt10000Op_LPU, decAmt10000Ko_LPU, decAmt20000Op_LPU, decAmt20000Ko_LPU, decAmt30000Op_LPU, decAmt30000Ko_LPU, decAmt40000Op_LPU, decAmt40000Ko_LPU, decAmt50000Op_LPU, decAmt50000Ko_LPU As Decimal

    Protected Sub gvAgihPTj_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvAgihPTj.RowDataBound
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Dim lblAmt10000Op_LPU As Label = CType(e.Row.FindControl("lblAmt10000Op_LPU"), Label)
                decAmt10000Op_LPU += CDec(lblAmt10000Op_LPU.Text)

                Dim lblAmt10000Ko As LinkButton = CType(e.Row.FindControl("lblAmt10000Ko"), LinkButton)
                decAmt10000Ko += CDec(lblAmt10000Ko.Text)

                Dim lblAmt10000Ko_LPU As Label = CType(e.Row.FindControl("lblAmt10000Ko_LPU"), Label)
                decAmt10000Ko_LPU += CDec(lblAmt10000Ko_LPU.Text)


                Dim lblAmt20000Op As LinkButton = CType(e.Row.FindControl("lblAmt20000Op"), LinkButton)
                decAmt20000Op += CDec(lblAmt20000Op.Text)

                Dim lblAmt20000Op_LPU As Label = CType(e.Row.FindControl("lblAmt20000Op_LPU"), Label)
                decAmt20000Op_LPU += CDec(lblAmt20000Op_LPU.Text)


                Dim lblAmt20000Ko As LinkButton = CType(e.Row.FindControl("lblAmt20000Ko"), LinkButton)
                    decAmt20000Ko += CDec(lblAmt20000Ko.Text)

                    Dim lblAmt20000Ko_LPU As Label = CType(e.Row.FindControl("lblAmt20000Ko_LPU"), Label)
                    decAmt20000Ko_LPU += CDec(lblAmt20000Ko_LPU.Text)


                Dim lblAmt30000Op As LinkButton = CType(e.Row.FindControl("lblAmt30000Op"), LinkButton)
                    decAmt30000Op += CDec(lblAmt30000Op.Text)

                    Dim lblAmt30000Op_LPU As Label = CType(e.Row.FindControl("lblAmt30000Op_LPU"), Label)
                    decAmt30000Op_LPU += CDec(lblAmt30000Op_LPU.Text)


                Dim lblAmt30000Ko As LinkButton = CType(e.Row.FindControl("lblAmt30000Ko"), LinkButton)
                    decAmt30000Ko += CDec(lblAmt30000Ko.Text)

                    Dim lblAmt30000Ko_LPU As Label = CType(e.Row.FindControl("lblAmt30000Ko_LPU"), Label)
                    decAmt30000Ko_LPU += CDec(lblAmt30000Ko_LPU.Text)
                ...
                Dim lblAmt40000Op As LinkButton = CType(e.Row.FindControl("lblAmt40000Op"), LinkButton)
                    ...
                    Dim lblAmt40000Op_LPU As Label = CType(e.Row.FindControl("lblAmt40000Op_LPU"), Label)
                    decAmt40000Op_LPU += CDec(lblAmt40000Op_LPU.Text)
                ...
                Dim lblAmt40000Ko As LinkButton = CType(e.Row.FindControl("lblAmt40000Ko"), LinkButton)
                    ...
                    Dim lblAmt40000Ko_LPU As Label = CType(e.Row.FindControl("lblAmt40000Ko_LPU"), Label)
                    decAmt40000Ko_LPU += CDec(lblAmt40000Ko_LPU.Text)
                ...
                Dim lblAmt50000Op As LinkButton = CType(e.Row.FindControl("lblAmt50000Op"), LinkButton)
                    ...
                    Dim lblAmt50000Op_LPU As Label = CType(e.Row.FindControl("lblAmt50000Op_LPU"), Label)
                    decAmt50000Op_LPU += CDec(lblAmt50000Op_LPU.Text)


                Dim lblAmt50000Ko As LinkButton = CType(e.Row.FindControl("lblAmt50000Ko"), LinkButton)
                    decAmt50000Ko += CDec(lblAmt50000Ko.Text)

                    Dim lblAmt50000Ko_LPU As Label = CType(e.Row.FindControl("lblAmt50000Ko_LPU"), Label)
                    decAmt50000Ko_LPU += CDec(lblAmt50000Ko_LPU.Text)
    ...
    Private Function fGetAmtVotAm(strTahun, strKodKW, strKO, strKodPTj, strVotAm) As Decimal
        Try
            ...
            strSql = $"select isnull(sum(b.BG20_JumPelarasanPTj),0) as BG06_Amaun from BG01_Mohon_RV as a inner join BG01_MohonDt_RV as b on a.BG20_NoMohon = b.BG20_NoMohon where a.BG20_TahunBajet = '{strTahun}' and a.KodKW = '{strKodKW}' and a.KodOperasi = '{strKO}' and a.KodBahagian = '{strKodPTj}' and b.KodVotAm = '{strVotAm}' and b.BG20_Aktif ='1' and BG20_FlagLPU = '1'"
    ...
    Private Function fGetAmtVotLPU(strTahun, strKodKW, strKO, strKodPTj, strVotAm) As Decimal
        Try
            ...
            strSql = $"select 
case when ISNULL(SUM(bjam.JumlahLPU ),0) as BG06_Amaun
 from BG01_Mohon_RV as a inner join BG01_MohonDt_RV as b on a.BG20_NoMohon = b.BG20_NoMohon 
where a.BG20_TahunBajet = '{strTahun}' and a.KodKW = '{strKodKW}' and a.KodOperasi = '{strKO}' and a.KodBahagian = '{strKodPTj}' and b.KodVotAm = '{strVotAm}' and b.BG20_Aktif ='1' and BG20_FlagLPU = '1'"
    ...
    Private Sub ddlKW_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlKW.SelectedIndexChanged
        ...
        Try
            ...
            If ddlKW.SelectedIndex <> 0 Then
                Dim kod_Kw = ddlKW.SelectedValue
                fBindGvPTj(kod_Kw)
            End If
    ...
    Private Sub fBindGvPTj(strKodKW As String)
        sClearGvPTj()
        ...
        Try
            ...
            Dim strTahun = dateNext.Year ''Date.Now.Year.ToString 'txtYear.Text 'ddlTahunAgih.SelectedValue.TrimEnd

            sClearGvPTj()
            strSql = $"select distinct dept_kod as dept_kod, dept_name 
                    from live_dept as a
                    where mkod = '41' and status = '1'
                    order by dept_name"
            Dim ds As New DataSet
            'Dim dbconn As New DBKewConn
            ds = dbconnEQ.fselectCommand(strSql)
            ...
            If Not ds Is Nothing Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    Dim strAmtMohon
                    Dim strAmtMohon1_Operasi, strAmtMohon1_Koperasi, strAmtMohon2_Operasi, strAmtMohon2_Koperasi, strAmtMohon3_Operasi, strAmtMohon3_Koperasi, strAmtMohon4_Operasi, strAmtMohon4_Koperasi, strAmtMohon5_Operasi, strAmtMohon5_Koperasi
                    ...
                    dt.Columns.Add("AmtMohon1_Operasi", GetType(String))
                    dt.Columns.Add("AmtMohon1_Koperasi", GetType(String))

                    dt.Columns.Add("AmtMohon2_Operasi", GetType(String))
                    dt.Columns.Add("AmtMohon2_Koperasi", GetType(String))

                    dt.Columns.Add("AmtMohon3_Operasi", GetType(String))
                    dt.Columns.Add("AmtMohon3_Koperasi", GetType(String))

                    dt.Columns.Add("AmtMohon4_Operasi", GetType(String))
                    dt.Columns.Add("AmtMohon4_Koperasi", GetType(String))

                    dt.Columns.Add("AmtMohon5_Operasi", GetType(String))
                    dt.Columns.Add("AmtMohon5_Koperasi", GetType(String))
                    ...
                    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        strKodPTJ = Trim(ds.Tables(0).Rows(i)("dept_kod"))
                        strButiranPTj = Trim(ds.Tables(0).Rows(i)("dept_name"))


                        strAmtMohon1_Operasi = fGetAmtVotLPU(strTahun, strKodKW, "01", strKodPTJ, "10000")
                        strAmtMohon1_Koperasi = fGetAmtVotLPU(strTahun, strKodKW, "02", strKodPTJ, "10000")
                        strAmtMohon2_Operasi = fGetAmtVotLPU(strTahun, strKodKW, "01", strKodPTJ, "20000")
                        strAmtMohon2_Koperasi = fGetAmtVotLPU(strTahun, strKodKW, "02", strKodPTJ, "20000")
                        strAmtMohon3_Operasi = fGetAmtVotLPU(strTahun, strKodKW, "01", strKodPTJ, "30000")
                        strAmtMohon3_Koperasi = fGetAmtVotLPU(strTahun, strKodKW, "02", strKodPTJ, "30000")
                        strAmtMohon4_Operasi = fGetAmtVotLPU(strTahun, strKodKW, "01", strKodPTJ, "40000")
                        strAmtMohon4_Koperasi = fGetAmtVotLPU(strTahun, strKodKW, "02", strKodPTJ, "40000")
                        strAmtMohon5_Operasi = fGetAmtVotLPU(strTahun, strKodKW, "01", strKodPTJ, "50000")
                        strAmtMohon5_Koperasi = fGetAmtVotLPU(strTahun, strKodKW, "02", strKodPTJ, "50000")
                        ...
                        dt.Rows.Add(strKodPTJ, strButiranPTj, strAmtMohon1_Operasi, strAmtMohon1_Koperasi, strAmtMohon2_Operasi, strAmtMohon2_Koperasi, strAmtMohon3_Operasi, strAmtMohon3_Koperasi, strAmtMohon4_Operasi, strAmtMohon4_Koperasi, strAmtMohon5_Operasi, strAmtMohon5_Koperasi, decAmt10000Op, decAmt10000Ko, decAmt20000Op, decAmt20000Ko, decAmt30000Op, decAmt30000Ko, decAmt40000Op, decAmt40000Ko, decAmt50000Op, decAmt50000Ko, decJumAgih)
                    Next
    ...
    Private Sub fBindGVMohonBajet(KodStatus As String)
        Try
            ...
            If KodStatus = String.Empty Then
                strSql = $"select DISTINCT a.BG20_NoMohon, BG20_TarikhMohon, BG20_Program, BG20_AmaunMohon, StatusDok, KodKW, KodOperasi, BG20_Justifikasi from BG01_Mohon_RV as a WHERE a.BG20_Status = 1 and BG20_FlagLPU = '1' " + ayatSql + "  ORDER BY BG20_NoMohon DESC,  BG20_TarikhMohon DESC"
                strSql_count = $"select count(DISTINCT a.BG20_NoMohon) as bil  from BG01_Mohon_RV as a WHERE a.BG20_Status = 1 and B20_FlagLPU = '1'  " + ayatSql
            Else
                strSql = $"select DISTINCT a.BG20_NoMohon, BG20_TarikhMohon, BG20_Program, BG20_AmaunMohon, StatusDok, KodKW, KodOperasi, BG20_Justifikasi from BG01_Mohon_RV as a where StatusDok='{KodStatus}' and BG20_FlagLPU = '1' " + ayatSql + "  ORDER BY BG20_NoMohon DESC,  BG20_TarikhMohon DESC"
                strSql_count = $"select count(DISTINCT a.BG20_NoMohon) as bil  from BG01_Mohon_RV as a WHERE a.BG20_Status = 1 and B20_FlagLPU = '1'  " + ayatSql
            End If
    ...
    Protected Sub gvAgihPTj_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAgihPTj.RowCommand
        ...
        If e.CommandName = "Select" Then
            ...
            'Open other page.
            Response.Redirect($"~/FORMS/BAJET/SEMAKAN BAJET/MaklumatBajet_RV.aspx?KodSubMenu={KodSubMenu}&no={NoMohon}")
        ...
        ElseIf e.CommandName = "10Op" Or e.CommandName = "10Ko" Or e.CommandName = "20Op" Or e.CommandName = "20Ko" Or e.CommandName = "30Op" Or e.CommandName = "30Ko" Or e.CommandName = "40Op" Or e.CommandName = "40Ko" Or e.CommandName = "50Op" Or e.CommandName = "50Ko" Then
            ...
            Try
                ...
                If lblCheck <> "0.00" Then
                    ...
                    'Open other page.
                    Response.Redirect($"~/FORMS/BAJET/SEMAKAN BAJET/Maklumat_Agihan_Bajet_Am_KetuaPTj.aspx?KodSub=" & strKodSub & "&KodSubMenu=" & strKodSubMenu & "&KodPTj=" & strKodPTj & "&Tahun=" & strTahun & "&KodKW=" & strKodKW & "&kodVot=" & strKodVot & "&strKodKO=" & strKodKO & "", False)
    ...
    Protected Sub lbtnHantar_Click(sender As Object, e As EventArgs) Handles lbtnHantar.Click
        ...
        For Each row As GridViewRow In rows
            ...
            If chk.Checked Then
                ...
                strSqlButiran = "Update BG01_Mohon_RV set StatusDok = @statusDok , BG20_StaffIDPelulus = @idSemak ,BG20_TarikhLulus = @tarikh  WHERE BG20_Status = @status and BG20_NoMohon = @NoMohon"
                paramSqlBtrn = {
                ...
                Dim strSQLStatusDok = "INSERT INTO BG12_StatusDok_RV (BG01_NoPermohonan, KodStatusDok, BG12_TkhProses, BG12_NoStaf, BG12_Ulasan) " &
        ...
        If countButiran > 0 Then
            fGlobalAlert($"Berjaya simpan", Me.Page, Me.[GetType](), "../../BAJET/SEMAKAN BAJET/Permohonan_Bajet_Review.aspx")
        Else
    ...
    Protected Sub lblKemaskiniVot_Click(sender As Object, e As EventArgs) Handles lblKemaskiniVot.Click
        ...
        If dbconn_.fUpdateCommand(strSQL_Save_, paramSql_simpan_) > 0 Then
            ...
            If countButiran > 0 Then
                fGlobalAlert($"Maklumat berjaya dikemaskini.", Me.Page, Me.[GetType](), "../../BAJET/SEMAKAN BAJET/Permohonan_Bajet_Review.aspx")
            Else
                fGlobalAlert("Maklumat Butiran tidak berjaya disimpan!", Me.Page, Me.[GetType]())
            End If
    ...
    Private Sub gvMohonBajet_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvMohonBajet.SelectedIndexChanged
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/SEMAKAN BAJET/MaklumatBajet_RV.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}&kodSkrin=1&no={strNoMohon}", False)
    End Sub

    Protected Sub lbtnMohonBaru_Click(sender As Object, e As EventArgs) Handles lbtnMohonBaru.Click
        Dim KodSubMenu = Request.QueryString("KodSubMenu")
        Response.Redirect($"~/FORMS/BAJET/SEMAKAN BAJET/MaklumatBajet_RV.aspx?KodSubMenu={KodSubMenu}&no=0")
    End Sub

    Private Function fBindAmaun_10000() As String
        Dim strSql As String
        Try
            strSql = "SELECT ISNULL(SUM(ISNULL(BG20_AmaunPelarasnPTj,0)),0) as amaun FROM BG01_Mohon_RV "
            Dim ds As New DataSet
            Dim dbconn As New DBKewConn
            Dim strAmaunMohon As String
