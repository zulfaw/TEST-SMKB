<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Pengesahan_LPU.aspx.vb" Inherits="SMKB_Web_Portal.Pengesahan_LPU" EnableEventValidation="False" %>
<%@ Register TagPrefix="UC" TagName="PEMOHON" src="summary.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1><%= TotalRecDt %>Pengesahan LPU</h1>
