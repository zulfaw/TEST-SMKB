Public Class Maklumat_Agihan_Bajet_Am_KetuaPTj_RV
...
group by KodKO"
    ...
    Private Sub lnkBtnBack_Click(sender As Object, e As EventArgs) Handles lnkBtnBack.Click
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/SEMAKAN BAJET/Permohonan_Bajet_Review.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}", False)
    End Sub
    ...
    Private Function fBindGvObjSebagai(strTahun, strKodKW, strKodKO, strKodPTj, strKodKP, strKodVot)
        ...
        Try
            ...
            strSql = $"select a.KodVotSebagai as KodVot, c.Butiran as ButVot , ISNULL(SUM(BG20_JumKetuaPTj),0) as jumlahMohon from BG01_MOHONDT_RV as a
        ...
        WHERE b.BG20_TahunBajet = '{strTahun}' and b.KodKW = '{strKodKW}' and b.KodOperasi = '{strKodKO}' and b.KodBahagian = '{strKodPTj}' and a.KodVotAm = '{strKodVot}' and BG20_Aktif = '1'
...
group by KodKP"
    ...
    Private Sub sBindGvButiran(strKodVotSbg, strTahun, kodkw, kodKO, kodPtj)
        ...
        Try
            ...
            strSql = $"select a.BG20_NoMohon, a.KodVotSebagai as KodVot, b.BG20_Program, a.BG20_Butiran ,ISNULL((BG20_JumKetuaPTj),0)  as BG20_AngJumlah from BG01_MOHONDT_RV as a
                    inner join  BG01_MOHON_RV as b on a.BG20_NoMohon = b.BG20_NoMohon
    ...
    Private Sub gvButiran_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvButiran.SelectedIndexChanged
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/SEMAKAN BAJET/MaklumatBajet_RV.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}&kodSkrin=2&no={strNoMohon}&kodvot={kodVot}", False)
    End Sub
