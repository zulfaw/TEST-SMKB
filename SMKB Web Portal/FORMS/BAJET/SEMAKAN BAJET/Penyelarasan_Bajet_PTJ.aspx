<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Penyelarasan_Bajet_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Penyelarasan_Bajet_PTJ" EnableEventValidation="False" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1><%= TotalRecDt %>Penyelerasan Bajet PTj</h1>
                ...
                <div>
                    <table class="table table table-borderless" style="width: 100%;">
                        <tr>
                            <td class="auto-style3">
                                <label class="control-label" for="">
                                    Bajet tahun&nbsp; : <asp:TextBox ID="txtYear" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                </label></td>
                        ...
                        <tr style="height: 25px">
                            <td class="auto-style3">
                                <label class="control-label" for="">
                                    Kumpulan Wang : <asp:DropDownList ID="ddlKW" runat="server" AutoPostBack="True" CssClass="form-control" Style="width: 40%;">
                                </asp:DropDownList>
                                </label></td>
                            <td>
                                &nbsp;</td>
                     ...
                     <%--   <tr style="height: 25px" >
                            <td class="auto-style3" colspan="2"><table border="1" class="table table table-borderless" style="width: 30%;">
                                <tr style="background-color: #FECB18">
                                    <td class="text-center" style="border: 1px solid black;">Vot Am</td>
                                    <td class="text-center" style="border: 1px solid black;"><strong>Jumlah Lulus (RM)</strong></td>
                                    <td class="text-center" style="border: 1px solid black;"><strong>Jumlah Mohon (RM)</strong></td>
                                </tr>
                                <tr>
                                    <td class="text-center" style="border: 1px solid black;">10000</td>
                                    <td class="text-right" style="border: 1px solid black;">
                                        <asp:Label ID="lblAmaunMohon" runat="server"></asp:Label>
                                    </td>
                                    <td class="text-right" style="border: 1px solid black;">-</td>
                                </tr>
                                <tr>
                                    <td class="text-center" style="border: 1px solid black;">20000</td>
                                    <td class="text-right" style="border: 1px solid black;">0.00</td>
                                    <td class="text-right" style="border: 1px solid black;">-</td>
                                </tr>
                                <tr>
                                    <td class="auto-style1" style="border: 1px solid black;">30000</td>
                                    <td class="auto-style2" style="border: 1px solid black;">
                                        <asp:Label ID="lblAmaunBend" runat="server" />
                                    </td>
                                    <td class="auto-style2" style="border: 1px solid black;">0.00</td>
                                </tr>
                                <tr>
                                    <td class="text-center" style="border: 1px solid black;">40000</td>
                                    <td class="text-right" style="border: 1px solid black;">
                                        <asp:Label ID="lblAmaunNC" runat="server" />
                                    </td>
                                    <td class="text-right" style="border: 1px solid black;">0.00</td>
                                </tr>
                                <tr>
                                    <td class="text-center" style="border: 1px solid black;">50000</td>
                                    <td class="text-right" style="border: 1px solid black;">
                                        <asp:Label ID="lblAmaunLPU" runat="server" />
                                    </td>
                                    <td class="text-right" style="border: 1px solid black;">0.00</td>
                                </tr>
                                </table>
                            ...
                            <div class="panel-body">
                                <div class="row" style="width: 99%;">
                                    <asp:GridView ID="gvAgihPTj" runat="server" AutoGenerateColumns="False" BorderColor="#333333" BorderStyle="Solid"
                                        ...
                                        Width="100%" OnRowCommand="gvAgihPTj_RowCommand" OnRowDataBound="gvAgihPTj_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField  HeaderText="Operasi">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt10000Op_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon1_Operasi", "{0:N2}")%>'/>
                                                </ItemTemplate>

                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                                        <asp:Label ID="lblJumAm10000Op" runat="server"  Font-Bold="true" />
                                                    </div>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" Width="200px"  Font-Size="9pt" BackColor="#ACD6FF" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Komited">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt10000Ko_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon1_Koperasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Operasi">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt20000Op_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon2_Operasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Komited">
                                                 <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt20000Ko_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon2_Koperasi", "{0:N2}")%>'/>
                                                 </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Operasi">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt30000Op_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon3_Operasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Komited">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt30000Ko_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon3_Koperasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Operasi">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt40000Op_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon4_Operasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Komited">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt40000Ko_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon4_Koperasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Operasi">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt50000Op_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon5_Operasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                            ...
                                            <asp:TemplateField HeaderText="Komited">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblAmt50000Ko_LPU" runat="server" visible="false"  Text='<%#Eval("AmtMohon5_Koperasi", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                             ...
                                             <asp:TemplateField HeaderText="Jumlah Permohonan (RM)">
                                                <ItemTemplate>
                                                   <asp:Label ID="lblAmtJum" runat="server" ForeColor="#003399" Font-Bold="true" Font-Size="9pt"  Text='<%#Eval("JumAgih", "{0:N2}")%>'/>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right;">
                                                        <asp:Label ID="lblAmtJumAll" runat="server" ForeColor="#003399" Font-Bold="true" Font-Size="9pt" />
                                                    </div>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" Width="200px" BackColor="#D0E8FF" Font-Size="9pt" />
                                            </asp:TemplateField>                                  
                                    ...
                                    <div  style="text-align: center; margin-top: 10px;">
                                        <asp:LinkButton ID="lnlBtnSaveSbg" runat="server" CssClass="btn">
						<i class="far fa-save fa-lg"></i>&nbsp;&nbsp;&nbsp;Posting
                                        </asp:LinkButton>
                                    </div>
                    ...
                    <ajaxToolkit:TabPanel ID="tabABM" runat="server" HeaderText="Senarai Permohonan">
                        ...
                        <i class="fa fa-plus fa-lg"></i>&nbsp;&nbsp;&nbsp;Mohon Baru
                            ...
                            <div style="text-align: left; margin-top: 10px;">
                                ...
                                <asp:GridView ID="gvMohonBajet" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" EmptyDataText=" "
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Kod KW" DataField="KodKW" SortExpression="KodKW" ReadOnly="True">
                                            <HeaderStyle CssClass="centerAlign" />
                                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                                        </asp:BoundField>

                                        <asp:BoundField HeaderText="Kod KO" DataField="KodOperasi" SortExpression="KodOperasi" ReadOnly="True">
                                            <HeaderStyle CssClass="centerAlign" />
                                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="Program / Aktiviti">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblNoMohon" runat="server" Visible="false" Text='<%#Eval("BG20_NoMohon") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="30%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField HeaderText="NoMohon" DataField="BG20_NoMohon">
                                        <HeaderStyle CssClass="hiddencol" />
                                        <ItemStyle CssClass="hiddencol" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="Anggaran Permohonan (RM)">
                                            <ItemTemplate>
                                                <asp:Label ID="lbtnAnggaran" runat="server" Text='<%#Eval("AngJumBesar", "{0:N2}")%>'></asp:Label>
                                            </ItemTemplate>
