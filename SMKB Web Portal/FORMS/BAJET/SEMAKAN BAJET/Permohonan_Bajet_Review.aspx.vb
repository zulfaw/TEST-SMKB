...
Public Class Permohonan_Bajet_Review
...
AND KodBahagian = '4101')
    ...
    Private Sub Permohonan_Bajet_Review_Init(sender As Object, e As EventArgs) Handles Me.Init
        fPopMohonDt()
    End Sub
    ...
    Private Function fGetAmtVotAm(strTahun, strKodKW, strKO, strKodPTj, strVotAm) As Decimal
        Try
            ...
            strSql = $"select isnull(sum(b.BG20_JumKetuaPTj),0) as BG06_Amaun from BG01_Mohon_RV as a inner join BG01_MohonDt_RV as b on a.BG20_NoMohon = b.BG20_NoMohon where a.BG20_TahunBajet = '{strTahun}' and a.KodKW = '{strKodKW}' and a.KodOperasi = '{strKO}' and a.KodBahagian = '{strKodPTj}' and b.KodVotAm = '{strVotAm}'  and b.BG20_Aktif ='1'"
    ...
    Private Sub fBindDdlKW()
        Try
            ...
            Dim strSql As String = "select KodKw, Butiran from MK_Kw where Status = '1'
                                    and KodKw in ('01','07')
                                    order by KodKw"
    ...
    Private Sub fBindGVMohonBajet(KodStatus As String)
        Try
            ...
            If KodStatus = String.Empty Then
                strSql = $"select DISTINCT a.BG20_NoMohon, BG20_TarikhMohon, BG20_Program, ISNULL((BG20_AmaunMohon),0) AS BG20_AmaunMohon, StatusDok, KodKW, KodOperasi, BG20_Justifikasi from BG01_Mohon_RV as a WHERE a.BG20_Status = 1 ORDER BY BG20_NoMohon DESC,  BG20_TarikhMohon DESC"
            Else
                strSql = $"select DISTINCT a.BG20_NoMohon, BG20_TarikhMohon, BG20_Program, ISNULL((BG20_AmaunMohon),0) AS BG20_AmaunMohon, StatusDok, KodKW, KodOperasi, BG20_Justifikasi from BG01_Mohon_RV as a where StatusDok in ('{KodStatus}','01') ORDER BY BG20_NoMohon DESC,  BG20_TarikhMohon DESC"
            End If
    ...
    Protected Sub lbtnHantar_Click(sender As Object, e As EventArgs) Handles lbtnHantar.Click
        ...
        statusDok = "24" 'SEMAKAN BENDAHARI
            ...
            If chk.Checked Then
                ...
                strSqlButiran = "Update BG01_Mohon_RV set StatusDok = @statusDok , BG20_StaffIDPelulus = @idSemak ,BG20_TarikhSemak = @tarikh, B20_FlagPTj = '1'  WHERE BG20_Status = @status and BG20_NoMohon = @NoMohon"
                paramSqlBtrn = {
                    ...
                    Dim strSQLStatusDok = "INSERT INTO BG12_StatusDok (BG01_NoPermohonan, KodStatusDok, BG12_TkhProses, BG12_NoStaf) " &
                           " VALUES (@NoMohon, @StatusKod, @Tarikh, @NoStaf)"
