<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Permohonan_Bajet_Review.aspx.vb" Inherits="SMKB_Web_Portal.Permohonan_Bajet_Review" EnableEventValidation="False" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1><%= TotalRecDt %>Permohonan Bajet Review</h1>
                        ...
                        <tr>
                            <td class="auto-style3">
                                <label class="control-label" for="">
                                    Bajet tahun&nbsp; : <asp:TextBox ID="txtYear" runat="server" CssClass="form-control" Enabled="false" Style="width: 4%;"></asp:TextBox>
                                </label></td>
                    ...
                    <ajaxToolkit:TabPanel ID="tabABM" runat="server" HeaderText="Senarai Permohonan">
                        ...
                        <ContentTemplate>
                            <div style="text-align: left; margin-top: 10px;">
                                <div style="text-align: right;"">                 <label class="control-label" for="">
