...
Public Class View_Doc
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim intIdMohon As Integer = CInt(Request.QueryString("IdMohon"))
        Dim intId As Integer = CInt(Request.QueryString("Id"))
        Dim strFileName = intIdMohon & "-" & intId
        ...
        If Not IsPostBack Then
            ...
            Try
                Dim folderPath As String = "~/Upload/Document/" & strKodModul & "/" & intIdMohon
