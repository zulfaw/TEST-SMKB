...
Public Class MaklumatSemakanBajet_NC_17122020
    ...
    Protected Sub lbtnHapus_Click(sender As Object, e As EventArgs) Handles lbtnHapus.Click
        ...
        If countButiran > 0 Then
            fGlobalAlert($"Rekod telah dipadam!", Me.Page, Me.[GetType](), "../../BAJET/PERMOHONAN BAJET/Kelululusan_NC.aspx")
        Else
                    ...
                    KodKW = @kodkw, BG20_Justifikasi = @justifikasi,  BG20_AmaunMohon_KB = @amaun Where BG20_NoMohon = '{noPermohonan}'"
                        ...
                        If dbconn.fUpdateCommand(strSQL_Save, paramSql_simpan) > 0 Then
                         ...
                         New SqlParameter("@nomohon", noPermohonan)
                            ...
                            If countButiran > 0 Then
                                fGlobalAlert($"Rekod baru telah ditambah bersama '{countButiran.ToString}' butiran permohonan!", Me.Page, Me.[GetType](), "../../BAJET/PERMOHONAN BAJET/Kelululusan_NC.aspx")
                            Else
                        ...
                        Dim paramSql2() As SqlParameter =
                  {
                     ...
                     New SqlParameter("@Ulasan", "-")
                        ...
                        If dbconn.fInsertCommand(strSql, paramSql) > 0 Then
                            ...
                            If countButiran > 0 Then
                                fGlobalAlert($"Rekod telah dikemaskini bersama '{countButiran.ToString}' butiran permohonan!", Me.Page, Me.[GetType](), "../../BAJET/PERMOHONAN BAJET/Kelululusan_NC.aspx")
                            Else
                                fGlobalAlert("Maklumat Butiran tidak berjaya disimpan!", Me.Page, Me.[GetType]())
                            End If
