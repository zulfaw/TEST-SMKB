<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Penyediaan_Bajet_Bendahari.aspx.vb" Inherits="SMKB_Web_Portal.Penyediaan_Bajet_Bendahari" EnableEventValidation="False" %>
<%@ Register TagPrefix="UC" TagName="PEMOHON" Src="summary2.ascx" %>
<%@ Register TagPrefix="SUM" TagName="SUM" Src="summary_ABM7.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1><%= TotalRecDt %>Penyediaan Bajet Bendahari</h1>
                    ...
                    <ajaxToolkit:TabPanel ID="tabABM" runat="server" HeaderText="Senarai Permohonan">
                        ...
                        <ContentTemplate>
                            <div style="text-align: left; margin-top: 10px;">
                                <label class="control-label" for="">
                                    Kod Operasi : <asp:DropDownList ID="ddlKO" runat="server" AutoPostBack="True" CssClass="form-control" Style="width: 20%;">
                                </asp:DropDownList>
                                <br />
