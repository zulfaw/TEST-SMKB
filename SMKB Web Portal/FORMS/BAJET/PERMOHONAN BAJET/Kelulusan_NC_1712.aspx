<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Kelulusan_NC_1712.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_NC_1712" EnableEventValidation="False" %>
                        ...
                        <ContentTemplate>
                            <div style="text-align: left; margin-top: 10px;">
                                ...
                                <asp:GridView ID="gvMohonBajet" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" "
                                    CssClass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" ShowFooter="true" OnDataBound="gvAgihPTj_RowCommand">
                                    <Columns>
