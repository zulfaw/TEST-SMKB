<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Defend_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Defend_PTJ" EnableEventValidation="False" %>
        ...
        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="tabCtrl" Height="850px" Width="100%">                                    
                <ajaxToolkit:TabPanel ID="tabABM" runat="server" HeaderText ="Anggaran Belanja Mengurus (ABM)">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvAbmMaster" runat="server" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#999999" BorderStyle="Double" BorderWidth="1px" CssClass="table table-striped table-bordered table-hover" DataKeyNames="KodVot" EmptyDataText=" " Font-Size="8pt" ShowFooter="True" ShowHeaderWhenEmpty="True" Width="95%">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:BoundField DataField="JumMohon" HeaderText="Permohonan Awal 2021 (RM)">
                                <ItemStyle Width="20%" HorizontalAlign="Right"/>
                                </asp:BoundField>
                                <asp:BoundField DataField="JumMohon" HeaderText="Permohonan Terkini 2021 (RM)">
                                <ItemStyle Width="20%" HorizontalAlign="Right"/>
                                </asp:BoundField>
                                ...
                                <asp:TemplateField>
                                   ...
                                   height:0px;overflow: hidden;" Width="95%">
                                                    <asp:GridView ID="gvAbmDt" runat="server" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#999999" BorderStyle="Double" BorderWidth="1px" CssClass="table table-striped table-bordered table-hover" EmptyDataText=" " Font-Size="8pt" OnRowCreated="gvAbmDt_RowCreated" OnRowDataBound="gvAbmDt_RowDataBound" ShowFooter="True" ShowHeaderWhenEmpty="True" Width="100%">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Bil">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:BoundField DataField="KodVot" HeaderText="Objek Sebagai" ReadOnly="True">
                                                            <ItemStyle Font-Bold="True" Width="5%" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="Jenis" HeaderText="Deskripsi" ReadOnly="True">
                                                            <ItemStyle Font-Bold="True" Width="15%" />
                                                            </asp:BoundField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label runat="server" Text="<%# lblPeruntukanPrev1 %>" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" Text='<%# Eval("PerbelanjaanPrev1") %>' />
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemStyle BackColor="#E1E1E1" ForeColor="#0033CC" HorizontalAlign="Right" Width="10%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                    ...
                    <ContentTemplate>                         
                        ...
                        <i class="fa fa-plus fa-lg"></i>&nbsp;&nbsp;&nbsp;Mohon Baru
                                    ...
                                    <div style="text-align:left;margin-top:10px;">
                                        <asp:Label runat="server" Text="Jumlah Rekod : "></asp:Label>
                                        <span style="font-weight :bold;"><%= TotalRec %></span>
