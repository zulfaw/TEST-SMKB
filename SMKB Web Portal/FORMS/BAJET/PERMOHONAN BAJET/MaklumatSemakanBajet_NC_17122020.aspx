<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatSemakanBajet_NC_17122020.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatSemakanBajet_NC_17122020" EnableEventValidation ="False"  %>
        ...
        <div class="panel-heading">
            ...
            <asp:GridView ID="gvButiran" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True" EmptyDataText=""
                cssclass="table table-striped table-bordered table-hover" Width="100%" Font-Size="8pt" ShowFooter="True"  
                 AllowSorting="True" AllowPaging="True" PageSize="5" DataKeyNames="NoButiran">
                 <columns>
