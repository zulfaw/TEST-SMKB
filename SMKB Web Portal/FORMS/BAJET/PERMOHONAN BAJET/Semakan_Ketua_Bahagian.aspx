<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Semakan_Ketua_Bahagian.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Ketua_Bahagian" EnableEventValidation ="False"  %>
    ...
    <ContentTemplate>
        ...
        <div class="panel-body" style="overflow-x:auto">
                   ...
                   <table style="width:100%">
                       <tr>
                           ...
                           <td>
                               ...
                               &nbsp;&nbsp;&nbsp;&nbsp; Tahun Bajet :
                               <asp:DropDownList ID="ddlTahun" runat="server" AutoPostBack="True" CssClass="form-control" Width="15%"></asp:DropDownList>
                               </label>
                           </td>
                           <td colspan="2">
                               &nbsp;</td>
                       ...
                       <tr>
                           ...
                           <td colspan="2" style="text-align:right">
                               <label class="control-label" for="">
                               <asp:LinkButton ID="lbtnMohonBaru" runat="server" CssClass="btn btn-info" Visible="false">
                       ...
                       <tr>
                           <td style="width: 121px">
                               ...
                               Unit :</label></td>
                           <td colspan="2">
                               <asp:DropDownList ID="ddlUnit" runat="server" AutoPostBack="True" CssClass="form-control" Width="60%">
                               </asp:DropDownList>
                           </td>
                ...
                <asp:TemplateField  HeaderText="Justifikasi">
                 <ItemTemplate>
                  ...
                  <asp:BoundField HeaderText="Anggaran Permohonan (RM)" DataField="AngJumBesar" SortExpression="AngJumBesar" HeaderStyle-CssClass="centerAlign" DataFormatString="{0:N}">
                    ...
                    <%--<asp:buttonfield buttontype="Button" commandname="Select" text="Info" />--%><asp:TemplateField>                        
                        <ItemTemplate>
            ...
            <div class="panel panel-default" style="width:90%" >
                <div ><h4 class="panel-title" style="font-weight: normal"><strong>Status Semakan</strong>
