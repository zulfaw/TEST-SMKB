<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Maklumat_Agihan_Bajet_Am_Bend.aspx.vb" Inherits="SMKB_Web_Portal.Maklumat_Agihan_Bajet_Am_Bend" %>
                    ...
                    <div style="margin-top: 20px;">
                        <asp:GridView ID="gvObjSebagai" runat="server" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#333333" BorderStyle="Solid" CssClass="table table-striped table-bordered table-hover" EmptyDataText=" " Font-Size="8pt" HeaderStyle-BackColor="#6699FF" ShowFooter="True" ShowHeaderWhenEmpty="True" Width="100%">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Agihan">                  
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Belanja">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Mohon  (RM)">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Cadangan Bendahari  (RM)">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Agihan NC (RM)">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Agihan LPU (RM)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAmtLPU" runat="server" Text='<%# Eval("AmtAgih_LPU", "{0:N2}") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <div style="text-align: right;">
                                            <asp:Label ID="lblTotAgih_LPU" runat="server" ForeColor="#003399" Font-Bold="true" />
                                        </div>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>
                    ...
                    <asp:GridView ID="gvButiran" runat="server" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#333333" BorderStyle="Solid" CssClass="table table-striped table-bordered table-hover" EmptyDataText=" " Font-Size="8pt" HeaderStyle-BackColor="#6699FF" ShowFooter="True" ShowHeaderWhenEmpty="True" Width="100%"
                       >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Agihan LPU (RM)">
                                <ItemTemplate>
                                    <asp:Label ID="lblAmtAgihanLPU" runat="server" Text='<%# Eval("AmtAgihan_LPU") %>' />
                                </ItemTemplate>
                                <FooterTemplate>
                                    <div style="text-align: right;">
