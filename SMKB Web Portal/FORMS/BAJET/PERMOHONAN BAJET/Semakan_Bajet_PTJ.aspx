<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Semakan_Bajet_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Bajet_PTJ" EnableEventValidation="False" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1><%= TotalRecDt %>Semakan Bajet PTj</h1>
                    ...
                    <table class="table table table-borderless" style="width: 100%;">
                        ...
                        <tr style="height: 25px">
                            <td class="auto-style3">
                                <label class="control-label" for="">
                                    Kumpulan Wang :
                                    <asp:DropDownList ID="ddlKW" runat="server" AutoPostBack="True" CssClass="form-control" Style="width: 20%;">
                                    </asp:DropDownList>
                                </label>
                            </td>
                            <td style="text-align: right">
                                <asp:LinkButton ID="lblCetakDt" runat="server" CssClass="HelpDeskLink" ToolTip="Papar Permohonan Bajet" Text="Cetak Permohonan">											
