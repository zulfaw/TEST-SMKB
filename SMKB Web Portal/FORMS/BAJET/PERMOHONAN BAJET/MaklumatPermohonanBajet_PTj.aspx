<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatPermohonanBajet_PTj.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatPermohonanBajet_PTj" EnableEventValidation ="False"  %>
            ...
            <asp:GridView ID="gvButiran" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True" EmptyDataText=" "
                ...
                AllowSorting="True" AllowPaging="True" PageSize="5">
                    ...
                    <asp:TemplateField HeaderText="Objek Am" ItemStyle-Width="10%" SortExpression="KodVotA" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:label id="StrKodVot" runat="server" Text='<%# Eval("KodVotA") %>'></asp:label>
                        </ItemTemplate>                        
                        <%--<EditItemTemplate>
                            <asp:DropDownList ID="ddlKodVot" runat="server" CssClass="form-control" Width="300px"></asp:DropDownList>
                        </EditItemTemplate>--%>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Objek Sebagai" ItemStyle-Width="1%" SortExpression="KodVotSbg" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:label id="StrKodVot" runat="server" Text='<%# Eval("KodVotSbg") %>'></asp:label>
                        </ItemTemplate>                        
                        <%--<EditItemTemplate>
                            <asp:DropDownList ID="ddlKodVot" runat="server" CssClass="form-control" Width="300px"></asp:DropDownList>
                        </EditItemTemplate>--%>
