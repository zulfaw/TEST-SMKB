<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatPermohonanBajet.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatPermohonanBajet" EnableEventValidation="False" %>
        ...
        <div class="row">
            ...
            <div class="pull-right">
                <asp:LinkButton ID="lbtnKembali" runat="server" CssClass="btn-circle" ToolTip="Kembali">
                    <i class="fa fa-times-circle-o fa-lg"></i>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Permohonan</h4><asp:Label runat="server" id="lblHiddenOpen" name="lblHiddenOpen" visibe="false"></asp:Label>
                                        ...
                                        <table style="width: 100%" class="table table table-borderless">
                                            <tr>
                                                <td class="auto-style1">
                                                    <label class="control-label" for="">No Mohon</label></td>
                                                <td class="auto-style2">
                                                    <asp:TextBox ID="txtNoMohon" runat="server" Width="15%" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                                    &nbsp &nbsp &nbsp &nbsp
                        <label class="control-label" for="">Status</label>
                                                    &nbsp &nbsp
                        <asp:TextBox ID="txtStatus" runat="server" Width="25%" CssClass="form-control" ReadOnly="true"></asp:TextBox>&nbsp &nbsp &nbsp &nbsp <label class="control-label" for=""><asp:Label runat="server" ID="lblTextUlasan"/></label>
                                                    &nbsp &nbsp<asp:TextBox ID="txtUlasan" runat="server" Width="40%" CssClass="form-control" ReadOnly="true" Visible="false"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 15%;">
                                            ...
                                            <tr id="trBahagian" runat="server">
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Bahagian</label></td>
                                                <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvddlBahagian" runat="server" ControlToValidate="ddlBahagian" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnSimpan" Display="Dynamic" CssClass="fontValidatation" ></asp:RequiredFieldValidator>--%>
                                            ...
                                            <tr id="trUnit" runat="server">
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Unit</label></td>
                                                <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvddlUnit" runat="server" ControlToValidate="ddlUnit" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnSimpan" Display="Dynamic" CssClass="fontValidatation" ></asp:RequiredFieldValidator>--%>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Tahun Bajet</label></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Jenis Dasar</label><span class="auto-style3"><label>*</label></span>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlJenDasar" runat="server" CssClass="form-control" Width="15%">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Kumpulan Wang</label><span class="auto-style3"><label>*</label></span>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlKW" runat="server" AutoPostBack="true" CssClass="form-control" Width="35%">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td style="width: 15%;"K<label class="control-label" for="">Kod Operasi</label><span class="auto-style3"><label>*</label></span>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlKodOperasi" runat="server" CssClass="form-control" Width="15%">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Program / Aktiviti</label><span class="auto-style3"><label>*<br />
                                                    </label>
                                                    </span></td>
                                                <td>
                                                    <asp:TextBox ID="txtProgram" runat="server" TextMode="multiline" CssClass="form-control" Width="100%" maxlenght="255"></asp:TextBox>
                                                    <span class="auto-style3">(Tidak melebihi 255 Aksara)</span>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="revMessageBoardContents" ControlToValidate="txtProgram"
                                                        Text="*Telah melebihi 255 karakter" ValidationExpression="^[\s\S]{0,255}$" runat="server" ForeColor="#820303" ValidationGroup="btnSimpan" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Justifikasi</label><span class="auto-style3"><label>*</label></span></td>
                                                <td>
                                                    <asp:TextBox ID="txtJust" runat="server" TextMode="multiline" CssClass="form-control" Width="100%" Rows="5"  maxlength = "1000"></asp:TextBox>
                                                    <span class="auto-style3">(Tidak melebihi 1000 Aksara) </span> <asp:RequiredFieldValidator ID="rfvJust" runat="server" ControlToValidate="txtJust" ErrorMessage="" ForeColor="#820303" Text="*Sila Isi" ValidationGroup="btnSimpan" Display="Dynamic" CssClass="fontValidatation"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate ="txtJust" 
                                                Text="*Telah melebihi 1000 karakter" ValidationExpression="^[\s\S]{0,1000}$" runat="server" ForeColor="#820303" ValidationGroup="btnSimpan"/>
                                                </td>
                                            </tr>
                                            </table>
                                                ...
                                                <table style="width: 100%" class="table table table-borderless">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvVotSbg0" runat="server" ControlToValidate="ddlVotA" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnSaveButiran_"></asp:RequiredFieldValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlVotA" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnKemasButiran_"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 20%;"><label class="control-label" for="">Objek Sebagai</label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlVotSbg" runat="server" CssClass="form-control" Width="60%">
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="rfvVotSbg" runat="server" ControlToValidate="ddlVotSbg" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnSaveButiran_"></asp:RequiredFieldValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlVotSbg" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnKemasButiran_"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 20%;">Buitran</td>
                                                        <td>
                                                            <asp:TextBox ID="txtButiranDt" runat="server" CssClass="form-control" Rows="5" TextMode="multiline" Width="100%"  maxlength = "1000"></asp:TextBox>
                                                            <span class="auto-style3">(Tidak melebihi 1000 Aksara)</span>   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtButiranDt" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila isi" ValidationGroup="btnSaveButiran_"></asp:RequiredFieldValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtButiranDt" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnKemasButiran_"></asp:RequiredFieldValidator>
                                                       
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 20%;">
                                                            <label class="control-label" for="">Jumlah Permohonan (RM)</label></td>
                                                        <td>
                                                            <asp:TextBox ID="txtAngJum" name="txtAngJum" runat="server" CssClass="form-control rightAlign" Width="100px"  onkeypress="return isNumberKey(event,this)"></asp:TextBox>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvKuantiti0" runat="server" ControlToValidate="txtAngJum" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila isi" ValidationGroup="btnSaveButiran_"></asp:RequiredFieldValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtAngJum" CssClass="fontValidatation" Display="Dynamic" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnKemasButiran_"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr <%If lblHiddenOpen.Text = "0" Then %>style="visibility:hidden" <%end if%>>
                        ...
                        <i class="fa fa-refresh fa-lg"></i>&nbsp;&nbsp;&nbsp;Reset
                                                            ...
                                                            &nbsp;&nbsp;
                    <asp:LinkButton ID="lbtnSaveButiran" runat="server" CssClass="btn btn-info" ValidationGroup="btnSaveButiran_" ToolTip="Tambah ke senarai">
                        <i class="fa fa-plus-circle fa-lg"></i>&nbsp;&nbsp;&nbsp;Tambah
                    </asp:LinkButton>
                                                            &nbsp;&nbsp;
                    <asp:LinkButton ID="lbtnKemaskini" runat="server" CssClass="btn btn-info" ValidationGroup="btnKemasButiran_" ToolTip="Kemaskini" Visible="false">
                        <i class="fa fa-plus-circle fa-lg"></i>&nbsp;&nbsp;&nbsp;Kemaskini
                                                ...
                                                <asp:GridView ID="gvButiran" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True" EmptyDataText=" "
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Objek Am" ItemStyle-Width="10%" SortExpression="KodVotA" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlKodVot" runat="server" CssClass="form-control" Width="300px"></asp:DropDownList>
                                                        ...
                                                        <asp:TemplateField HeaderText="Objek Sebagai" ItemStyle-Width="10%" SortExpression="KodVotSbg" HeaderStyle-CssClass="centerAlign" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlKodVot" runat="server" CssClass="form-control" Width="300px"></asp:DropDownList>
                                                        ...
                                                        <asp:TemplateField HeaderText="Butiran" ItemStyle-Width="40%" SortExpression="Butiran" HeaderStyle-CssClass="centerLeft" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
				...
				<i class="far fa-trash-alt fa-lg"></i>
                                        ...
                                        <table style="width: 100%" class="table table table-borderless">
                                            <tr>
                                                <td style="width: 15%;">&nbsp; Dokumen (Format PDF)</td>
                                                <td>
                                                    <div class="form-inline">
                                                        <asp:FileUpload ID="fuBajet" runat="server" Width="50%" CssClass="form-control" Height="25px" BackColor="#FFFFCC" EnableViewState="true" />
                                                    ...
                                                    <asp:GridView ID="gvLampiran" runat="server" AutoGenerateColumns="false" BorderColor="#333333" BorderStyle="Solid" CssClass="table table-striped table-bordered table-hover" DataKeyNames="BG16_Id" EmptyDataText="No files uploaded" Font-Size="8pt" HeaderStyle-BackColor="#6699FF" ShowHeaderWhenEmpty="true" Width="80%">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="3%">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Select" CssClass="btn-xs" ToolTip="Padam"
                                                                        OnClientClick="return confirm('Anda pasti untuk padam rekod ini?');">
				                                        <i class="far fa-trash-alt fa-lg"></i>
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
                                        ...
                                        <div class="row">
                                            <div style="text-align: center" <%If lblHiddenOpen.Text = "0" Then %>hidden <%end if%>>
            ...
            <asp:Panel ID="pnlpopupHantar" runat="server" BackColor="White" Width="70%" Style="display: none">
                <table style="border: Solid 3px #D5AA00; width: 100%; height: 100%;">
                    <tr style="background: linear-gradient(to bottom, #fceabb 0%,#fccd4d 50%,#f8b500 51%,#fbdf93 100%);">
                        <td style="height: 10%; font-weight: bold; text-align: center;" colspan="2">Maklumat Lanjut
                        </td>
