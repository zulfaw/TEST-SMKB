<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Permohonan_Bajet.aspx.vb" Inherits="SMKB_Web_Portal.Permohonan_Bajet"%>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Permohonan Bajet</h1>
...
<style type="text/css"> .hiddencol { display: none; } </style>  
    ...
    <ContentTemplate>
        ...
        <div style="text-align:right; color:blue"><asp:HyperLink runat="server" target="_blank" NavigateUrl="~/Upload/Document/Bajet/Manual_Pengguna_Permohonan_Bajet.pdf">- Manual Pengguna -</asp:HyperLink></div>
        ...
        <div class="panel-body" style="overflow-x:auto">
                ...
                <div>
                   <table style="width:100%">
                       <tr>
                           ...
                           <td>
                               <label class="control-label" for="">
                               <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" CssClass="form-control" Width="30%">
                               </asp:DropDownList>
                               &nbsp;&nbsp;&nbsp;&nbsp; Tahun Bajet :
            ...
            <asp:GridView ID="gvMohonBajet" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True"  EmptyDataText=" "
