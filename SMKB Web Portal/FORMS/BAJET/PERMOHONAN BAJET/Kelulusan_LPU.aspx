<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Kelulusan_LPU.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_LPU" EnableEventValidation="False" %>
<%@ Register TagPrefix="UC" TagName="PEMOHON" Src="summary2.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1><%= TotalRecDt %>Kelulusan LPU</h1>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" CssClass="form-control" Width="50%"></asp:DropDownList>
                ...
                <div>
                    <table class="table table table-borderless" style="width: 100%;">
                        ...
                        <tr style="height: 25px">
                            <td class="auto-style3">
                                <label class="control-label" for="">
                                    Kumpulan Wang : <asp:DropDownList ID="ddlKW" runat="server" AutoPostBack="True" CssClass="form-control" Style="width: 20%;">
                                </asp:DropDownList>
                                </label></td>
                                   <td style="text-align:right"><asp:LinkButton ID="lblCetak" runat="server" CssClass="HelpDeskLink" ToolTip="Lihat" Text="Cetak" >											
                ...
                <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" CssClass="tabCtrl" Height="100%" Width="100%">
                    ...
                    <ajaxToolkit:TabPanel ID="tabABM" runat="server" HeaderText="Senarai Permohonan">
                        ...
                        <ContentTemplate>
                            <div style="text-align: left; margin-top: 10px;">
                                Jumlah Rekod : <asp:Label ID="lblRekod" runat="server"/>
                                        ...
                                        <asp:TemplateField HeaderText="Justifikasi">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDescription" runat="server" class="gridViewToolTip"
                                                    Text='<%# Limit(Eval("BG20_Justifikasi"), 30) %>' tooltip='<%# Eval("BG20_Justifikasi") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="30%" />
                                        </asp:TemplateField>
                ...
                <div class="panel-body well" style="width: 70%;">
                    <div class="row">
                                        <table style="width: 100%" class="table table table-borderless">
                                            <tr>
                                                <td style="width: 20%;">&nbsp; Minit Mesyuarat (Format PDF)</td>
                                                <td>
                                                    <div class="form-inline">
                                                        <asp:FileUpload ID="fuBajet" runat="server" BackColor="#FFFFCC" CssClass="form-control" Height="25px" Width="50%" />
                                                        <asp:Button ID="btnUpload" runat="server" CssClass="btn btn-info" Text="Muat Naik" Visible="True" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
