<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatSemakanBajet_Bend.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatSemakanBajet_Bend" EnableEventValidation="False" %>
        ...
        <ContentTemplate>
            <div class="container-fluid">
                ...
                <i class="fa fa-arrow-left fa-lg"></i>&nbsp;&nbsp;&nbsp;Kembali
                            ...
                            <asp:Label ID="lblKodSub" runat="server" Visible="false"></asp:Label>
                            <asp:Label ID="lblKodSubMenu" runat="server" Visible="false"></asp:Label>
                            <asp:Label ID="lblKodSkrin" runat="server" Visible="false"></asp:Label>
                            <asp:Label ID="lblKodVotAmHid" runat="server" Visible="true"></asp:Label>
                        </div>
                    </div>
                </div>
                ...
                <asp:LinkButton ID="lbtnKembali" runat="server" CssClass="btn-circle" ToolTip="Kembali">
                    <i class="fa fa-times-circle-o fa-lg"></i>
                        ...
                        <asp:TextBox ID="txtStatus" runat="server" Width="40%" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Tarikh</label></td>
                                                <td>
                                                    <asp:TextBox ID="txtTarikh" runat="server" CssClass="form-control leftAlign" Width="80px" ReadOnly="true"></asp:TextBox>
                                                    <asp:Label id="lblDelete" runat="server" Text='<%# Eval("statusDLT") %>' Visible="True"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <asp:RequiredFieldValidator ID="rfvddlUnit" runat="server" ControlToValidate="ddlUnit" ErrorMessage="" ForeColor="#820303" Text="*Sila Pilih" ValidationGroup="btnSimpan" Display="Dynamic" CssClass="fontValidatation" ></asp:RequiredFieldValidator>--%>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">K<label class="control-label" for="">od Operasi</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Program / Aktiviti</label></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td style="width: 15%;">
                                                    <label class="control-label" for="">Justifikasi</label></td>
                                                <td>
                                        ...
                                        <div class="panel panel-default" style="overflow-x: scroll; width: 95%;">
                                            ...
                                            <div class="panel-body">
                                                <table style="width: 100%" class="table table table-borderless">
                                                    ...
                                                    <tr>
                                                        <td style="width: 20%;">O<label class="control-label" for="">bjek Sebagai</label>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtAngJum" name="txtAngJum" runat="server" CssClass="form-control rightAlign" Width="100px"></asp:TextBox>
                    ...
                    <asp:LinkButton ID="lbtnKemaskini" runat="server" CssClass="btn btn-info" ValidationGroup="btnSaveButiran" ToolTip="Kemaskini" Visible="false">
                        <i class="fa fa-plus-circle fa-lg"></i>&nbsp;&nbsp;&nbsp;Kemaskini
                                                            ...
                                                            &nbsp;&nbsp;
                    <asp:LinkButton ID="lbtnSaveButiran" runat="server" CssClass="btn btn-info" ValidationGroup="btnSaveButiran" ToolTip="Tambah ke senarai"  Visible="false">
                        <i class="fa fa-plus-circle fa-lg"></i>&nbsp;&nbsp;&nbsp;Tambah
                            ...
                            <asp:DropDownList ID="ddlKodVot" runat="server" CssClass="form-control" Width="300px"></asp:DropDownList>
                                                        ...
                                                        <asp:TemplateField HeaderText="Butiran" ItemStyle-Width="50%" SortExpression="Butiran" HeaderStyle-CssClass="centerLeft" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
					...
					<i class="far fa-edit fa-lg"></i>
                                                                ...
                                                                <asp:LinkButton ID="btnAktif" runat="server" CommandName="Aktif" CssClass="btn-xs" ToolTip="Aktif" Visible="false">
					<i class="fa fa-check" ></i>
                                                                </asp:LinkButton>

                                                                <asp:LinkButton ID="btnDelete" runat="server" CommandName="Padam" CssClass="btn-xs" ToolTip="Padam"
                                                                    OnClientClick="return confirm('Anda pasti untuk padam rekod ini?');" Visible="false">
				<i class="far fa-trash-alt fa-lg"></i>
                                                                </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Status Delete Bendahari" Visible="False">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBend" runat="server" Text='<%# Eval("BendDelete") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblAmaunAsalPTJ" runat="server" Text='<%# Eval("AmaunPTj") %>'></asp:Label>
                                                            </ItemTemplate>                                                         
                                                        </asp:TemplateField>
                                        ...
                                        <div class="row">
                                            <div style="text-align: center">
                                                <asp:LinkButton ID="lbtnAktif" runat="server" CssClass="btn btn-info" OnClientClick="return confirm('Anda pasti untuk tukar status rekod ini kepada AKTIF?');" Visible="false">
                        <i class="fa fa-trash-o fa-lg"></i>&nbsp;&nbsp;&nbsp;Aktif
                                                </asp:LinkButton>
                                                &nbsp;&nbsp;
                                                <asp:LinkButton ID="lbtnTidakAktif" runat="server" CssClass="btn btn-info" OnClientClick="return confirm('Anda pasti untuk tukar status rekod ini kepada TIDAK AKTIF?');" Visible="false" >
                        <i class="fa fa-trash-o fa-lg"></i>&nbsp;&nbsp;&nbsp;Tidak Aktif
                                                </asp:LinkButton>
                                                &nbsp;&nbsp;
