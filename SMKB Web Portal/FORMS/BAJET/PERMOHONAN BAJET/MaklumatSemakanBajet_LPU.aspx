<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatSemakanBajet_LPU.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatSemakanBajet_LPU" EnableEventValidation ="False"  %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">        
 ...
 <div class="container-fluid">
        ...
        <div>
            ...
            <asp:Label id="lblKodVotAmHid" runat="server" Visible="false"></asp:Label>
        </div>
        </div></div>
        ...
        <div class="panel-heading">
            ...
            <table style="width:100%" class="table table table-borderless">
                ...
                <tr>
                    <td class="auto-style1"><Label class="control-label" for="">Tahun Bajet</Label></td>
                    <td class="auto-style2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlJenDasar" runat="server" CssClass="form-control" Width="20%" Enabled ="False">
                        </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlKW" runat="server" AutoPostBack="true" CssClass="form-control" Width="80%" Enabled="false">
                        </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlKodOperasi" runat="server" CssClass="form-control" Width="50%" Enabled ="False">
                        </asp:DropDownList>
