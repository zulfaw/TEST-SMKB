...
Imports System.Web
Public Class Penyediaan_Bajet_Bendahari_17122020
...
where MK01_Tahun = '" & txtYear.Text & "' and MK01_VotTahun.KodKw = '" & strKodKW & "' order by MK_PTJ .KodPTJ"
    ...
    Private Sub gvAgihPTj_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvAgihPTj.SelectedIndexChanged
        Try
            ...
            'Open other page.
            Response.Redirect($"~/FORMS/BAJET/PERMOHONAN BAJET/Maklumat_Agihan_Bajet_Am_KPTJ.aspx?KodSub=" & strKodSub & "&KodSubMenu=" & strKodSubMenu & "&KodPTj=" & strKodPTj & "&Tahun=" & strTahun & "&KodKW=" & strKodKW & "&kodVot=" & strKodVot & "&strKodKO=" & strKodKO & "", False)
    ...
    Protected Sub gvMohonBajet_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvMohonBajet.RowCommand
        ...
        If e.CommandName = "Select" Then
            ...
            'Open other page.
            Response.Redirect($"~/FORMS/BAJET/PERMOHONAN BAJET/MaklumatSemakanBajet_Bendahari.aspx?KodSubMenu={KodSubMenu}&no={NoMohon}")
        End If
    End Sub
    ...
    Protected Sub lbtnHantar_Click(sender As Object, e As EventArgs) Handles lbtnHantar.Click
        ...
        If countButiran > 0 Then
            fGlobalAlert($"Berjaya hantar", Me.Page, Me.[GetType](), "../../BAJET/PERMOHONAN BAJET/Penyediaan_Bajet_Bendahari.aspx")
        Else
