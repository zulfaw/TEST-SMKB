<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Pengesahan_LPUxx.aspx.vb" Inherits="SMKB_Web_Portal.Pengesahan_LPUxx" EnableEventValidation="False" %>
...
.btnDisabled{
    ...
    <div class="row">
                            ...
                            <div>
                                <table  class="table table table-borderless" style="width:100%;" border="1"> 
                                    <tr style="background-color:#FECB18"> 
                                     ...
                                     <tr>
                                         <td class="auto-style7" style="border: 1px solid black;"></td>
                                         <td class="text-right" style="border: 1px solid black;">Permohonan0.00</td>
                                    </tr>
                                     <tr>
                                     ...
                                     <tr>
                                         <td style="border: 1px solid black;" class="auto-style7">0.00</td>
                                        <td class="text-right" style="border: 1px solid black;">Agihan NC</td>
                                    </tr>
        ...
        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="tabCtrl" Height="850px" Width="100%" >       
            <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" ActiveTabIndex="1"  HeaderText ="Ringkasan ABM">
                    <ContentTemplate>
                     <div class="panel-body" >
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Operasi">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton id="lblAmt10000Op" runat="server" CommandName="Select" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" Text='<%#Eval("Amt10000Op", "{0:N2}")%>'></asp:LinkButton>
                                        <asp:Label ID="lblLvl" runat ="server" Text="10000" Visible="false"></asp:Label>
                                        <asp:Label ID="lblKOJns" runat ="server" Text="01" Visible="false"></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Komited">
                                      <ItemTemplate>
                                        <%-- <asp:HyperLink ID="hlAmt10000" runat="server" Text='<%#Eval("Amt10000", "{0:N2}")%>'/>--%>
                                        <asp:LinkButton id="lblAmt10000Ko" runat="server" CommandName="Select" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" Text='<%#Eval("Amt10000Ko", "{0:N2}")%>'></asp:LinkButton>
                                        <asp:Label ID="lblLvlKo" runat ="server" Text="10000" Visible="false"></asp:Label>
                                        <asp:Label ID="lblKOJnsKo" runat ="server" Text="02" Visible="false"></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Operasi">
                                    <ItemTemplate>
                                        <%--<asp:HyperLink ID="hlAmt50000" runat="server" Text='<%#Eval("Amt50000", "{0:N2}")%>'/>--%>
                                        <asp:Label ID="lblAmt50000Op" runat="server" Text='<%#Eval("Amt50000Op", "{0:N2}")%>' />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Komited">
                                    <ItemTemplate>
                                        <%--<asp:HyperLink ID="hlAmt50000" runat="server" Text='<%#Eval("Amt50000", "{0:N2}")%>'/>--%>
                                        <asp:Label ID="lblAmt50000Ko" runat="server" Text='<%#Eval("Amt50000Ko", "{0:N2}")%>' />
                                    </ItemTemplate>
        ...
        <ItemTemplate>
            ...
            <asp:Label runat="server" Text="Jumlah Rekod : " /><span style="font-weight :bold;"><%= TotalRec %> </span> 
                ...
                <div ><h4 class="panel-title" style="font-weight: normal"><strong>Status</strong><asp:RadioButtonList ID="rblStatus" runat="server" RepeatDirection="Horizontal">
               ...
               <ajaxToolkit:TabPanel ID="tabKeseluruhan" runat="server" >
