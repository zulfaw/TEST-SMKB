Public Class Maklumat_Agihan_Bajet_Am_KPTJ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If strKodVot = "1" Then
                strKodVot = "10000"
                strkodName = "EMOLUMEN"
            ElseIf strKodVot = "2" Then
                strKodVot = "20000"
                strkodName = "PERKHIDMATAN DAN BEKALAN"
            ElseIf strKodVot = "3" Then
                strKodVot = "30000"
                strkodName = "ASET"
            ElseIf strKodVot = "4" Then
                strKodVot = "40000"
                strkodName = "PEMBERIAN DAN BAYARAN TETAP"
            ElseIf strKodVot = "5" Then
                strKodVot = "50000"
                strkodName = "PERBELANJAAN LAIN"
            End If
...
and left(MK_Vot.kodvot,1) = '" & Left(strKodVot, 1) & "' ORDER BY MK_Vot.KodVot"
...
group by KodKP"
    ...
    Private Sub sBindGvButiran(strKodVotSbg)
        ...
        Try
            ...
            ElseIf strKodVotSbg = "12000" Then
                dt.Rows.Add("Elaun Tetap", "Pejabat Naib Canselor, Pejabat Pengurusan dan Perhubungan Canselori, Pejabat Audit Dalam", FormatNumber(30000), FormatNumber(20000), FormatNumber(25000), "")
