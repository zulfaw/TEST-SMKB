...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1><%= TotalRecDt %>Pengesahan Ketua PTj</h1>
                            ...
                            <td class="auto-style3">
                                <label class="control-label" for="">
                                    Kumpulan Wang : <asp:DropDownList ID="ddlKW" runat="server" AutoPostBack="True" CssClass="form-control" Style="width: 20%;">
                                                     ...
                                                     <td style="text-align:right"><asp:LinkButton ID="lblCetakDt" runat="server" CssClass="HelpDeskLink" ToolTip="Papar Permohonan Bajet" Text="Cetak Permohonan" >											
                                             <i class="fas fa-print fa-lg"></i></asp:LinkButton>&nbsp<asp:LinkButton ID="lblCetak" runat="server" CssClass="HelpDeskLink" ToolTip="Papar Ringkasan Bajet" Text="Cetak Ringkasan" >											
                                        ...
                                        <asp:TemplateField HeaderText="Program / Aktiviti">
                                            <ItemTemplate>
                                                <asp:Label ID="lblProgram" runat="server" class="gridViewToolTip"
                                                    Text='<%# Limit(Eval("BG20_Program"), 30) %>' tooltip='<%# Eval("BG20_Program") %>'>
                                                </asp:Label>
