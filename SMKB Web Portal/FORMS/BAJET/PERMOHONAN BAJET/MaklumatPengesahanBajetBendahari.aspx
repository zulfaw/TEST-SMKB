<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatPengesahanBajetBendahari.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatPengesahanBajetBendahari" EnableEventValidation ="False"  %>
                    ...
                    <HeaderStyle BackColor="#996633" />
                       ...
                       <div class="panel panel-default" style="width:90%" >
                               ...
                               <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                   ...
                                   <asp:ListItem Value="1">Tidak Sokong</asp:ListItem>
                               </asp:RadioButtonList>
                               </h4>
                       </div>
