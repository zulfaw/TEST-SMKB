Public Class Maklumat_Agihan_Bajet_Am_KetuaPTj
...
group by KodKO"
    ...
    Private Sub lnkBtnBack_Click(sender As Object, e As EventArgs) Handles lnkBtnBack.Click
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/PERMOHONAN BAJET/Pengesahan_Ketua_PTJ.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}", False)
    End Sub
    ...
    Private Function fBindGvObjSebagai(strTahun, strKodKW, strKodKO, strKodPTj, strKodKP, strKodVot)
        ...
        Try
            ...
            strSql = $"select a.KodVotSebagai as KodVot, c.Butiran as ButVot , ISNULL(SUM(BG20_JumKetuaPTj),0) as jumlahMohon from BG01_MohonDt as a
        ...
        WHERE b.BG20_TahunBajet = '{strTahun}' and b.KodKW = '{strKodKW}' and b.KodOperasi = '{strKodKO}' and b.KodBahagian = '{strKodPTj}' and a.KodVotAm = '{strKodVot}' and BG20_Aktif = '1' and a.BG20_Status = 1 and B20_FlagKew = '1'  
...
group by KodKP"
    ...
    Private Sub sBindGvButiran(strKodVotSbg, strTahun, kodkw, kodKO, kodPtj)
        ...
        Try
            ...
            strSql = $"select a.BG20_NoMohon, a.KodVotSebagai as KodVot, b.BG20_Program, a.BG20_Butiran ,ISNULL((BG20_JumKetuaPTj),0)  as BG20_AngJumlah from BG01_MohonDt as a
                    inner join  BG01_Mohon as b on a.BG20_NoMohon = b.BG20_NoMohon
                    WHERE b.BG20_TahunBajet = '{strTahun}' and b.KodKW = '{kodkw}' and b.KodOperasi = '{kodKO}' and b.KodBahagian = '{kodPtj}'
                    and a.KodVotSebagai = '{strKodVotSbg}' and BG20_Aktif = '1' and a.BG20_Status = 1 and B20_FlagKew = '1'  "
    ...
    Private Sub gvButiran_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvButiran.SelectedIndexChanged
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/PERMOHONAN BAJET/MaklumatSemakanBajet_KetuaPtj.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}&kodSkrin=2&no={strNoMohon}&kodvot={kodVot}", False)
    End Sub
