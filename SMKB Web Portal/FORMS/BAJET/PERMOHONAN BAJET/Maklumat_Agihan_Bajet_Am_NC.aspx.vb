Public Class Maklumat_Agihan_Bajet_Am_NC
...
group by KodKO"
    ...
    Private Sub lnkBtnBack_Click(sender As Object, e As EventArgs) Handles lnkBtnBack.Click
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/PERMOHONAN BAJET/Kelulusan_NC.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}", False)
    End Sub
...
group by KodKP"
    ...
    Private Sub sBindGvButiran(strKodVotSbg, strTahun, kodkw, kodKO, kodPtj)
        ...
        Try
            ...
            strSql = $"select a.BG20_NoMohon, a.KodVotSebagai as KodVot, b.BG20_Program, a.BG20_Butiran ,ISNULL((BG20_JumKetuaPTj),0) as BG20_JumKetuaPTj ,ISNULL((BG20_JumBendahari),0)  as BG20_JumBendahari,ISNULL((BG20_JumNC),0) as BG20_JumNC, ISNULL((BG20_JumLPU),0) as BG20_JumLPU, isnull(a.BG20_FlagNC_Delete, 1) as BendDelete from BG01_MohonDt as a
                    inner join  BG01_Mohon as b on a.BG20_NoMohon = b.BG20_NoMohon
                    WHERE b.BG20_TahunBajet = '{strTahun}' and b.KodKW = '{kodkw}' and b.KodOperasi = '{kodKO}' and b.KodPTj = '{kodPtj}'
                    and a.KodVotSebagai = '{strKodVotSbg}' and a.BG20_Status ='1' and BG20_FlagNC = '1' "
    ...
    Private Sub gvButiran_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvButiran.SelectedIndexChanged
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/PERMOHONAN BAJET/MaklumatSemakanBajet_NC.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}&kodSkrin=2&no={strNoMohon}&kodvot={kodVot}", False)
    End Sub
