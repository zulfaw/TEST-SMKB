<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatDefendLPU.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatDefendLPU" EnableEventValidation="False" %>
        ...
        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="tabCtrl" Height="100%" Width="100%">                                    
                <ajaxToolkit:TabPanel ID="tabABM" runat="server" HeaderText ="Anggaran Belanja Mengurus (ABM)">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:TemplateField HeaderText="Agihan LPU 2021 (RM)">  
                        <ItemTemplate>
