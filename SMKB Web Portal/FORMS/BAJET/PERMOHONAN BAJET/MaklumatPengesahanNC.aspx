<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MaklumatPengesahanNC.aspx.vb" Inherits="SMKB_Web_Portal.MaklumatPengesahanNC" EnableEventValidation ="False"  %>
                    ...
                    <HeaderStyle BackColor="#996633" />
                       ...
                       <div ><h4 class="panel-title">Status:
                               <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                   ...
                                   <asp:ListItem Value="1">Tidak Lulus</asp:ListItem>
                               </asp:RadioButtonList>
                               </h4>
                       </div>
