...
from BG01_MohonDt a where  LEFT(a.KodVotSebagai, 1) <> '0' and BG20_NoMohon in  (select BG20_NoMohon  from BG01_Mohon where StatusDok in ('05','06') and BG20_Status = 1) group by a.KodVotSebagai"
    ...
    Private Sub fBindgvAbmMaster()
        Try
            ...
            Dim strSql As String = "select KodVot, Butiran,'-' as JumMohon, '-' as JumAgih from mk_vot where Klasifikasi = 'H1' and KodVot <> '00000' and kodVot <= '50000' order by KodVot"
    ...
    Private Sub sBindGvProgram(ByVal strKodVot As String)
        Try
            ...
            Dim ds As New DataSet
            Dim strSql As String = "select BG20_NoMohon , KodBahagian  , KodUnitPtj ,BG20_Program,BG20_AmaunMohon from BG01_Mohon where BG20_NoMohon in (select BG20_NoMohon  from BG01_MohonDt where KodVotSebagai = '" & strKodVot & "')
    ...
    Private Sub Penyediaan_Bajet_PTJ_AbortTransaction(sender As Object, e As EventArgs) Handles Me.AbortTransaction
