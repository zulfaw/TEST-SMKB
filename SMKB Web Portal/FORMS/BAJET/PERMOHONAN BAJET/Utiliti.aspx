<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Utiliti.aspx.vb" Inherits="SMKB_Web_Portal.Utiliti" %>
                ...
                <div style="width: 800px;margin-left: 20px;">
                    ...
                    <asp:GridView ID="gvDasar" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="BG_KodDasar" HeaderText="Kod Dasar" ReadOnly="True" SortExpression="KodOperasi">
