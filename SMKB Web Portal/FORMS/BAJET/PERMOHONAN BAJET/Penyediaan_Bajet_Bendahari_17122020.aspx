<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Penyediaan_Bajet_Bendahari_17122020.aspx.vb" Inherits="SMKB_Web_Portal.Penyediaan_Bajet_Bendahari_17122020" EnableEventValidation="False" %>
                            ...
                            <div>
                                <table  class="table table table-borderless" style="width:100%;" border="1"> 
                                    <tr style="background-color:#FECB18"> 
                                     ...
                                     <tr>
                                         <td class="auto-style7" style="border: 1px solid black;">Permohonan</td>
                                     ...
                                     <tr>
                                        <td class="auto-style7" style="border: 1px solid black;">Agihan NC</td>
                                         <td style="border: 1px solid black;" class="text-right">0.00</td>
                                    </tr>
