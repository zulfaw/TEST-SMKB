<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Semakan_Bajet_PTJ_15122020.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Bajet_PTJ_15122020" EnableEventValidation="False" %>
                                ...
                                <div>
                                    <table class="table table table-borderless" style="width: 100%;" border="1">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid black;" class="text-right">1,090,000.00</td>
                                        </tr>
                                        <tr>
                                            <td class="auto-style7" style="border: 1px solid black;">Lulus KPT</td>
                                            <td style="border: 1px solid black;" class="text-right">00.00</td>
                                        </tr>
                                        <tr>
