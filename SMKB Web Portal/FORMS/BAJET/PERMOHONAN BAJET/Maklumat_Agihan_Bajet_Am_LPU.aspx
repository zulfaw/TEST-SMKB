<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Maklumat_Agihan_Bajet_Am_LPU.aspx.vb" Inherits="SMKB_Web_Portal.Maklumat_Agihan_Bajet_Am_LPU" %>
            ...
            <div class="panel-body well" style="width: 800px; padding: 5px;">
                <div class="row">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td style="width: 125px;">Bajet tahun</td>
                    ...
                    <table style="width: 100%; text-align: left;">
                        <tr style="height: 35px;">
                            ...
                            <td>
                                ...
                                <asp:Label ID="lblHidObjAm" runat="server" Visible="false"></asp:Label>
                        ...
                        <asp:GridView ID="gvObjSebagai" runat="server" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#333333" BorderStyle="Solid" CssClass="table table-striped table-bordered table-hover" EmptyDataText=" " Font-Size="8pt" HeaderStyle-BackColor="#6699FF" ShowFooter="True" ShowHeaderWhenEmpty="True" Width="100%">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Agihan 2020 (RM)">
                                    ...
                                    <FooterTemplate>
                                        <div style="text-align: right;">
                                            <asp:Label ID="lblTotAmtAgihPast" runat="server" ForeColor="#003399" Font-Bold="true" />
                                        </div>
                                    </FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="Belanja 2020 (RM)">
                                    ...
                                    <FooterTemplate>
                                        <div style="text-align: right;">
                                            <asp:Label ID="lblTotAmtBelanjaPast" runat="server" ForeColor="#003399" Font-Bold="true" />
                                        </div>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Mohon 2022 (RM)">
                                    <ItemTemplate>
                                    ...
                                    <FooterTemplate>
                                        <div style="text-align: right;">
                                            <asp:Label ID="lblTotAmtMohon" runat="server" ForeColor="#003399" Font-Bold="true" />
                                        </div>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Cadangan Bendahari 2022 (RM)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAmtCad" runat="server" Text='<%# Eval("AmtCad", "{0:N2}") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <div style="text-align: right;">
                                            <asp:Label ID="lblTotAmtCad" runat="server" ForeColor="#003399" Font-Bold="true" />
                                        </div>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Agihan NC 2022 (RM)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAmtNC" runat="server" Text='<%# Eval("AmtAgih", "{0:N2}") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <div style="text-align: right;">
                                            <asp:Label ID="lblTotAgih" runat="server" ForeColor="#003399" Font-Bold="true" />
                                        </div>
                                    </FooterTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Agihan LPU 2022 (RM)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAmtLPU" runat="server" Text='<%# Eval("AmtAgihLPU", "{0:N2}") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <div style="text-align: right;">
                                            <asp:Label ID="lblTotAgihLPU" runat="server" ForeColor="#003399" Font-Bold="true" />
                                        </div>
                                    </FooterTemplate>
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td>
                                <label class="control-label" for="">
                                    <asp:DropDownList ID="ddlUnit" runat="server" AutoPostBack="True" CssClass="form-control" Width="50%" Enabled="False">
                                    </asp:DropDownList>
                                </label>
                            </td>
                        </tr>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Program">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblNoMohon" runat="server" Text='<%# Eval("NoMohon") %>' visible="false" />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Agihan NC 2022 (RM)">
                                ...
                                <FooterTemplate>
                                    <div style="text-align: right;">
                                        <asp:Label ID="lblTotAmtAgihan" runat="server" ForeColor="#003399" Font-Bold="true" />
                                    </div>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="Right" Width="10%" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Agihan LPU 2022 (RM)">
                                <ItemTemplate>
                                    <asp:Label ID="lblAmtAgihanLPU" runat="server" Text='<%# Eval("AmtAgihanLPU") %>' />
                                </ItemTemplate>
                                <FooterTemplate>
                                    <div style="text-align: right;">
                                        <asp:Label ID="lblTotAmtAgihanLPU" runat="server" ForeColor="#003399" Font-Bold="true" />
                                    </div>
                                </FooterTemplate>
