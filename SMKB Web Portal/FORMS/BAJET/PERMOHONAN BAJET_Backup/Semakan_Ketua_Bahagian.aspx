...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ContentTemplate>
        ...
        <div class="panel-body" style="overflow-x:scroll">
            ...
            <asp:DropDownList ID="ddlUnit" runat="server" AutoPostBack="True" CssClass="form-control" Width="60%"></asp:DropDownList>
            <br /><br />
            <label class="control-label" for="">Status&nbsp;:</label>
            <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" CssClass="form-control" Width="60%"></asp:DropDownList>
            <br /><br />
            
            <asp:GridView ID="gvSemakanBajet" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="false" EmptyDataText=" "
