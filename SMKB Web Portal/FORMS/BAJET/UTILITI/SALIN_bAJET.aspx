<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Salin_Bajet.aspx.vb" Inherits="SMKB_Web_Portal.Salin_Bajet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>SALIN PERMOHONAN BAJET</h1>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div class="panel-body well" style="width: 400px;">
                    <div class="row">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td class="auto-style1">Permohonan Bajet Tahun</td>
                                <td>:</td>
                                <td>
      ...
      <a href="#" data-toggle="tooltip" title="Salin Bajet telah lengkap." style="cursor:default;">
