...
Public Class Maklumat_Kelulusan_Agihan_
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            fBindGVMohonBajet(strKodPTj, strTahun)
...
WHERE KodAgih = 'AL' and BG07_Tahun = '" & strTahun & "' and KodPTJ = '" & strKodPTj & "';"
            ...
            If Not ds Is Nothing Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    If fSelesaiLulus(strTahun, strKodPTj, decBajetPTj) Then
                        ...
                        lblAlert.Text = "Salin bajet kepada PTj ini telah dilaksanakan."
                    Else
                        ...
                        Else
                            lbtnLulus.Visible = False
                            divAlert.Visible = True
                            lblAlert.Text = "Salin bajet kepada PTj ini belum dilaksanakan.!"
                            sClearGvLst()
                        End If
                    End If
    ...
    Private Sub lnkBtnBack_Click(sender As Object, e As EventArgs) Handles lnkBtnBack.Click
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/BAJET/UTILITI/Salin_Bajet.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}", False)
    End Sub
    ...
    Private Sub fBindGVMohonBajet(ptj As String, tahun As String)
        Try
            Dim strSql As String = ""
            ...
            strSql = $"select DISTINCT a.BG20_NoMohon, BG20_TarikhMohon, REPLACE(BG20_Program,'\','''')  as BG20_Program, BG20_AmaunMohon, StatusDok, KodKW, KodOperasi,  REPLACE(BG20_Justifikasi,'\','''')  as BG20_Justifikasi from BG01_Mohon as a 
            WHERE BG20_StaffIDPemohon is not null 
            and Left(KodPtj,2) = '" + Left(ptj, 2) + "' and BG20_TahunBajet = '" + tahun + "'"

            strSql_count = $"Select count(DISTINCT a.BG20_NoMohon) As bil from BG01_Mohon As a WHERE BG20_StaffIDPemohon Is Not null and Left(KodPtj,2) = '" + Left(ptj, 2) + "' and BG20_TahunBajet = '" + tahun + "'"
            'Else
