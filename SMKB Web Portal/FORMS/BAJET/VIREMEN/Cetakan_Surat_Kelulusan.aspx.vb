...
Public Class Cetakan_Surat_Kelulusan
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                gvKelulusanViremen.DataSource = New List(Of String)
                gvKelulusanViremen.DataBind()
            End If
    ...
    Public Sub OnConfirm(sender As Object, e As EventArgs) Handles btnCari.Click, btnCari.Click
        ...
        gvKelulusanViremen.DataSource = dt
        gvKelulusanViremen.DataBind()
    ...
    Private Function fFindRec(ByVal strCarianNoViremen As String) As DataTable
        Try
            ...
            Dim strSql As String = "select b.BG09_TkhProses, a.BG07_NoViremen, a.BG07_RujSurat
                                    ...
                                    where (a.KodStatusDok = '05') and (a.BG07_NoViremen like '%" + strCarianNoViremen + "%')"
            'KodStatusDok = '05' = lulus bendahari
    ...
    Private Function BindGridView(ByVal strSql As String) As DataSet
        ...
        End Try
    End Function
    Private Sub ggvKelulusanViremen_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvKelulusanViremen.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            e.Row.Attributes("onclick") = Page.ClientScript.GetPostBackClientHyperlink(gvKelulusanViremen, "Select$" & e.Row.RowIndex)
            e.Row.ToolTip = "Klik untuk pilih rekod ini."
            e.Row.ForeColor = ColorTranslator.FromHtml("#000000")
        End If
    End Sub

    Protected Sub gvKelulusanViremen_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvKelulusanViremen.SelectedIndexChanged

        For Each row As GridViewRow In gvKelulusanViremen.Rows
            If row.RowIndex = gvKelulusanViremen.SelectedIndex Then

                row.ForeColor = ColorTranslator.FromHtml("#0000FF")
                row.ToolTip = String.Empty

                Dim strNoViremen As String = gvKelulusanViremen.Rows(row.RowIndex).Cells(2).Text
        ...
        Next
    End Sub
    Private Sub gvKelulusanViremen_PageIndexChanging(sender As Object, e As GridViewPageEventArgs) Handles gvKelulusanViremen.PageIndexChanging
        Try

            gvKelulusanViremen.PageIndex = e.NewPageIndex

            If Session("SortedView") IsNot Nothing Then
                gvKelulusanViremen.DataSource = Session("SortedView")
                gvKelulusanViremen.DataBind()
            Else
        ...
        End Try
    End Sub
    Private Sub gvKelulusanViremen_Sorting(sender As Object, e As GridViewSortEventArgs) Handles gvKelulusanViremen.Sorting
        Try
            ...
            gvKelulusanViremen.DataSource = sortedView
            gvKelulusanViremen.DataBind()
