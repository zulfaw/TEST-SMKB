<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Permohonan_Viremen_(URIS).aspx.vb" Inherits="SMKB_Web_Portal.Permohonan_Viremen__URIS_" %>
                                ...
                                <table class="nav-justified">
                                    ...
                                    <tr style="height: 25px">
                                        <td>
                                            Objek Am :</td>
                                        <td style="height: 22px">
                                            <asp:DropDownList ID="ddlObjAmK" runat="server" AutoPostBack="True" CssClass="form-control" Style="height: 21px;">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="ddlObjAmK" CssClass="text-danger" ErrorMessage="Pilih Objek Am" InitialValue="0" ValidationGroup="grpSimpan"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="height: 25px">
                                        ...
                                        <td style="height: 22px">
                                            <asp:DropDownList ID="ddlObjSbgK" runat="server" AutoPostBack="True" CssClass="form-control" Style="height: 21px;">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlObjSbgK" CssClass="text-danger" ErrorMessage="Pilih Objek Sebagai" InitialValue="0" ValidationGroup="grpSimpan"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                              ...
                              (Pilih  PTJ / Fakulti )
                                    ...
                                    <tr style="height: 25px">
                                        <td>
                                            Objek Am :</td>
                                        <td style="height: 22px">
                                            <asp:DropDownList ID="ddlObjAmM" runat="server" AutoPostBack="True" CssClass="form-control" Style="height: 21px;">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="ddlObjAmM" CssClass="text-danger" ErrorMessage="Pilih Objek Am" InitialValue="0" ValidationGroup="grpSimpan"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="height: 25px">
                                        ...
                                        <td style="height: 22px">
                                            <asp:DropDownList ID="ddlObjSbgM" runat="server" AutoPostBack="True" CssClass="form-control" Style="height: 21px;">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="ddlObjSbgM" CssClass="text-danger" ErrorMessage="Pilih Objek Sebagai" InitialValue="0" ValidationGroup="grpSimpan"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                        ...
                        <div class="panel panel-default" style="margin-left: 0px; width: 100%;">
                            ...
                            <div class="panel-body">
                                <table style="width: 100%; margin-right: 0px;">
                                    <tr>
                                        <td style="text-align: right;width:450px;"><b>Jumlah Viremen (RM) :</b></td>
                                        <td>
