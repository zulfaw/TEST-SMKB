<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Pengesahan_Viremen_(Bendahari).aspx.vb" Inherits="SMKB_Web_Portal.Terimaan__Bendahari_" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="divDt" runat="server" visible="false">
                ...
                <div class="panel panel-default" style="width: 700px;">
                    ...
                    <div class="panel-body">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td style="width: 106px">Tarikh Sah</td>
                                <td>:</td>
                                <td>
                ...
                <div class="panel panel-default" style="width: 700px;">
                    <div class="panel-heading">Pengesah (Bendahari)</div>
                    <div class="panel-body">
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 106px; height: 23px;">Nama</td>
                                <td style="height: 23px">:</td>
                                <td style="height: 23px">
                                    <asp:Label ID="lblNoStafSah2" runat="server"></asp:Label>
                                    &nbsp;-&nbsp;<asp:Label ID="lblNmStafSah2" runat="server"></asp:Label>
                                    &nbsp;</td>
                                <td style="height: 23px"></td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:Label ID="lblJawSah2" runat="server"></asp:Label>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:Label ID="lblTkhSah2" runat="server"></asp:Label>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                ...
                <div class="row">
                    <div style="text-align: center; margin-top: 50px;">
						...
						<i class="fas fa-check-circle"></i>&nbsp;&nbsp;&nbsp;Sah
                         ...
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:LinkButton ID="lBtnPulang" runat="server" CssClass="btn" OnClientClick="return confirm('Anda pasti untuk memulangkan permohonan viremen ini?');">
						<i class="fas fa-undo"></i>&nbsp;&nbsp;&nbsp;Pemulangan
                         </asp:LinkButton>
