<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PERMOHONAN_TAMBAH_KURANG_(URIS).aspx.vb" Inherits="SMKB_Web_Portal.PERMOHONAN_TAMBAH_KURANG__URIS_" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <h1>PERMOHONAN TAMBAH/KURANG (URIS)</h1>
