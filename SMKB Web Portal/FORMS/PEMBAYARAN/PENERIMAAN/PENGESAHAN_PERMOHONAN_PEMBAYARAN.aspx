<%@ Page Title="" Language="vb" AutoEventWireup="false" Async="true" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PENGESAHAN_PERMOHONAN_PEMBAYARAN.aspx.vb" Inherits="SMKB_Web_Portal.PENGESAHAN_PERMOHONAN_PEMBAYARAN" %>
    ...
    <contenttemplate>
        ...
        <script type="text/javascript">
            ...
            async function lulus() {
                ...
                let conf = await show_message_async('Lulus permohonan Pembayaran?<br>  <textarea id="txtUlasan" placeholder="Ulasan"  class="form-control" rows = "1" ></textarea > ')
                if (!conf) {
                    return
                }
                ...
                notification("Permohonan Pembayaran berjaya diluluskan")
            ...
            function loadInvoisLists(dateStart, dateEnd) {
                ...
                show_loader()
                $.ajax({
                    url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Invois_WS.asmx/getPPSokong") %>',
                    method: "POST",
                    data: JSON.stringify({
                        DateStart: dateStart,
                        DateEnd: dateEnd
