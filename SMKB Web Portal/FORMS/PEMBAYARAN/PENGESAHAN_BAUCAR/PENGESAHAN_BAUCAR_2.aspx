<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PENGESAHAN_BAUCAR_2.aspx.vb" Inherits="SMKB_Web_Portal.PENGESAHAN_BAUCAR_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <contenttemplate>
        ...
        <script type="text/javascript">
            ...
            async function lulusBaucar() {
                ...
                console.log(baucar)
                console.log("votinvois",cacheInvoisHdr.Kod_Vot)  
            ...
            function postLulusBaucar(baucar, votInvois) {
                return new Promise(function (resolve, reject) {
                    $.ajax({
                        url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Baucar_WS.asmx/lulusBaucar2") %>',
                        method: "POST",
                        data: JSON.stringify({
                            "baucar": baucar,
                            "votInvois": votInvois
   ...
   // page load
            ...
            function loadInvoisLists(dateStart, dateEnd) {
                ...
                show_loader()
                $.ajax({
                    url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Baucar_WS.asmx/getInvoisBaucarLulus1") %>',
                    method: "POST",
                    data: JSON.stringify({
                        DateStart: dateStart,
                        DateEnd: dateEnd
