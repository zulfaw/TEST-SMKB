<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Integrasi_Pelajar_Terperinci.aspx.vb" Inherits="SMKB_Web_Portal.Integrasi_Pelajar_Terperinci" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax": {
                    "url": "Integrasi.asmx/Load_MaklumatBilTerperinciPelajar",
                    "method": 'POST',
                    ...
                    "data": function () {
                        ...
                        var kodpenghutang = searchParams.get('nomatrik')
                        //var status = searchParams.get('status')
                ...
                "rowCallback": function (row, data) {
                    ...
                    $(row).on("click", function () {
                        rowClickHandler(data.SMP51_DCID);
                    });
                },
            ...
            $('.btnKembali').click(async function () {
                var url = localStorage.getItem('redirectIntegrasiPelajarUrl');
        ...
        async function AjaxGetRecordHdrJurnal(id) {
            ...
            try {
                ...
                const response = await fetch('Integrasi.asmx/LoadHdrInvois', {
                    method: 'POST',
                    headers: {
        ...
        async function AjaxGetRecordJurnal(id) {
            ...
            try {
                ...
                const response = await fetch('Integrasi.asmx/LoadRecordInvoisTerimaanBayaran', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function setValueToRow_HdrJurnal(orderDetail) {
            ...
            $('#txtNamaPenghutang').val(orderDetail.Kod_Penghutang)

            $('#tkhMula').val(orderDetail.TkhMula)
            $('#tkhTamat').val(orderDetail.TkhTamat)
            //$('#rdKontrak').val(orderDetail.Kontrak)
            $('#txtUrusniaga').val('YURAN')
