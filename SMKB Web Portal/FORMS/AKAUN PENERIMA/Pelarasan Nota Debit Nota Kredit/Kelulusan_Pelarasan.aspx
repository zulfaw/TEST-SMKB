<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Kelulusan_Pelarasan.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Pelarasan" %>
                ...
                <div>
                    <%--<div class="modal-content">--%>
                        <div class="modal-header">
                            <h5 class="modal-title">Senarai Permohonan Pelarasan</h5>
                        </div>
                        <!-- Create the dropdown filter -->
                        <div class="search-filter">
                            <div class="form-row justify-content-center">
                                 <div class="form-group row col-md-6">
                                    <label for="" class="col-sm-4 col-form-label">Tempoh Permohonan:</label>
                                    <div class="col-sm-8">
                ...
                <div class="modal-content">
                                        ...
                                        <table class="table table-striped" id="tblData" style="width: 100%;">
                                            <thead>
                                                <tr style="width: 100%; text-align: center;">
                                                    <th scope="col" style="width: 20%;vertical-align:middle">Vot</th>
                    ...
                    <div class="modal-footer modal-footer--sticky">
                        ...
                        <div class="form-group col-md-12" align="right">
                            ...
                            <button type="button" class="btn btn-success btnLulus">Lulus</button>
