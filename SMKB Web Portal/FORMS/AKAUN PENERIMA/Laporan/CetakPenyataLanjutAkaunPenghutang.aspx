<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CetakPenyataLanjutAkaunPenghutang.aspx.vb" Inherits="SMKB_Web_Portal.CetakPenyataLanjutAkaunPenghutang" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Penyata Akaun Penghutang Terperinci</title>
...
<body class="d-flex flex-column justify-content-center align-items-center w-auto">
    ...
    <form id="form1" runat="server" class="p-5 pt-2 m-auto">
        ...
        <div class="justify-content-center">
            <hr />
            <h2 class="text-center font-weight-bold">Penyata Tahunan Akaun Penghutang&nbsp;(<span id="txtBulan" runat="server"></span>&nbsp;<span id="txtTahun" runat="server"></span>)</h2>
        </div>
        <br />
        <div>
        ...
        <div class="container mt-4">
            <asp:GridView ID="gvPenghutang" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false"
                OnRowDataBound="gvPenghutang_RowDataBound">
                <Columns>
                    <asp:BoundField DataField="Tarikh" HeaderText="Tarikh" ItemStyle-Width="30%" />
                    <asp:BoundField DataField="Tujuan" HeaderText="Tujuan" DataFormatString="{0:N2}" ItemStyle-Width="50%" />
                    <asp:BoundField DataField="Jumlah" HeaderText="Jumlah (RM)" DataFormatString="{0:N2}" ItemStyle-Width="20%" />
                </Columns>
            </asp:GridView>
        </div>
        
        <div class="container d-flex mt-4 justify-content-between">
            <label class="font-weight-bolder">Jumlah Credit&nbsp;<label id="creditBulan" runat="server"></label>&nbsp;(RM)</label>
        ...
        <div class="container d-flex mt-2 justify-content-between">
            <label class="font-weight-bolder">Jumlah Debit&nbsp;<label id="debitBulan" runat="server"></label>&nbsp;(RM)</label>
