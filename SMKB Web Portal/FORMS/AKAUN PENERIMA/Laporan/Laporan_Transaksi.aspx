<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Laporan_Transaksi.aspx.vb" Inherits="SMKB_Web_Portal.Laporan_Transaksi" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Laporan Transaksi Akaun Belum Terima</h5>
                        ...
                        <div class="col-md-12">
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans_rpt" class="table table-striped" style="width: 100%">
                                    <thead>
                                        <tr>                                          
                                            <th scope="col">No. Bil/No.Resit</th>
                                            <th scope="col">Kod Penghutang</th>
                                            <th scope="col">Nama Penghutang</th>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans_rpt").DataTable({
                    ...
                    "ajax": {
                        "url": "TransaksiPenghutangWS.asmx/LoadOrderRecord_SenaraiLulusTransaksiJurnal",
                        method: 'POST',
            ...
            $(document).ready(function () {
                ...
                $('#ddlJenTransaksi').dropdown({
                    ...
                    apiSettings: {
                        url: 'TransaksiPenghutangWS.asmx/GetJenisTransaksi?q={query}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            async function ajaxSubmitOrder(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'TransaksiPenghutangWS.asmx/SubmitOrders',
                        method: 'POST',
            ...
            async function ajaxSaveOrder(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'TransaksiPenghutangWS.asmx/Lulusorder',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function ajaxSaveOrderXLulus(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'TransaksiPenghutangWS.asmx/XLulusorder',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function ajaxDeleteOrder(id) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'TransaksiPenghutangWS.asmx/DeleteOrder',
                        method: 'POST',
            ...
            async function AjaxDelete(id) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'TransaksiPenghutangWS.asmx/DeleteRecord',
                        method: 'POST',
                        data: JSON.stringify({ id: id }),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function AjaxLoadOrderRecord(id) {
                ...
                try {
                    const response = await fetch('TransaksiPenghutangWS.asmx/LoadOrderRecord', {
                        method: 'POST',
                        headers: {
            ...
            async function AjaxLoadOrderRecord_Senarai(id) {
                ...
                try {
                    const response = await fetch('TransaksiPenghutangWS.asmx/LoadOrderRecord_SenaraiLulusTransaksiJurnal', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function initDropdownKw(id, idVot) {
                ...
                $('#' + id).dropdown({
                    fullTextSearch: true,
                    apiSettings: {
                        url: 'TransaksiPenghutangWS.asmx/GetKWList?q={query}&kodkw={kodkw}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            async function initDropdownKo(id, idKw) {
                ...
                $('#' + id).dropdown({
                    fullTextSearch: true,
                    apiSettings: {
                        url: 'TransaksiPenghutangWS.asmx/GetKoList?q={query}&kodko={kodko}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            async function initDropdownKp(id, idKo) {
                ...
                $('#' + id).dropdown({
                    fullTextSearch: true,
                    apiSettings: {
                        url: 'TransaksiPenghutangWS.asmx/GetKpList?q={query}&kodko={kodko}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            async function initDropdownVot(id, idPtj) {
                ...
                $('#' + id).dropdown({
                    fullTextSearch: true,
                    apiSettings: {
                        url: 'TransaksiPenghutangWS.asmx/GetVotList?q={query}&kodVot={kodVot}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            async function initDropdownPtj(id) {
                ...
                $('#' + id).dropdown({
                    fullTextSearch: true,
                    apiSettings: {
                        url: 'TransaksiPenghutangWS.asmx/GetVotPTJ?q={query}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            async function initDropdownCOA(id) {
                ...
                $('#' + id).dropdown({
                    ...
                    apiSettings: {
                        url: 'TransaksiPenghutangWS.asmx/GetVotCOA?q={query}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            async function AjaxGetRecordJurnal(id) {
                ...
                try {
                    ...
                    const response = await fetch('TransaksiPenghutangWS.asmx/LoadRecordJurnal', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordHdrJurnal(id) {
                ...
                try {
                    ...
                    const response = await fetch('TransaksiPenghutangWS.asmx/LoadHdrJurnal', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
