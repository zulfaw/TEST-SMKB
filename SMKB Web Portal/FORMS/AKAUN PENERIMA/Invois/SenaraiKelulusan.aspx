                                            ...
                                            <tbody id="tableID">
                                                <tr style="display: none; width: 100%">
                                                    ...
                                                    <td>
                                                        ...
                                                        <label class="lblKuantiti_" id="lblKuantiti" name="lblKuantiti"></label>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <label class="lblHarga_" id="lblHarga" name="lblHarga"></label>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <label class="lblCukai_" id="lblCukai" name="lblCukai"></label>
                                                    ...
                                                    <td>
                                                        ...
                                                        <label class="lblDiskaun_" id="lblDiskaun" name="lblDiskaun"></label>
