...
Public Class BilPelajarItemList
...
Public Class BilPelajar
    ...
    Public Property OrderDetails As List(Of BilPelajarDetail)
...
Public Class PenerimaOrder_Pelajar
    Public Property OrderID As String
    Public Property Bil As String
