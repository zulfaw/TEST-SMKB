...
Public Class Order_Resit
    ...
    Public Property bankutem As String

    Public Property OrderIDResit As String


    Public Property OrderDetails As List(Of OrderDetail_Resit)

    Public Sub New()

    End Sub

    Public Sub New(orderId_ As String, orderIdResit_ As String, PenghutangID_ As String, TkhMula_ As String, TkhTamat_ As String, Kontrak_ As String, JenisUrusniaga_ As String, Tujuan_ As String, Jumlah_ As String, tkhBil_ As String, tempoh_ As String, tempohbyrn_ As String, norujukan_ As String, modterima_ As String, bankutem_ As String, lOrderDetails_ As List(Of OrderDetail_Resit))
        OrderID = orderId_
        OrderIDResit = orderIdResit_
...
Public Class OrderDetail_Resit
    ...
    Public Sub New(Optional id_ As String = "", Optional orderId_ As String = "", Optional orderIdResit_ As String = "", Optional ddlVot_ As String = "", Optional details_ As String = "",
                   ...
                   Optional Cukai_ As String = "", Optional Kadar_harga_ As String = "", Optional PenghutangID_ As String = "", Optional debit_ As String = "")
        id = id_
        ddlVot = ddlVot_
        details = details_
        quantity = quantity_
