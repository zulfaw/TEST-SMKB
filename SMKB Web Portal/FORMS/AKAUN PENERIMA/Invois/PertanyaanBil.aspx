<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PertanyaanBil.aspx.vb" Inherits="SMKB_Web_Portal.PertanyaanBil" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax":
                {
                    "url": "SenaraiKelulusanWS.asmx/LoadOrderRecord_PertanyaanBil",
                    type: 'POST',
                    data: function (d) {
