...
CodeBehind="Terima_Kaunter.aspx.vb" Inherits="SMKB_Web_Portal.Terima_Kaunter" %>
                                ...
                                <div class="">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <label class="input-group__label" for="tkhBil">Tarikh Resit <i style="color:red">*</i> </label>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <select id="ddlMod" class="ui search dropdown input-group__input" name="ddlMod"></select>
                                            <label class="input-group__label" for="ddlMod">Mod Terimaan <i style="color:red">*</i></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <select id="ddlBankUTeM" class="ui search dropdown input-group__input" name="ddlBankUTeM"></select>
                                            <label class="input-group__label" for="ddlBankUTeM">Bank UTeM <i style="color:red">*</i></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                                ...
                                                <table class="table table-striped" id="tblData" style="width: 100%;">
                                                    <thead>
                                                        <tr style="width: 100%; text-align: center">
                                                            ...
                                                            <th scope="col" style="width: 6%;display:none">Kuantiti</th>
                                                            <th scope="col" style="width: 8%;display:none">Harga Seunit (RM)</th>
                                                            <th scope="col" style="width: 8%;display:none">Cukai (%)</th>
                                                            <th scope="col" style="width: 8%;display:none">Diskaun (%)</th>
                                                            <th scope="col" style="width: 7%">Debit </th>
                                                            <th scope="col" style="width: 7%">Kredit </th>
                                                    ...
                                                    <tbody id="tableID">
                                                        <tr style="display: none; width: 100%">
                                                            ...
                                                            <td>
                                                                <input class="form-control underline-input debit"
                                                                    id="debit" name="debit"
                                                                    style="text-align: right" placeholder="0.00" readonly/>
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="float-right">
                                                        ...
                                                        <button type="button" class="btn btn-secondary btnSimpan" style="display:none">Simpan</button>
            ...
            showModalButton.addEventListener('mouseleave', () => {
                ...
                <script type="text/javascript">
                    ...
                    $('#ddlMod').dropdown({
                        ...
                        fullTextSearch: true,
                        apiSettings: {
                            url: '<%=ResolveClientUrl("~/FORMS/AKAUN PENERIMA/Terimaan/TerimaWS.asmx/GetModTerimaList")%>',
                            method: 'POST',
                            dataType: "json",
                            contentType: 'application/json; charset=utf-8',
                            cache: false,
                    ...
                    $('#ddlBankUTeM').dropdown({
                        ...
                        fullTextSearch: true,
                        apiSettings: {
                            url: 'InvoisWS.asmx/GetKodBankList',
                            method: 'POST',
                            dataType: "json",
                            contentType: 'application/json; charset=utf-8',
                            cache: false,
                    ...
                    async function ajaxSubmitOrder(order) {
                        ...
                        return new Promise((resolve, reject) => {
                            $.ajax({
                                ...
                                url: 'InvoisWS.asmx/SubmitOrdersKaunter',
                                method: 'POST',
                                data: JSON.stringify(order),
                                dataType: 'json',
                                contentType: 'application/json; charset=utf-8',
                    ...
                    $(tableID).on('keyup', '.quantity, .price, .amount, .diskaun, .cukai', async function () {
                        var curTR = $(this).closest("tr");
                        var quantity = "1";
                        var price = $(curTR).find("td > .amount");
                        var amount = $(curTR).find("td > .amount");
                        var cukai = "0";
                        var JUMcukai = "0";
                        var diskaun = "0";
                        var JUMdiskaun = "0";
                        var amountwocukai = $(curTR).find("td > .amount");

                        var totalPrice = 1 * NumDefault(price.val())
                        var amauncukai = 0 / 100
                        var total_cukai = totalPrice * amauncukai
                        var amaundiskaun = 0 / 100
