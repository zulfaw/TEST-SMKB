<%@ Page Title="Pengurusan Penghutang" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master"
    CodeBehind="Maklumat_Penghutang.aspx.vb" Inherits="SMKB_Web_Portal.DaftarMaklumatPenghutang" %>
                ...
                <%--<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>
                    <div id="PermohonanTab" class="tabcontent" style="display: block">
                        <%-- DIV DAFTAR PENGHUTANG --%>
                            <div id="divMaklumatPenghutang" runat="server" visible="true">
                                <div class="modal-body">
                                    <div class="table-title">
                                        <h5 >Senarai Penghutang</h5>
                            ...
                            <!-- Modal - Add New Penghutang -->
                            <div class="modal fade" id="modalNewPenghutang" tabindex="-1" role="dialog"
                                                ...
                                                <div class="row w-full">
                                                    <div class="container w-full">
                                                        ...
                                                        <div class="form-group d-flex align-items-center">
                                                            <div class="col-4 d-flex justify-content-end">
                                                                <label for="ddlKategoriPenghutang"
                                                                    class="form-label text-right">Kategori Penghutang: <span class="text-danger">*</span>
                                                                </label>
                                                            </div>
                                                            <div class="col-6">
                                                                <select id="ddlKategoriPenghutang"
                                                                    class="ui search dropdown"
                                                                    name="ddlKategoriPenghutang"></select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group d-flex align-items-center"
                                                            id="sectionId">
                                                        ...
                                                        <div class="form-group d-none align-items-center"
                                                            ...
                                                            <div class="col-6">
                                                                <%--<input type="text" class="form-control" placeholder=""
                                                                    ...
                                                                    autocomplete="off">--%>
                                                                <select id="txtStafBankName" class="ui search dropdown"
                                                                    name="txtStafBankName"></select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group d-flex align-items-center">
                                                            <div class="col-4 d-flex justify-content-end">
                            ...
                            <!-- Modal - Update Penghutang -->
                            <div class="modal fade" id="modalUpdatePenghutang" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                aria-hidden="true" data-backdrop="static">
                                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Kemaskini Penghutang</h5>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row w-full">
                                                    <div class="container w-full">
                                                        ...
                                                        <div class="form-group d-flex align-items-center w-full">
                                                            <div class="col-4 d-flex justify-content-end">
                                                                <label for="txtNoPenghutangUpdate" class="form-label">No.
                                                                    Akaun: </label>
                                                            </div>
                                                            <div class="col-6">
                                                                <input type="text" class="form-control" placeholder="" id="txtNoPenghutangUpdate"
                                                                    name="txtNoPenghutangUpdate" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="form-group d-flex align-items-center">
                                                            <div class="col-4 d-flex justify-content-end">
                                                                <label for="ddlKategoriPenghutangUpdate" class="form-label text-right">Kategori
                                                                    Penghutang: <span class="text-danger">*</span>
                                                                </label>
                                                            </div>
                                                            <div class="col-6">
                                                                <select id="ddlKategoriPenghutangUpdate" class="ui search dropdown"
                                                                    name="ddlKategoriPenghutangUpdate"></select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group d-none align-items-center" id="sectionStafBankUpdate">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <select id="txtStafBankNameUpdate" class="ui search dropdown" name="txtStafBankNameUpdate"></select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group d-flex align-items-center">
                                                            <div class="col-4 d-flex justify-content-end">
                    ...
                    <script type="text/javascript">
                        ...
                        $(document).ready(function () {
                            ...
                            tbl = $("#tblDataSenarai").DataTable({
                                ...
                                "ajax": {
                                    "url": "PenghutangWS.asmx/LoadList_SenaraiPenghutang",
                                    "method": 'POST',
                            ...
                            Promise.all([fetchKodKategoriPenghutang]).then(function (values) {
                            });
                        });
                        ...
                        $('#ddlKategoriPenghutangUpdate').dropdown({
                            selectOnKeydown: true,
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetKodPenghutangList?q={query}',
                        ...
                        $('#ddlBandar').dropdown({
                            ...
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetBandarList?q={query}',
                                method: 'POST',
                                dataType: "json",
                                contentType: 'application/json; charset=utf-8',
                                cache: false,
                        ...
                        $('#ddlBank').dropdown({
                            ...
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetBankList?q={query}',
                                method: 'POST',
                                dataType: "json",
                                contentType: 'application/json; charset=utf-8',
                                cache: false,
                        ...
                        $('#txtStafBankNameUpdate').dropdown({
                            selectOnKeydown: true,
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetBankList?q={query}',
                        ...
                        $('#ddlNoStaf').dropdown({
                            ...
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetKodStaffList?q={query}',
                                method: 'POST',
                                dataType: "json",
                                contentType: 'application/json; charset=utf-8',
                                cache: false,
                        ...
                        $('#ddlNoMatrikUG').dropdown({
                            ...
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetKodPelajarUGList?q={query}',
                                method: 'POST',
                                dataType: "json",
                                contentType: 'application/json; charset=utf-8',
                                cache: false,
                        ...
                        $('#ddlNoMatrikPG').dropdown({
                            ...
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetKodPelajarPGList?q={query}',
                                method: 'POST',
                                dataType: "json",
                                contentType: 'application/json; charset=utf-8',
                                cache: false,
                        ...
                        $('.btnHantar').click(async function () {
                            ...
                            if ($('#ddlKategoriPenghutang').val() == "" || $('#txtNama').val() == "" || $('#txtNoTelefon').val() == "" || $('#txtEmel').val() == "") {
                        ...
                        $('.btnKemaskini').click(async function () {
                            // check every required field
                            if ($('#ddlKategoriPenghutangUpdate').val() == "" || $('#txtNamaUpdate').val() == "" || $('#txtNoTelefonUpdate').val() == "" || $('#txtEmelUpdate').val() == "") {
                                // open modal makluman and show message
                                $('#maklumanModal').modal('toggle');
                                $('#detailMakluman').html('<span>Sila isi semua ruangan yang bertanda <span class="text-danger">*</span></span>');
                            } else {
                        ...
                        $('.btnYa').click(async function () {
                            ...
                            if ($('#txtNoPenghutangUpdate').val() == "") {

                                selectedCategory = $('#ddlKategoriPenghutang').val();
                                ...
                                if (selectedCategory == "ST") {
                                    ...
                                    bank = $('#ddlBank').val();
                                } else if (selectedCategory == "OA" || selectedCategory == "SY" || selectedCategory == "PN") {
                                    id = $('#txtId').val();
                                    bank = $('#ddlBank').val();
                                }
                                ...
                                if (result.Status !== "Failed") {
                                    $('#modalNewPenghutang').modal('toggle');
                                    // open modal makluman and show message
                                    $('#maklumanModal').modal('toggle');
                                ...
                                selectedCategory = $('#ddlKategoriPenghutangUpdate').val();
                                ...
                                penghutang = {
                                    penghutang: {
                                        ...
                                        Id: id,
                                        IdPenghutang: $('#txtNoPenghutangUpdate').val(),
                                        NoTelefon: $('#txtNoTelefonUpdate').val(),
                                        Email: $('#txtEmelUpdate').val(),
                                        KategoriPenghutang: $('#ddlKategoriPenghutangUpdate').val(),
                                        Alamat1: alamat1,
                                        Alamat2: alamat2,
                                        KodNegara: negara,
                                        KodNegeri: negeri,
                                ...
                                if (result.Status !== "Failed") {
                                    $('#modalUpdatePenghutang').modal('toggle');
                                    // open modal makluman and show message
                                    $('#maklumanModal').modal('toggle');
                                    $('#detailMakluman').html(result.Message);
                                    clearAllFields();
                        ...
                        function clearAllFields() {
                            ...
                            $('#txtNoPenghutangUpdate').val('');
                            $('#txtNamaUpdate').val('');
                            $('#txtNoTelefonUpdate').val('');
                            $('#txtEmelUpdate').val('');

                            $('#ddlKategoriPenghutangUpdate').dropdown('clear');
                            $('#ddlKategoriPenghutangUpdate').dropdown('refresh');
                            $('#ddlKategoriPenghutangUpdate').trigger('change');
                        ...
                        function rowClickHandler(item) {
                            ...
                            $('#ddlKategoriPenghutangUpdate').dropdown('clear');
                            $('#ddlKategoriPenghutangUpdate').empty();
                            $('#ddlKategoriPenghutangUpdate').dropdown('refresh');

                            $('#txtNoPenghutangUpdate').val(item.id);
                            ...
                            kategoriPromise.then(function (result) {
                                if (result && result.length > 0) {
                                    ...
                                    $('#ddlKategoriPenghutangUpdate').append(option);

                                    // click event for ddlKategoriPenghutang
                                    isReset = false;
                                    $('#ddlKategoriPenghutangUpdate').trigger('change');
                                    isReset = true;
                                    ...
                                    if (item.kategoriPenghutang == 'PL' || item.kategoriPenghutang == 'PG' || item.kategoriPenghutang == 'PH') {

                                        if (item.kategoriPenghutang == 'PG') {
                                            $('#ddlNoMatrikPGUpdate').dropdown('clear');
                                        ...
                                        } else if (item.kategoriPenghutang == 'PH') {
                                            $('#ddlNoMatrikPHUpdate').dropdown('clear');
                                        ...
                                        GetPenghutangAllDetailValue(item.id).then(function (result) {
                                    ...
                                    } else if (item.kategoriPenghutang == 'ST') {
                                    ...
                                    } else if (item.kategoriPenghutang == 'OA' || item.kategoriPenghutang == 'SY' || item.kategoriPenghutang == 'PN') {
                        ...
                        // display modal - add new penghutang
                        $('.btnPapar').click(function () {                       
                            // put timeout to prevent dropdown from showing (reset state)
                            isReset = true;
                            clearAllFields();
                            isReset = false;
                            $('#modalNewPenghutang').modal('show');
                        });

                        // get value from ddlKategoriPenghutang to display section based on selection
                        $('#ddlKategoriPenghutang').on('change', async function () {
                            if (!isReset) {
                                // kategori
                                ...
                                } else if (selectedValue == "SY" || selectedValue == "PN") { // if Syarikat
                                    // hide not necessary section
                                    $('#sectionNoStaf').removeClass('d-flex');
                                    $('#sectionNoStaf').addClass('d-none');
                                    $('#sectionStaf').removeClass('d-flex');
                        ...
                        // get value from ddlKategoriPenghutang to display section based on selection
                        $('#ddlKategoriPenghutangUpdate').on('change', async function () {
                            if (!isReset) {
                                // kategori
                                var selectedValue = $(this).val();
                        ...
                        // get value from ddl for auto-select Negeri and Negara
                        $('#ddlBandarUpdate').on('change', async function () {
                        ...
                        function GetBandarValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetBandarValue',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
                        ...
                        function GetBandarValueMapping(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetBandarValueMap',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
                        ...
                        function GetBankValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetBankValue',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
                        ...
                        function GetNoStaffValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetKodStaffList',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
                        ...
                        function GetPenghutangAllDetailValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetPenghutangAllDetailValue',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
                        ...
                        function GetStaffValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetStafValue',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
                        ...
                        function GetPelajarUGValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetPelajarUGValue',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
                        ...
                        function GetPelajarPGValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetPelajarPGValue',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
