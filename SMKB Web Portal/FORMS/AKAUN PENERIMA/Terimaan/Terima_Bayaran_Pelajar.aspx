<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Terima_Bayaran.aspx.vb" Inherits="SMKB_Web_Portal.Terima_Bayaran" %>
                ...
                <div>
                    <div class="modal-body">
                        ...
                        <div class="search-filter">
                            <div id="search_penaja" class="form-row justify-content-center" style="display:none">
                                 <div class="form-group row col-md-6">
                                    <label for="" class="col-sm-3 col-form-label">Penaja:</label>
                                    <div class="col-sm-8">
                                        <select id="ddlKategoriPenghutang" class="ui search dropdown form-control" name="ddlKategoriPenghutang"></select>
                                    </div>
                                </div>
                            </div>
                            <div id="search_individu" class="form-row justify-content-center">
                                 <div class="form-group row col-md-6">
