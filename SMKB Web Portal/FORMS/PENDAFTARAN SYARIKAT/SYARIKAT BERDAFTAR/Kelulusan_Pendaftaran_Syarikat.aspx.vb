Public Class Kelulusan_Pendaftaran_Syarikat
...
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodLulus = '3' AND ROC01_KodAktif = '00'"
        End If
...
ROC01_TkhLulus,ROC01_TkhSahKemaskini, ROC01_TkhDaftar, ROC01_IDSem, ROC01_Bekalan, ROC01_Perkhidmatan, ROC01_Kerja
from ROC01_Syarikat a, ROC_StatAktif c
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodLulus = '3' 
AND ROC01_KodAktif = '00' AND ROC01_NoSya LIKE '%{txtCari.Text}%'"
            ElseIf ddlCari.SelectedValue = 2 Then
                'Nama Syarikat
                strSql = $"SELECT ROC01_NoSya, c.Butiran As StatAktif, ROC01_NamaSya, 
ROC01_TkhLulus,ROC01_TkhSahKemaskini, ROC01_TkhDaftar, ROC01_IDSem, ROC01_Bekalan, ROC01_Perkhidmatan, ROC01_Kerja
from ROC01_Syarikat a, ROC_StatAktif c
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodLulus = '3' AND 
ROC01_KodAktif = '00' AND ROC01_NamaSya LIKE '%{txtCari.Text}%'"
            ElseIf ddlCari.SelectedValue = 3 Then
                'Tahun
                strSql = $"SELECT ROC01_NoSya, c.Butiran As StatAktif, ROC01_NamaSya, 
ROC01_TkhLulus,ROC01_TkhSahKemaskini, ROC01_TkhDaftar, ROC01_IDSem, ROC01_Bekalan, ROC01_Perkhidmatan, ROC01_Kerja
from ROC01_Syarikat a, ROC_StatAktif c
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodLulus = '3' AND ROC01_KodAktif = '00' AND
YEAR(ROC01_TkhLulus) = {txtCari.Text}"
