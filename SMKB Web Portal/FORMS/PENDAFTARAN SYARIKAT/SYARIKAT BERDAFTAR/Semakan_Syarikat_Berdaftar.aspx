<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Semakan_Syarikat_Berdaftar.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Syarikat_Berdaftar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Semakan Syarikat Berdaftar</h1>
                ...
                <td>
					...
					<asp:GridView ID="gvSyarikat" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="true" EmptyDataText=" Tiada rekod"
							cssclass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" PageSize="50" Font-Size="8pt">
								...
								<asp:BoundField HeaderText="Peniagaan Utama" DataField="NamaNiaga" SortExpression="NamaNiaga" HeaderStyle-CssClass="centerAlign" ItemStyle-Width="8%" />									                         
