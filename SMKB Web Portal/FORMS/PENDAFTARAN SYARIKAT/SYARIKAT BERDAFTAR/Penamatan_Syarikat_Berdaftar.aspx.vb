Public Class Penamatan_Syarikat_Berdaftar
...
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodLulus = '1' AND ROC01_KodAktif <> '00'"
        End If
...
ROC01_TkhLulus,ROC01_TkhSahKemaskini, ROC01_TkhDaftar, ROC01_IDSem, ROC01_Bekalan, ROC01_Perkhidmatan, ROC01_Kerja
from ROC01_Syarikat a, ROC_StatAktif c
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodAktif <> '00'
AND ROC01_NoSya LIKE '%{txtCari.Text}%'"
...
from ROC01_Syarikat a, ROC_StatAktif c
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodAktif <> '00'
AND ROC01_NamaSya LIKE '%{txtCari.Text}%'"
...
from ROC01_Syarikat a, ROC_StatAktif c
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodAktif <> '00'
AND YEAR(ROC01_TkhLulus) = {txtCari.Text}"
...
from ROC01_Syarikat a, ROC_StatAktif c
WHERE c.KodAktif = a.ROC01_KodAktif AND ROC01_KodAktif <> '00'
AND c.Butiran LIKE '%{txtCari.Text}%'"
            End If
    ...
    Protected Sub BindGridViewButiran()
        Using dt = dbconn.fSelectCommandDt(ViewState("Str"))
