<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Kelulusan_Kemaskini_Syarikat.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Kemaskini_Syarikat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h1>Kelulusan Kemaskini Syarikat Berdaftar</h1>
			...
			<div class="panel panel-default" style="width:auto;">
				<div class="panel-heading">
					<h3 class="panel-title">
						Senarai Syarikat Yang Telah Membuat Kemaskini Dan Menunggu Kelulusan
					</h3>
				</div>
                ...
                <td style="width:110px;">
					...
					<asp:GridView ID="gvSyarikat" runat="server" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="true" EmptyDataText=" Tiada rekod"
							cssclass="table table-striped table-bordered table-hover" Width="100%" BorderStyle="Solid" PageSize="50" Font-Size="8pt">
								...
								<asp:BoundField HeaderText="Nama Syarikat" DataField="ROC01_NamaSya" SortExpression="ROC01_NamaSya" HeaderStyle-CssClass="centerAlign" ItemStyle-Width="35%"/>
								<asp:BoundField HeaderText="Peniagaan Utama" DataField="NamaNiaga" SortExpression="NamaNiaga" HeaderStyle-CssClass="centerAlign" ItemStyle-Width="25%" />									                         
