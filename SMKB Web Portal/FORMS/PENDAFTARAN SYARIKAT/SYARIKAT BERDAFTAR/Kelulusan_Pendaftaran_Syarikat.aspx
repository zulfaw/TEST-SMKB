<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Kelulusan_Pendaftaran_Syarikat.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Pendaftaran_Syarikat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Kelulusan Pendaftaran Syarikat Berdaftar</h1>
			...
			<div class="panel panel-default" style="width:auto;">
				<div class="panel-heading">
					<h3 class="panel-title">
						Senarai Syarikat Berdaftar Menunggu Kelulusan
					</h3>
				</div>
