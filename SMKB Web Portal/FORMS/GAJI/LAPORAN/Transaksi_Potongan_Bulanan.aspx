<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Transaksi_Potongan_Bulanan.aspx.vb" Inherits="SMKB_Web_Portal.Transaksi_Potongan_Bulanan" %>
...
<%--    <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.1.0-rc.0/css/select2.min.css" rel="stylesheet" />--%>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Laporan Transaksi Potongan Bulanan</h5>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <%--<asp:DropDownList ID="ptjFilter" runat="server" DataTextField="Pejabat" DataValueField="KodPejabat" class="ui fluid search dropdown selection custom-select" AutoPostBack="true" OnSelectedIndexChanged="ptjFilter_SelectedIndexChanged"></asp:DropDownList>--%>
                                        <asp:DropDownList ID="potonganFilter" runat="server" DataTextField="Butiran" DataValueField="Kod" class="ui fluid search dropdown selection custom-select"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function beginSearch() {
            ...
            $.ajax({
                url: "Laporan_WS.asmx/LoadRecord_TransaksiPotonganBulanan",
                type: "POST", 
                data: JSON.stringify({
                    ...
                    kodpotongan: $('#<%=potonganFilter.ClientID%>').val()
                }),
                        ...
                        buttons: ['csv', 'excel',
                            {
                                ...
                                action: function (e, dt, button, config) {
                                    window.open('<%= ResolveClientUrl("~/FORMS/GAJI/LAPORAN/PrintReport/reportTransaksiPotongan.aspx") %>', '_blank');
                                }
                            }
                        ],
