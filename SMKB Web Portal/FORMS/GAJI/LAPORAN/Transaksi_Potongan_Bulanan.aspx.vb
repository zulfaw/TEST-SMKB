...
Public Class Transaksi_Potongan_Bulanan
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Dim kodPotongan As DataTable = GetPotonganList()
            ' Bind the data to the dropdown list
            potonganFilter.DataSource = kodPotongan
            potonganFilter.DataBind()
    ...
    Private Function GetPotonganList() As DataTable
        ' Create a connection to your database
        Dim connectionString As String = "server=devmis12.utem.edu.my;database=DbKewanganV4;uid=Smkb;pwd=Smkb@Dev2012;"
        Dim connection As New SqlConnection(connectionString)
        ...
        Dim query As String = "SELECT '00' AS Kod, 'KESELURUHAN' AS Butiran UNION ALL
                               SELECT Kod,Butiran FROM SMKB_Gaji_Potongan WHERE Jenis = 'PT'"
