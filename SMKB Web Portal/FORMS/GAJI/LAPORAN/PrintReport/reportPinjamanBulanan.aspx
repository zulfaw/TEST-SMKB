<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportPinjamanBulanan.aspx.vb" Inherits="SMKB_Web_Portal.reportPotonganBulanan" %>
<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TablePinjamanBulanan.ascx" TagPrefix="Vot" TagName="Table" %>
    ...
    <form id="form1" runat="server">
         <div id="masterdiv" class="container">
                ...
                <table> 
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Senarai Pinjaman Bulanan</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Pinjaman <%= Session("Pinjaman") %> Bulanan</strong></p>
            ...
            <div class="vot-table-content">
                 <Vot:Table runat="server" ID="TablePinjamanBulanan" CustomClass="TablePinjamanBulanan" />
            </div>
