<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportCukaiBulanan.aspx.vb" Inherits="SMKB_Web_Portal.reportCukaiBulanan" %>
    ...
    <form id="form1" runat="server">
         <div id="masterdiv" class="container">
                ...
                <table> 
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Cukai Bulanan</strong></p>
            ...
            <div class="vot-table-content">
                 <Vot:Table runat="server" ID="TableCukaiBulanan" kodKwFrom="1" kodKwTo="1" CustomClass="TableCukaiBulanan" />
            </div>
            <script>
