<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportTransaksi.aspx.vb" Inherits="SMKB_Web_Portal.reportTransaksi" %>

<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TableTransaksi.ascx" TagPrefix="Vot" TagName="Table" %>
...
<head>
    ...
    <style>
        ...
        .table-with-border th, .table-with-border td {
            ...
            padding: 8px; /* Add some padding to the table cells for spacing */
...
*/
        ...
        @page {
            size: landscape; /*or letter, legal, etc. */
...
<body>
    ...
    <div id="masterdiv" class="container">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 30%; text-align: right">
                        ...
                        <span class="ptarikh">Laporan Transaksi Bulanan</span><br />
                ...
                <tr>
                    ...
                    <td style="text-align: center" colspan="3">
                        <br />
                        <p class="pheader3"><strong>Laporan Transaksi Bulanan</strong></p>
        ...
        <%--<div class="content">--%>
            <Vot:Table runat="server" ID="TableTransaksi" CustomClass="TableTransaksi" />
        </div>
        <br />
