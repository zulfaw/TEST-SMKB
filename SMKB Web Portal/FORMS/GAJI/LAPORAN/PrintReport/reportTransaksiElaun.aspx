<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportTransaksiElaun.aspx.vb" Inherits="SMKB_Web_Portal.reportTransaksiElaun" %>

<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TableTransaksiElaun.ascx" TagPrefix="Vot" TagName="Table" %>
        ...
        <div id="masterdiv" class="container">
           ...
           <div id="headerreport" class="header" style ="">
                <table>
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan Transaksi Elaun</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Transaksi Elaun</strong></p>
            ...
            <div class="vot-table-content">
                <Vot:Table runat="server" ID="tblTransaksiElaun" CustomClass="tblTransaksiElaun" />
            </div>
