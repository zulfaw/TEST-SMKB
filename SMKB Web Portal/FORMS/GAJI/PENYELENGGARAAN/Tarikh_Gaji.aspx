    ...
    <div class="table-title">
        ...
        <div class="box-body" align="center" >               
            <asp:GridView ID="gvJenis" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="kod_param" HeaderText="Kod">
                ...
                <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Tahun</label>
                                            <asp:TextBox runat="server" ID="TextBox1" CssClass="form-control" Style="width: 100%;" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Tarikh Gaji</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="$('#tambah').modal('hide'); return false;">Tutup</button>
                            <asp:LinkButton ID="lbtnSimpan" runat="server" autopostback ="true" CssClass="btn btn-secondary" OnClientClick="return fSimpan();"> 
