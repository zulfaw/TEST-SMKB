<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Sah_Statutory.aspx.vb" Inherits="SMKB_Web_Portal.Sah_Statutory" %>
                ...
                <div class="card d-block h-100 
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-body p-4">
                        ...
                        <p>
                            <asp:CheckBox ID="chkSah" runat="server" Text="Saya mengesahkan bahawa kesemua Proses Statutory telah selesai dilaksanakan" />
                        </p>
...
<script type="text/javascript">
    ...
    $('.btnSah').click(function () {
        ...
        if ($('#<%=chkSah.ClientID%>').is(':checked')) {
            ...
            //alert(bln);
            $.ajax({
                "url": "Transaksi_WS.asmx/SahStatutory",
                method: 'POST',
