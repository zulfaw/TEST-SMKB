...
Public Class Salary_Plus
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        ...
        Dim s_comp, s_comp_name, s_acc, ref, jenis, expdate, s_header, descc As String
        ...
        s_comp = "0000001626"
        s_comp_name = "UNIVERSITI TEKNIKAL MALAYSIA MELAKA"
        s_acc = "04042010000833"
        ref = Space(14)
        ...
        'Header
        s_comp = s_comp.PadRight(13, " ")
        s_comp_name = s_comp_name.PadRight(40, " ")
        ...
        s_header = "H" + Trim(s_comp) + s_acc + Space(55)


        w.WriteLine(s_header)
