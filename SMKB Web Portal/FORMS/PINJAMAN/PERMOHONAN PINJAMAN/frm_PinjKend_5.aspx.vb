...
Public Class frm_PinjKend_5
    ...
    End Sub
    Protected Sub btnStep1_Click(sender As Object, e As EventArgs) Handles btnStep1.ServerClick
        Response.Redirect($"~/Forms/Pinjaman/Permohonan Pinjaman/frm_PinjKend.aspx?KodSubmenu={ViewState("kodsubmenu")}")
    End Sub
